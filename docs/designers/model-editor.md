...
2. Na pasku narzędzi **Edytor modelu** wybierz kolejno pozycje narzędzia **skryptów**  >    >  **wyciągnięcie**.
...
2. Na pasku narzędzi **Edytor modelu** wybierz kolejno pozycje narzędzia **skryptów** Podziel  >    >  .
...
2. Na pasku narzędzi **Edytor modelu** wybierz kolejno pozycje narzędzia **skryptów**  >    >  **triangulacja**.

#### <a name="merge-objects"></a>Scal obiekty

1. W trybie zaznaczania obiektów zaznacz obiekty, które chcesz scalić.

2. Na pasku narzędzi **Edytor modelu** wybierz kolejno pozycje narzędzia **skrypty**  >    >  **Scal obiekty**.
