...
|Projektowanie klasycznych aplikacji, które używają wersja WPF XAML | [Rozpoczynanie pracy z usługą Windows Presentation Foundation](../designers/getting-started-with-wpf.md) |
| Opracowanie aplikacji DirectX w programie Visual Studio | [Praca z zasobami 3D dla gier i aplikacji](../designers/working-with-3-d-assets-for-games-and-apps.md) |
| Dostępne dla programów standardowych ikon | [Biblioteka obrazów programu Visual Studio](../designers/the-visual-studio-image-library.md) |
