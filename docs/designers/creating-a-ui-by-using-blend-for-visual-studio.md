...
![Panel narzędzia w Blend for Visual Studio](../designers/media/blend-tools-panel.png)
...
![Okno elementów zawartości w Blend for Visual Studio](../designers/media/blend-assets-window.png)
...
![Okno obiektu i osi czasu w trybie animacji](../designers/media/storyboard-timeline.png)
