...
description: Dowiedz się, jak zmienić parametry w module cieniującego, aby nadać obiektowi różne wyglądy na podstawie właściwości materiału, świateł kierunkowych, położenia kamery oraz czasu.
