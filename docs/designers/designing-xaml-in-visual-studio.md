...
- **Pakiet NuGet:** Możesz zarządzać pakietami NuGet w programie Visual Studio i Blend for Visual Studio. NuGet to Menedżer pakietów dla platformy .NET, która upraszcza instalacji i usuwania pakietów za pomocą rozwiązania.
