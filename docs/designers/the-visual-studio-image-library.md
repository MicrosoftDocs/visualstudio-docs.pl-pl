...
description: Dowiedz się więcej o bibliotece obrazów programu Visual Studio, która zawiera obrazy aplikacji, które są wyświetlane w programie Visual Studio, Windows, Office i innym oprogramowaniu firmy Microsoft.
