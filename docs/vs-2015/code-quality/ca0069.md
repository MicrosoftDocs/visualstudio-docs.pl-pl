...
ms.locfileid: "72646449"
---
# <a name="ca0069"></a>CA0069

UsingAlternatePlatform. Nie można znaleźć *FrameworkVersion1* . Zamiast tego należy użyć *FrameworkVersion2* . Aby uzyskać najlepsze wyniki analizy, upewnij się, że zainstalowano poprawną .NET Framework.
