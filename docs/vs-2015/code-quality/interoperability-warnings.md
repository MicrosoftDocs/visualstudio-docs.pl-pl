---
title: Współdziałanie — ostrzeżenia | Dokumentacja firmy Microsoft
ms.date: 11/15/2016
...
|[CA1401: P/Invokes nie powinny być widoczne](../code-quality/ca1401-p-invokes-should-not-be-visible.md)|Metoda publiczna lub chroniona w typie publicznym ma atrybut System.Runtime.InteropServices.DllImportAttribute (również implementowany przez słowo kluczowe Declare w języku Visual Basic). Takie metody nie powinny być udostępniane.|  
...
|[CA1404: Wywołaj metodę GetLastError natychmiast po P/Invoke](../code-quality/ca1404-call-getlasterror-immediately-after-p-invoke.md)|Wykonano wywołanie do metody Marshal.GetLastWin32Error lub równoważny [!INCLUDE[TLA2#tla_win32](../includes/tla2sharptla-win32-md.md)] funkcję GetLastError, a bezpośrednio poprzedzające wywołanie nie jest to platforma wywołania metody.|  
...
|[CA1406: Unikaj argumentów Int64 dla klientów w języku Visual Basic 6](../code-quality/ca1406-avoid-int64-arguments-for-visual-basic-6-clients.md)|Klienci Visual Basic 6 COM nie może uzyskać dostęp do 64-bitowych liczb całkowitych.|  
...
|[CA1414: Oznacz logiczne argumenty P/Invoke za pomocą atrybutu MarshalAs](../code-quality/ca1414-mark-boolean-p-invoke-arguments-with-marshalas.md)|Typ danych Boolean ma wiele reprezentacji w kodzie niezarządzanym.|  
|[CA1415: Poprawnie Zadeklaruj P/Invokes](../code-quality/ca1415-declare-p-invokes-correctly.md)|Ta zasada będzie wyglądać dla deklaracji metod wywołania platformy, których platformą docelową [!INCLUDE[TLA2#tla_win32](../includes/tla2sharptla-win32-md.md)] parametru struktury funkcji, które mają wskaźnik do OVERLAPPED, a odpowiadający parametr zarządzalny nie jest wskaźnikiem do <xref:System.Threading.NativeOverlapped?displayProperty=fullName> struktury.|
