...
- W języku C++ można odwoływać się do zestawów za pomocą ForcedUsing w VCPROJ, zastępując wiersz polecenia, aby przekazać/FU lub dodać #using \<Some.dll> tylko w programie źródłowym.
