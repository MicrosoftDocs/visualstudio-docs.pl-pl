---
title: 'Instrukcje: generowanie danych metryk kodu | Microsoft Docs'
ms.date: 11/15/2016
...
### <a name="to-generate-code-metrics-results-for-an-entire-solution"></a>Aby wygenerować wyniki metryk kodu dla całego rozwiązania
...
- W oknie **wyników metryk kodu** kliknij przycisk **CalculateCode metryki dla rozwiązania** .
     ...
     Wyniki są generowane i zostanie wyświetlone okno **wyników metryk kodu** .

### <a name="to-generate-code-metrics-results-for-one-or-more-selected-projects"></a>Aby wygenerować wyniki metryk kodu dla co najmniej jednego wybranego projektu
...
### <a name="to-view-the-results-details"></a>Aby wyświetlić szczegóły wyników
