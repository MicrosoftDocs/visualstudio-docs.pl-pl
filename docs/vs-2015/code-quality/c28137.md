...
## <a name="example"></a>Przykład  
 Na przykład procedura [ExAcquireResourceExclusiveLite](https://msdn.microsoft.com/library/windows/hardware/ff544351.aspx) wymaga wartości true lub false dla parametru `Wait`. Poniższy przykładowy kod generuje to ostrzeżenie:  
