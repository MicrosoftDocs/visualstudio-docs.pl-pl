...
|Metoda|Opis|
|------------|-----------------|
|<xref:System.GC.Collect%2A?displayProperty=fullName>|Wywoływanie GC. Zbieranie danych może znacząco wpłynąć na wydajność aplikacji i jest rzadko konieczne. Aby uzyskać więcej informacji, zobacz wpis w blogu dotyczącym [wydajności smakowite kąski Mariani](http://go.microsoft.com/fwlink/?LinkId=169256) w witrynie MSDN.|
