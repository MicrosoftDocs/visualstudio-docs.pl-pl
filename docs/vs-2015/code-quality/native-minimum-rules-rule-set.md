---
title: Natywny zestaw reguł minimalnych reguł | Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "72661074"
---
# <a name="native-minimum-rules-rule-set"></a>Zestaw reguł Native Minimum Rules
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Natywne reguły firmy Microsoft, które koncentrują się na najważniejszych problemach w kodzie natywnym, w tym potencjalnych luk w zabezpieczeniach i awarii aplikacji. Ten zestaw reguł powinien być dołączany do każdego niestandardowego zestawu reguł tworzonego dla projektów natywnych.
