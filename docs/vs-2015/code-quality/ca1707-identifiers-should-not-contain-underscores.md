...
Aby uzyskać najnowszą dokumentację programu Visual Studio, zobacz [CA1707: Identyfikatory nie powinny zawierać podkreśleń](https://docs.microsoft.com/visualstudio/code-quality/ca1707-identifiers-should-not-contain-underscores) w witrynie docs.microsoft.com.  
