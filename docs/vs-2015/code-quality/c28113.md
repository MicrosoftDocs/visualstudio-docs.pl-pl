...
Ostrzeżenie C28113: Uzyskiwanie dostępu do zmiennej lokalnej za pośrednictwem funkcji Interlocked  
 ...
 Sterownik jest użyć procedury wsparcie kadry zarządzającej blokowaną, takich jak [InterlockedDecrement](https://msdn.microsoft.com/library/windows/hardware/ff547871.aspx), aby uzyskiwać dostęp do zmiennej lokalnej.  
