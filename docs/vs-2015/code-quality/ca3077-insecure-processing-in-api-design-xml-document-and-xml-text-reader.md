...
- klasy <xref:System.Xml.XmlDocument> lub <xref:System.Xml.XmlTextReader> używają domyślnych wartości programu rozpoznawania nazw dla przetwarzania DTD.
