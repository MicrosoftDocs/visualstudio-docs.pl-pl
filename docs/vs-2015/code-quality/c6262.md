...
ms.locfileid: "65683662"
---
# <a name="c6262"></a>C6262
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Ostrzeżenie C6262: Używa funkcji \<stałą > liczbę bajtów stosu: przekracza / analyze: stacksize\<constant 2 >. Rozważ przeniesienie niektórych danych do sterty  
...
## <a name="see-also"></a>Zobacz też  
 [/ STACK (twórz stos z alokacji)](https://msdn.microsoft.com/library/73283660-e4bd-47cc-b5ca-04c5d739034c)   
