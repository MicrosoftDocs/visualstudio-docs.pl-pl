---
title: Zrozumienie SAL | Microsoft Docs
ms.date: 11/15/2016
...
2. Na pasku menu wybierz **kompilacja**, **Uruchom analizę kodu w rozwiązaniu**.  
   ...
   > "Pinta" może mieć wartość "0": to nie jest zgodne ze specyfikacją funkcji "InCallee".  
...
### <a name="example-the-_in_opt_-annotation"></a>Przykład: \_ \_ adnotacja In_opt  
...
### <a name="example-the-_out_opt_-annotation"></a>Przykład: \_ \_ adnotacja Out_opt  
...
### <a name="example-the-_inout_opt_-annotation"></a>Przykład: \_ \_ adnotacja Inout_opt  
...
### <a name="example-the-_outptr_opt_-annotation"></a>Przykład: \_ \_ adnotacja Outptr_opt  
