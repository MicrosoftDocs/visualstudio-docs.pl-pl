...
Ostrzeżenie C6504: nieprawidłowa adnotacja: właściwość może być używana tylko na wartościach wskaźnika, wskaźnik do elementu członkowskiego lub typu tablicowego  
 ...
 To ostrzeżenie wskazuje na użycie na niezgodny typ danych właściwości. Aby uzyskać więcej informacji na temat typów danych obsługiwanych przez właściwości, zobacz [właściwości adnotacji](https://msdn.microsoft.com/f77b4370-6bda-4294-bd2a-e7d0df182a3d).  
