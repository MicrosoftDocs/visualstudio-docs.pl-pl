...
[!INCLUDE[vs2010](../includes/vs2010-md.md)] zapewnia starszą [!INCLUDE[wfd1](../includes/wfd1-md.md)], której można użyć do [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] lub [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)].
 ...
 Po utworzeniu sekwencyjnego przepływu pracy, który jest [SequentialWorkflowActivity](https://go.microsoft.com/fwlink?LinkID=65040), dostępne są trzy widoki przepływu pracy. Te widoki są dostępne z menu **przepływ pracy** oraz z menu kontekstowego na powierzchni projektowej.
...
## <a name="see-also"></a>Zobacz też
 [Widoki działań (starsze)](../workflow-designer/activity-views-legacy.md) [Tworzenie starszych projektów przepływu](../workflow-designer/creating-legacy-workflow-projects.md) pracy — [Tryby tworzenia przepływu pracy](https://go.microsoft.com/fwlink?LinkID=65014)