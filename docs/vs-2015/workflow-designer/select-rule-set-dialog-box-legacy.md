...
## <a name="see-also"></a>Zobacz też
 Okno dialogowe Edytor zestawu reguł [zasad zabezpieczeń](https://msdn2.microsoft.com/library/system.workflow.activities.policyactivity.aspx) [(starsza wersja)](../workflow-designer/rule-set-editor-dialog-box-legacy.md) [przy użyciu działania zasad](https://msdn2.microsoft.com/library/bb675229.aspx) z [użyciem warunków w przepływach pracy](https://msdn2.microsoft.com/library/bb628447.aspx)
