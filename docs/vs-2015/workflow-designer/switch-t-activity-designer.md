---
title: Przełącz &lt;T projektanta działań &gt; | Microsoft Docs
ms.date: 11/15/2016
...
---
# <a name="switchlttgt-activity-designer"></a>Przełącz &lt;T projektanta działań &gt;
 ...
 **@No__t_1T >** Projektant działań służy do tworzenia i konfigurowania działania <xref:System.Activities.Statements.Switch%601> w [!INCLUDE[wfd1](../includes/wfd1-md.md)].
...
## <a name="how-to-use-the-switcht-activity-designer"></a>Jak używać narzędzia Switch \<T > Designer
 @No__t_1T projektanta działania **przełącznika >** można znaleźć w kategorii **przepływ sterowania** dla **przybornika**, do którego uzyskuje się dostęp przez kliknięcie na karcie **przybornika** w [!INCLUDE[wfd2](../includes/wfd2-md.md)] (Alternatywnie wybierz pozycję **pasek narzędzi** z **widoku).** lub CTRL + ALT + X.) Po porzucenie go do [!INCLUDE[wfd2](../includes/wfd2-md.md)] wyświetla okno dialogowe **Wybieranie typów** , aby zezwolić użytkownikowi na określenie typu ogólnego *t* używanego w działaniu \<1. Wartość domyślna to **Int32**. Po wybraniu typu ogólnego *T* , **przełącznik \<T >** projektanta zostanie dodany do projektanta przepływu pracy.
