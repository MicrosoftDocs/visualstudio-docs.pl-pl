---
title: Okna dialogowe Dodawanie parametrów i Dodawanie argumentów | Microsoft Docs
ms.date: 11/15/2016
...
|**Wartość**|Wyrażenie języka VB, które jest używane do przypisywania wartości domyślnej do nowego parametru|

 W poniższej tabeli opisano elementy interfejsu użytkownika (UI) okna dialogowego **Dodawanie argumentów** używanych przez <xref:System.Activities.Statements.InvokeDelegate> projektanta.
