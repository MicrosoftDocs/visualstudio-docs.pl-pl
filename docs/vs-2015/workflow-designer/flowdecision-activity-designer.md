...
### <a name="using-the-flowdecision-designer"></a>Korzystanie z narzędzia FlowDecision Designer
 Projektanta **FlowDecision** można znaleźć w kategorii **schemat blokowy** **przybornika**, do którego uzyskuje się dostęp, klikając kartę **przybornika** w [!INCLUDE[wfd2](../includes/wfd2-md.md)] **narzędziu** (Alternatywnie, wybierając z menu **Widok** lub CTRL + ALT + X).

 Projektanta **FlowDecision** można przeciągać z **przybornika** i znajdować się na [!INCLUDE[wfd2](../includes/wfd2-md.md)] powierzchni w ramach projektanta działań **schematu blokowego** . Spowoduje to utworzenie <xref:System.Activities.Statements.FlowDecision> oznaczonej **decyzji** w ramach <xref:System.Activities.Statements.Flowchart> działania. Wskaźnik myszy nad projektantem i dojścia do **rzeczywistych** i **fałszywych** kwadratów dla dwóch gałęzi.
...
## <a name="see-also"></a>Zobacz też
 Schemat blokowy [schematu blokowego](../workflow-designer/flowchart-activity-designers.md) [Flowchart](../workflow-designer/flowchart-activity-designer.md) [FlowSwitch \<T> ](../workflow-designer/flowswitch-t-activity-designer.md)