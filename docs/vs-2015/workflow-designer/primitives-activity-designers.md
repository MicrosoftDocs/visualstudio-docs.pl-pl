...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Umożliwia tworzenie i konfigurowanie <xref:System.Activities.Statements.InvokeMethod> działania.  
  
 [WriteLine](../workflow-designer/writeline-activity-designer.md)  
 Umożliwia tworzenie i konfigurowanie <xref:System.Activities.Statements.WriteLine> działania.  
