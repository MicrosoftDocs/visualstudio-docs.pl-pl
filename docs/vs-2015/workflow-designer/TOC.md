...
#### [Instrukcje: Tworzenie aplikacji konsolowej przepływu pracy](how-to-create-a-workflow-console-application.md)
...
##### [Instrukcje: Tworzenie aplikacji konsolowej sekwencyjnego przepływu pracy (starsza wersja)](how-to-create-sequential-workflow-console-applications-legacy.md)
##### [Instrukcje: Tworzenie aplikacji konsolowej przepływu pracy automatu stanów (starsza wersja)](how-to-create-state-machine-workflow-console-applications-legacy.md)
