---
title: Tworzenie starszych projektów przepływu pracy | Microsoft Docs
ms.date: 11/15/2016
...
|Biblioteka działań przepływu pracy|Projekt służący do tworzenia biblioteki działań, która może zostać później ponownie użyta jako bloki konstrukcyjne w przepływach pracy.|
|Aplikacja konsolowa przepływu pracy automatu Stanów|Projekt służący do tworzenia aplikacji konsolowej przepływu pracy automatu Stanów.|
|Biblioteka przepływu pracy automatu Stanów|Projekt służący do tworzenia biblioteki przepływu pracy automatu Stanów.|
|Pusty projekt przepływu pracy|Pusty projekt służący do tworzenia aplikacji przepływu pracy.|
...
## <a name="see-also"></a>Zobacz też
 [Widoki sekwencyjnego przepływu pracy (starsze)](../workflow-designer/sequential-workflow-views-legacy.md) [okna przepływu pracy programu Visual Studio (starsza wersja)](../workflow-designer/visual-studio-workflow-windows-legacy.md)