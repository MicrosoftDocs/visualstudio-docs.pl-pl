...
- Aby utworzyć aplikacje dla wielu platform przy użyciu Apache Cordova [pobieranie programu Visual Studio Tools for Apache Cordova](https://taco.visualstudio.com/docs/install-vs-tools-apache-cordova/).
