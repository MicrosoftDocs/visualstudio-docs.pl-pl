...
|`ResourceFiles`|Wymagany parametr interfejsu `String`.<br /><br /> Nazwa pliku zasobów, z którego ma zostać utworzona [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] Nazwa manifestu.|  
