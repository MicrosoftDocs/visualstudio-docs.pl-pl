...
Pakiet VSIX można utworzyć w celu zawinięcia [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] rozszerzenia do wdrożenia. Istnieją trzy sposoby tworzenia pakietu:  
  
- Utwórz projekt pakietu VSIX przy użyciu jednego z szablonów rozszerzalności, które znajdują się w [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] zestawie SDK. Jest to najprostsza opcja dla większości scenariuszy.  
