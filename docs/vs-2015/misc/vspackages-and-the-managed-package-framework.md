...
- Korzystanie z [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] szablonu projektu pakietu  
...
- Kompiluj swój pakietu VSPackage bez [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] szablonu projektu pakietu  
