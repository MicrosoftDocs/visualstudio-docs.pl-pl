...
## <a name="NET"></a>Tworzenie aplikacji dla systemów Android, iOS i Windows (.NET Framework)
...
|**Dowiedz się więcej**|
|--------------------|
|Wybierz, czy można udostępnić swój kod za pomocą udostępnionych projektów i/lub projektów biblioteki klas przenośnych.<br /><br /> [Udostępnianie kodu na wielu platformach](https://devblogs.microsoft.com/dotnet/sharing-code-across-platforms/) (blog .NET Framework)<br /><br /> [Udostępnianie opcji kodu](https://docs.microsoft.com/xamarin/cross-platform/app-fundamentals/code-sharing) (Xamarin)<br /><br /> [Opcje udostępniania kodu z .NET Framework](https://msdn.microsoft.com/library/dn720832.aspx) (Biblioteka MSDN)|
...
|[Migrowanie aplikacji do platforma uniwersalna systemu Windows (platformy UWP)](../misc/migrate-apps-to-the-universal-windows-platform-uwp.md)|
...
|--------------------|
|[Zainstaluj program Visual Studio](https://visualstudio.microsoft.com/vs/community/) (VisualStudio.com)|
|[Wprowadzenie do Visual Studio Tools dla Apache Cordova](https://docs.microsoft.com/visualstudio/cross-platform/tools-for-cordova/?view=toolsforcordova-2017) (Taco.VisualStudio.com)|
|[Dowiedz się więcej o programie Visual Studio Emulator for Android](https://visualstudio.microsoft.com/vs/msft-android-emulator/) (VisualStudio.com)|
...
## <a name="CPP"></a>Tworzenie aplikacji dla systemów Android i Windows (C++)
 ...
 Jeśli potrzebujesz do tworzenia aplikacji dla systemu Android, która wymaga dowolny rodzaj manipulowanie grafiki zaawansowane, takie jak gry, można użyć C++, aby to zrobić. Zacznij od projektu **aplikacji native-activity (Android)** . W tym projekcie są pełna obsługa łańcucha narzędzi Clang.
 ...
 Można również utworzyć aplikację, która jest przeznaczony dla rozmaitych urządzeniach z systemem Windows 10 przy użyciu języków C++ i uniwersalnej szablon projektu aplikacji Windows. Więcej informacji na ten temat znajduje się w sekcji [docelowe urządzenia z systemem Windows 10](#WindowsHTML) , która występuje wcześniej w tym temacie.
...
|[Zainstaluj wizualizację C++ dla wieloplatformowych narzędzi programistycznych dla aplikacji mobilnych.](https://msdn.microsoft.com/library/dn872463\(v=vs.140\).aspx) (Biblioteka MSDN)|
|[Dowiedz się więcej C++ o używaniu programu w celu kierowania wielu platform.](https://www.visualstudio.com/vs/cplusplus-mdd/) (VisualStudio.com)|
...
|[Dowiedz się więcej o programie Visual Studio Emulator for Android](https://visualstudio.microsoft.com/vs/msft-android-emulator/) (VisualStudio.com)|
|[Dowiedz się więcej C++ o udostępnianiu kodu w aplikacjach dla systemów Android i Windows](https://visualstudio.microsoft.com/vs/features/cplusplus-mdd/) (VisualStudio.com)|
...
## <a name="Unity"></a>Tworzenie wieloplatformowej gry dla systemów Android, iOS i Windows przy użyciu narzędzi Visual Studio Tools for Unity
...
- [Mobile Services platformy Azure](https://msdn.microsoft.com/library/dn720832\(v=vs.110\).aspx)
