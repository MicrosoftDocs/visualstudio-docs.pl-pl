---
title: Pisanie testów jednostkowych dla .NET Framework za pomocą struktury testów jednostkowych firmy Microsoft dla kodu zarządzanego | Microsoft Docs
ms.date: 11/15/2016
...
W tej sekcji [Przewodnik: Tworzenie i uruchamianie testów jednostkowych dla kodu zarządzanego](../test/walkthrough-creating-and-running-unit-tests-for-managed-code.md)
 ...
 [Korzystanie ze składowych Microsoft.VisualStudio.TestTools.UnitTesting w testach jednostkowych](../test/using-microsoft-visualstudio-testtools-unittesting-members-in-unit-tests.md)
