...
- Należy dodać klucze publiczne testu i podrobionego zestawu do **InternalsVisibleToAttribute** atrybutów w zestawach typu shim. Poniżej przedstawiono, jak nasze przykładowe atrybuty w kodzie zestawu shimmed będzie wyglądać po zestawu typu shim ma silnej nazwy:  
  ...
  Jeśli zestawu typu shim ma silnej nazwy, Fakes framework automatycznie podpisze wygenerowanego zestawu pozornego. Masz silny podpis zestawu testowego. Zobacz [tworzenie i używanie zestawów o silnych nazwach](https://msdn.microsoft.com/library/ffbf6d9e-4a88-4a8a-9645-4ce0ee1ee5f9).  
