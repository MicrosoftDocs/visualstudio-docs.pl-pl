...
1. Sprawdź, czy test jest teraz sterowany danymi, ponownie uruchamiając test.
   ...
   **Wskazówki**
   ...
   Aby uzyskać dodatkowe informacje, zobacz [testowanie ciągłego dostarczania za pomocą programu Visual studio 2012 — Rozdział 2: testowanie jednostkowe: testowanie wewnątrz](http://go.microsoft.com/fwlink/?LinkID=255188) i [testowanie ciągłego dostarczania za pomocą programu Visual Studio 2012 — Rozdział 5: Automatyzowanie testów systemowych](http://go.microsoft.com/fwlink/?LinkID=255196)
