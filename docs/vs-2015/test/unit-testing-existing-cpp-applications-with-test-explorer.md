...
2. Dodaj klasy testów i metody do plików testów jednostkowych kodu. Na przykład:  
   ...
   Aby uzyskać więcej informacji, zobacz [testy jednostkowe kodu natywnego za pomocą narzędzia Eksplorator testów](https://msdn.microsoft.com/8a09d6d8-3613-49d8-9ffe-11375ac4736c).  
