...
|Architektura|x86 i x64 **Uwaga:**  Program Internet Explorer nie jest obsługiwane w trybie 64-bitowym z wyjątkiem sytuacji, gdy jest uruchomiona w [!INCLUDE[win8](../includes/win8-md.md)] lub nowszej wersji.|  
