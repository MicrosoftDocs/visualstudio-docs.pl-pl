...
|MFC|Obsługiwane częściowo. Zobacz następującą [witrynę sieci Web firmy Microsoft](https://go.microsoft.com/fwlink/?LinkId=206511) , aby uzyskać szczegółowe informacje o obsługiwanych funkcjach.|
...
|Klient Dynamics (Ax) 2012|Akcje odtwarzania i nagrywania są obsługiwane częściowo. Aby uzyskać szczegółowe informacje, zobacz następującą [witrynę sieci Web firmy Microsoft](https://go.microsoft.com/fwlink/?LinkId=232677) .|
|SAP|Nieobsługiwane.|
