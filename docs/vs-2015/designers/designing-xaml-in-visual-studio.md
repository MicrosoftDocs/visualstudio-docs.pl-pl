...
### <a name="shared-capabilities"></a>Udostępnione możliwości
 W przypadku większości podstawowych zadań środowisko IDE dla programu Visual Studio i Blend for Visual Studio współdzielą ten sam zestaw okien i możliwości, z niewielkimi różnicami. Niektóre najważniejsze elementy to:
