---
title: Właściwości dynamiczne klasy XElement | Microsoft Docs
ms.date: 11/15/2016
...
W tej sekcji opisano właściwości dynamiczne <xref:System.Xml.Linq.XElement?displayProperty=fullName> [t] (<!-- TODO: review code entity reference <xref:assetId:///t?qualifyHint=False&amp;autoUpgrade=True>  -->określonej.

## <a name="in-this-section"></a>W tej sekcji

|Temat|Opis|
|-----------|-----------------|
|[Atrybut](../designers/attribute-xelement-dynamic-property.md)|Pobiera indeksator używany do pobierania atrybutu, który odnosi się do określonej rozwiniętej nazwy.|
|[Element](../designers/element-xelement-dynamic-property.md)|Pobiera indeksator używany do pobierania elementu podrzędnego, który odnosi się do określonej rozwiniętej nazwy.|
