---
title: Element LocalizedDescription (VSIX Language Pack schemat) | Dokumentacja firmy Microsoft
ms.date: 11/15/2016
...
ms.locfileid: "54764139"
---
# <a name="localizeddescription-element-vsix-language-pack-schema"></a>Element LocalizedDescription (schemat VSIX Language Pack)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Wymagana. Zapewnia zlokalizowany opis rozszerzenia.  
...
## <a name="text-value"></a>Wartość tekstowa  
 Wymagana. Opis tekstowy rozszerzenia w języku docelowym.  
