...
|||Element źródłowy: Odwołanie/łącze|Element źródłowy: Fizyczny element lub systemu plików (CF_HDROP)|
|-|-|----------------------------------|-------------------------------------------------------------|
