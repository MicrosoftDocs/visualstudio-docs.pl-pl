...
## <a name="implementing-an-itagger"></a>Implementowanie elementu ITagger  
...
5. Należy również dodać `TagsChanged` zdarzenie, które zostanie wywołane przez metodę Update.  
