...
## <a name="in-this-section"></a>W tej sekcji
 ...
 [Konfiguracja konfiguracji](https://msdn.microsoft.com/library/faa4ed55-66ce-4792-939f-a5b093f13a2e) Skonfiguruj interfejs API konfiguracji do odnajdywania wystąpień programu Visual Studio 2017.

 [Rozszerzalność folderu Open](https://msdn.microsoft.com/library/0897ae3d-6a09-4d26-90c9-7f3d0b8e5c5d) Interfejs API obszaru roboczego dla folderu Open w programie Visual Studio 2017.
 ...
 <xref:Microsoft.VisualStudio.Text.Document>Klasy używane w nowym edytorze dla dokumentów.
 ...
 <xref:Microsoft.VisualStudio.Shell.Design.Serialization>Klasy używane w powłoce programu Visual Studio.
 ...
 <xref:Microsoft.VisualStudio.VCCodeModel>Używany do automatyzacji C++ projektu Visual.

 <xref:Microsoft.VisualStudio.VCProject>Klasy używane do automatyzacji C++ projektu Visual.

 <xref:Microsoft.VisualStudio.VCProjectEngine>Używany do automatyzacji C++ projektu Visual.

 <xref:Microsoft.VisualStudio.VsWizard>Używany przez kreatora programu Visual Studio.

 <xref:VSLangProj>Używany do C# automatyzacji projektu i Visual Basic.

 <xref:VSLangProj2>Używany do C# automatyzacji projektu i Visual Basic.

 <xref:VSLangProj80>Używany do C# automatyzacji projektu i Visual Basic.

 <xref:VslangProj90>Używany do C# automatyzacji projektu i Visual Basic.

 <xref:VslangProj100>Używany do C# automatyzacji projektu i Visual Basic.

 <xref:VSLangProj110>Używany do C# automatyzacji projektu i Visual Basic.

 <xref:VSLangProj140>Używany do C# automatyzacji projektu i Visual Basic.

 <xref:Microsoft.VisualStudio.Language.CallHierarchy>Używany do C# automatyzacji i Visual Basic.

 <xref:Microsoft.VisualStudio.Language.NavigateTo.Interfaces>Używany do C# automatyzacji i Visual Basic.

 <xref:Microsoft.VisualStudio.Threading>Używane dla wątków programu Visual Studio.

 <xref:Microsoft.VisualStudio.ConnectedServices?qualifyHint=False&autoUpgrade=True>Używane dla usług połączonych programu Visual Studio.
 ...
 <xref:Microsoft.Build.Tasks.Hosting>Używany dla programu MSBuild.
...
## <a name="related-sections"></a>Sekcje pokrewne
 [Visual Studio SDK](../extensibility/visual-studio-sdk.md) Zawiera dokumentację, przykłady i kod ułatwiający opracowywanie produktów, które integrują się z programem Visual Studio.
