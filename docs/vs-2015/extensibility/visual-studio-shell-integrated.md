...
|{1&gt;Kompilacja&lt;1}|-Niestandardowe kroki kompilacji w środowisku IDE<br />— Wstępna kompilacja dla ochrony własności intelektualnej (IP)<br />-Podpisywanie kodu<br />     MSBuild|  
...
|Designer|— Projektant Windows Presentation Foundation<br />-Projektant formularzy systemu Windows<br />— Projektant sieci Web i Edytor HTML|  
