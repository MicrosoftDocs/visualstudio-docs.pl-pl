...
Wizualizatory typów i podglądy niestandardowe przedstawiają dane w sposób, który jest szybko zrozumiały dla dewelopera. Ewaluatora wyrażeń (EE) może obsługiwać Wizualizatory typu innych firm, a także dostarczać własne przeglądarki niestandardowe.  
 ...
 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] Określa, ile wizualizatorów typów i przegląda niestandardowych są skojarzone z typem obiektu przez wywołanie metody [GetCustomViewerCount](../../extensibility/debugger/reference/idebugproperty3-getcustomviewercount.md) . Jeśli istnieje co najmniej jeden wizualizator typu lub przeglądarka niestandardowa, program Visual Studio wywołuje metodę [GetCustomViewerList](../../extensibility/debugger/reference/idebugproperty3-getcustomviewerlist.md) , aby pobrać listę wizualizacji i osób przeglądających (w rzeczywistości listę `CLSID` s, które implementują Wizualizatory i osoby przeglądające), i prezentuje je użytkownikowi.  
  
## <a name="supporting-type-visualizers"></a>Wizualizatory typów pomocniczych  
 Istnieje wiele interfejsów, które należy zaimplementować na potrzeby obsługi wizualizatorów typu EE. Te interfejsy można podzielić na dwie szerokie Kategorie: te, które wyświetlają Wizualizatory typów i te, które uzyskują dostęp do danych właściwości.  
