...
#### <a name="parameters"></a>Parametry  
 ...
 `pguidLanguage`  
 określoną Zwraca identyfikator GUID języka, który implementuje kod w tym kontekście dokumentu. Na przykład: `guidVBScriptLang` lub `guidCPPLang`. Ten identyfikator GUID nie jest ograniczony do języków dostarczonych przez program [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] .  
