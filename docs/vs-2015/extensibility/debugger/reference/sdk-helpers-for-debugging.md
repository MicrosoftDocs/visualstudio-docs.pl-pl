...
## <a name="requirements"></a>Wymagania  
 Te pliki znajdują się w [!INCLUDE[vs_dev10_ext](../../../includes/vs-dev10-ext-md.md)] katalogu instalacyjnym zestawu SDK (domyślnie *[dysk]* \Program Files\Microsoft Visual Studio 2010 SDK \\ ).  
