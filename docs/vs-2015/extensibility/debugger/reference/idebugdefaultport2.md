...
## <a name="notes-for-callers"></a>Uwagi dotyczące wywoływania  
 Argument metod w interfejsie [IDebugProgramProvider2](../../../extensibility/debugger/reference/idebugprogramprovider2.md) dostarcza ten interfejs. Wywołanie [polecenia QueryInterface](https://msdn.microsoft.com/library/62fce95e-aafa-4187-b50b-e6611b74c3b3) w interfejsie [IDebugPort2](../../../extensibility/debugger/reference/idebugport2.md) może również uzyskać ten interfejs.  
