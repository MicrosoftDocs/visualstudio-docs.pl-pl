...
## <a name="create-your-own-sdks"></a>Tworzenie własnych zestawów SDK
 Dowiedz się, jak utworzyć pakiet i wdrażanie własnych zestawów SDK platformy i rozszerzenia: [Tworzenie Software Development Kit](../extensibility/creating-a-software-development-kit.md).
