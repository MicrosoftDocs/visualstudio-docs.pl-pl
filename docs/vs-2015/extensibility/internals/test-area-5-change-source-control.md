...
## <a name="command-menu-access"></a>Dostęp do menu poleceń  
 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]W przypadku testów użyto następującej ścieżki menu zintegrowanego środowiska deweloperskiego.  
