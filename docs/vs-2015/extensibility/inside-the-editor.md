---
title: Wewnątrz edytora | Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "64837893"
---
# <a name="inside-the-editor"></a>Wewnątrz edytora
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Edytor składa się z różnych podsystemów, które zostały zaprojektowane, aby zachować niezależny model tekstu edytora od widoku tekstu i interfejsu użytkownika.  
  
 W tych sekcjach opisano różne aspekty edytora:  
  
- [Przegląd podsystemów](../extensibility/inside-the-editor.md#overview)  
...
- [Tagi i klasyfikatory](../extensibility/inside-the-editor.md#tagsandclassifiers)  
...
## <a name="overview-of-the-subsystems"></a><a name="overview"></a> Przegląd podsystemów  
...
- System do opisywania tekstu w buforze pod warunkiem podzbiorów tekstu w innych buforach.  
  ...
  Typy publiczne podsystemu modelu tekstowego są zawarte w Microsoft.VisualStudio.Text.Data.dll i Microsoft.VisualStudio.CoreUtilitiy.dll, które są zależne tylko od .NET Framework biblioteki klas podstawowych i Managed Extensibility Framework (MEF).  
...
### <a name="the-text-model"></a><a name="textmodel"></a> Model tekstu  
...
#### <a name="text-buffers-and-text-snapshots"></a>Bufory tekstu i migawki tekstu  
 ...
 Bufor tekstowy może być edytowany przez dowolny wątek, dopóki wątek nie przejmie na własność buforu tekstu przez wywołanie <xref:Microsoft.VisualStudio.Text.ITextBuffer.TakeThreadOwnership%2A> . Następnie tylko ten wątek może wykonywać edycję.  
...
#### <a name="tracking-points-and-tracking-spans"></a>Punkty śledzenia i zakres śledzenia  
 ...
 <xref:Microsoft.VisualStudio.Text.ITrackingSpan>Reprezentuje zakres znaków zamiast tylko jednego położenia. Jego zachowanie zależy od jego <xref:Microsoft.VisualStudio.Text.SpanTrackingMode> . Jeśli tryb śledzenia zakresu ma wartość <xref:Microsoft.VisualStudio.Text.SpanTrackingMode> , zakres śledzenia powiększa się w celu uwzględnienia tekstu wstawionego na krawędziach. Jeśli tryb śledzenia obejmuje <xref:Microsoft.VisualStudio.Text.SpanTrackingMode> , zakres śledzenia nie uwzględnia tekstu wstawionego na jego krawędzi. Jeśli jednak tryb śledzenia zakresu ma wartość <xref:Microsoft.VisualStudio.Text.SpanTrackingMode> , wstawianie powoduje wypchnięcie bieżącej pozycji do początku i w przypadku trybu śledzenia zakresu <xref:Microsoft.VisualStudio.Text.SpanTrackingMode> , wstawienie powoduje wypchnięcie bieżącego położenia do końca.  
...
### <a name="the-text-view"></a><a name="textview"></a> Widok tekstu  
...
### <a name="tags-and-classifiers"></a><a name="tagsandclassifiers"></a> Tagi i klasyfikatory  
...
#### <a name="classification-types"></a>Classification Types (Typy klasyfikacji)  
...
#### <a name="classification-formatting-and-text-coloring"></a>Formatowanie klasyfikacji i kolorowanie tekstu  
 Formatowanie tekstu to przykład funkcji, która jest oparta na klasyfikacji tekstu. Jest on używany przez warstwę widoku tekstu do określenia sposobu wyświetlania tekstu w aplikacji. Obszar formatowania tekstu jest zależny od platformy WPF, ale logiczna definicja klasyfikacji nie jest.  
...
### <a name="adornments"></a><a name="adornments"></a> Zakończeń  
...
### <a name="outlining"></a><a name="outlining"></a> Konspekt  
...
### <a name="mouse-bindings"></a><a name="mousebindings"></a> Powiązania myszy  
...
### <a name="editor-operations"></a><a name="editoroperations"></a> Operacje edytora  
...
### <a name="intellisense"></a><a name="intellisense"></a> Technologia  
