...
|----------|---------------------|  
|Dołącz profiler do działającej aplikacji platformy ASP.NET|-   [Jak: Dołączanie profilera do aplikacji ASP.NET w celu zbierania danych współbieżności](../profiling/how-to-attach-the-profiler-to-an-aspnet-web-application-to-collect-concurrency-data-by-using-the-command-line.md)|  
...
### <a name="profiling-aspnet-applications"></a>Profilowanie aplikacji ASP.NET  
...
### <a name="profiling-concurrency-issues"></a>Profilowanie problemów współbieżności  
  
|Zadanie|Powiązana zawartość|  
|----------|---------------------|  
|**Profil aplikacji autonomicznej (klienta)**|-   [Zbieranie danych współbieżności](../profiling/collecting-concurrency-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
