---
title: 'Instrukcje: dołączanie profilera do aplikacji sieci Web ASP.NET w celu zbierania statystyk aplikacji przy użyciu wiersza polecenia | Microsoft Docs'
ms.date: 11/15/2016
...
W tym temacie opisano, jak używać [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] narzędzi wiersza polecenia narzędzia profilowania do dołączania profilera do aplikacji sieci Web ASP.NET i zbierania statystyk wydajności przy użyciu metody próbkowania.  
...
## <a name="ending-the-profiling-session"></a>Kończenie sesji profilowania  
 Aby zakończyć sesję profilowania, Zamknij [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] aplikację sieci Web, a następnie użyj polecenia Internet Information Services (IIS) **IISReset** , aby zamknąć [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] proces roboczy. Wywołaj opcję **VSPerfCmd** [/Shutdown](../profiling/shutdown.md) , aby wyłączyć profiler i zamknąć plik danych profilowania.  
...
1. Wykonaj jedną z następujących czynności, aby odłączyć Profiler od aplikacji docelowej:  
    ...
    - Zamknij [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] proces roboczy.  
