---
title: 'Instrukcje: Instrumentacja usługi natywnej i zbieranie szczegółowych danych o chronometrażu przy użyciu wiersza polecenia profilera | Microsoft Docs'
ms.date: 11/15/2016
...
W tym temacie opisano, jak używać [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] narzędzi wiersza polecenia narzędzia profilowania do instrumentowania natywnej usługi (C/C++) i zbierania szczegółowych danych o chronometrażu.  
