...
#### <a name="parameters"></a>Parametry  
 ...
 `ppSpan`  
 Adres zmiennej, która będzie przechowywać obiekt zakresu wyników. Adres nie może mieć wartości NULL, zmienna może mieć dowolną wartość.  
