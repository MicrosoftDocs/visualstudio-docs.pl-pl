...
|**Pokrycie**|Wykonuje Instrumentację pokrycia. Może być może być używana tylko z następujących opcji: **Pełne**, **OutputPath**, **wykluczyć**, i **Logfile**...|  
