...
|**Wdróż aplikację lub usługę ASP.NET:** Aplikacje i usługi ASP.NET można wdrożyć na wiele różnych sposobów.|[Wdrażanie aplikacji i usług sieci Web ASP.NET](/aspnet/mvc/overview/deployment/)|  
...
|**Wdróż usługę WCF:** Inne aplikacje mogą używać usług WCF RIA wdrożonych na serwerze sieci Web.|[Wdrażanie rozwiązań usług WCF RIA](https://msdn.microsoft.com/library/ff426912\(v=vs.91\).aspx)|  
|**Wdróż usługę OData:** Inne aplikacje mogą używać usług OData wdrożonych na serwerze sieci Web.|[Wdrażanie usługi OData](https://msdn.microsoft.com/library/hh973447.aspx)|  
...
|**Utwórz program instalacyjny:** Program instalacyjny można utworzyć za pomocą InstallShield Limited Edition, który jest bezpłatny.|[InstallShield Limited Edition](../deployment/installshield-limited-edition.md)|  
...
|**Zainstaluj wymagania wstępne:** Wstępnie wymagane składniki dla aplikacji klasycznych można zainstalować, konfigurując Instalator generyczny, który jest znany jako program inicjujący.|[Wstępnie wymagane składniki wdrażania aplikacji](../deployment/application-deployment-prerequisites.md)|
