...
> [!NOTE]
> Aby dodać pakiet instalacyjny dla programu .NET Framework, zobacz [.NET Framework — przewodnik wdrażania dla deweloperów](https://msdn.microsoft.com/library/ee942965\(v=vs.110\).aspx).  
