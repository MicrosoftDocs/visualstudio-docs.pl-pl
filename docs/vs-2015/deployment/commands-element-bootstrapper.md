...
`Commands`Element implementuje testy opisane przez elementy poniżej `InstallChecks` elementu i deklaruje pakiet, który program [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] inicjujący powinien zainstalować, jeśli test zakończy się niepowodzeniem.  
