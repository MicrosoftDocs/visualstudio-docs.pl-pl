...
- Aby zainstalować zestaw SDK, użyj [indeksu pakietu języka Python](https://pypi.python.org/pypi/azure) lub [Zainstaluj Język Python i zestaw SDK](/azure/developer/python/azure-sdk-install) w dokumentacji platformy Azure. 
...
[Wprowadzenie z PTVS: Konfigurowanie programu Visual Studio](../python/getting-started-with-ptvs-setting-up-visual-studio.md) 
 ...
 [Wprowadzenie z PTVS: kompilowanie witryny sieci Web na platformie Azure](../python/getting-started-with-ptvs-building-a-website-in-azure.md)
