...
```  
 ...
 Można określić własnego edytora lub Edytor podane w [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)], takich jak <xref:System.Windows.Forms.Design.FileNameEditor> lub <xref:System.Drawing.Design.ImageEditor>. Na przykład użyj następującej procedury, aby właściwość, w którym użytkownik może wprowadzić nazwę pliku.  
