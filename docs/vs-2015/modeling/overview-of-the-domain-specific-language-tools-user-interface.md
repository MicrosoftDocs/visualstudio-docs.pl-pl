...
Po pierwszym otwarciu rozwiązania narzędzia języka specyficznego dla domeny (narzędzia DSL) w [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] interfejs użytkownika będzie wyglądał na poniższym obrazie.
