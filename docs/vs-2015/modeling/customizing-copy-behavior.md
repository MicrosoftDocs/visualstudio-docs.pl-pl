...
W języku specyficznym dla domeny (DSL) utworzonym za pomocą [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] wizualizacji i modelowania SDK można zmienić to, co się dzieje, gdy użytkownik kopiuje i wklei elementy.
