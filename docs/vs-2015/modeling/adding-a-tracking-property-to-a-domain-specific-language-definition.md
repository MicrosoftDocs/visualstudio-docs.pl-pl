---
title: Dodawanie właściwości śledzenia do definicji języka specyficznego dla domeny | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="customizing-the-default-dsl-definition"></a>Dostosowywanie domyślnej definicji DSL
...
#### <a name="to-transform-the-text-templates"></a>Aby przekształcić szablony tekstu
...
## <a name="creating-files-for-custom-code"></a>Tworzenie plików dla niestandardowego kodu
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>Aby zaktualizować pakiet DSL w celu użycia niestandardowego deskryptora typu
