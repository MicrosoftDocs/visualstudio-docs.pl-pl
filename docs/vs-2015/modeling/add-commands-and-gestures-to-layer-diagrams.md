...
3. Aby przetestować rozszerzenie, naciśnij **klawisze CTRL + F5** lub **F5**.
    ...
    Doświadczalne wystąpienie [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] uruchomienia. W tym przypadku Utwórz diagram warstwowy. Rozszerzenie polecenia lub gestu powinno być wykonane na tym diagramie.
...
1. Utwórz projekt biblioteki klas w nowym lub istniejącym rozwiązaniu programu Visual Studio. W oknie dialogowym **Nowy projekt** kliknij pozycję **Visual C#** , a następnie kliknij pozycję **Biblioteka klas**. Ten projekt będzie zawierać polecenia lub klasy obsługi gestów.
...
2. Zidentyfikuj lub Utwórz projekt VSIX w rozwiązaniu. Projekt VSIX zawiera plik o nazwie **source. Extension. vsixmanifest**. Aby dodać projekt VSIX:
    ...
    1. W oknie dialogowym **Nowy projekt** rozwiń węzeł **Visual C#**, a następnie kliknij pozycję **rozszerzalność**, a następnie kliknij pozycję **Projekt VSIX**.
...
1. Edytuj plik klasy w projekcie biblioteki klas C#, aby zawierał kod dla rozszerzenia. Aby uzyskać więcej informacji, zobacz jedną z następujących sekcji:
...
2. Aby przetestować tę funkcję, naciśnij klawisze CTRL + F5 lub F5. Doświadczalne wystąpienie [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] zostanie otwarte. W tym wystąpieniu Utwórz lub Otwórz diagram warstwowy.
