...
## <a name="what-commands-can-you-modify"></a><a name="what"></a> Jakie polecenia można modyfikować?
...
## <a name="extend-the-appropriate-command-set-class"></a><a name="extend"></a> Poszerzenie odpowiedniej klasy zestawu poleceń
...
## <a name="override-the-command-methods"></a><a name="override"></a> Zastąp metody polecenia
