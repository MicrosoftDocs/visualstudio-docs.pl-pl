---
title: 'Przewodnik: Generowanie kodu przy użyciu szablonów tekstowych | Dokumentacja firmy Microsoft'
ms.date: 11/15/2016
...
```  
 ...
 Na tym etapie .cs wygenerowany plik zawiera następujące deklaracje:  
