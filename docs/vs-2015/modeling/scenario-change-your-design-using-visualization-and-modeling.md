...
## <a name="understanding-and-communicating-information-about-the-system"></a><a name="UnderstandingCommunicating"></a> Zrozumienie i przekazywanie informacji o systemie
...
|*Diagram aktywności (UML)*<br /><br /> Zobacz:<br /><br /> -   [Diagramy aktywności UML: odwołanie](../modeling/uml-activity-diagrams-reference.md)<br />-   [Diagramy aktywności UML: wytyczne](../modeling/uml-activity-diagrams-guidelines.md)|Przepływ kroków, które występują, gdy klient tworzy zamówienie|
...
### <a name="describing-new-or-updated-user-requirements"></a><a name="DescribingURM"></a> Opisywanie nowych lub zaktualizowanych wymagań użytkowników
...
|*Diagram aktywności (UML)*<br /><br /> Zobacz:<br /><br /> -   [Diagramy aktywności UML: odwołanie](../modeling/uml-activity-diagrams-reference.md)<br />-   [Diagramy aktywności UML: wytyczne](../modeling/uml-activity-diagrams-guidelines.md)|Kroki, które należy wykonać, gdy klient chce napisać przegląd restauracji|
...
|**Schematów**|**Szczegół**|
|------------------|-------------------|
|*Diagram aktywności (UML)*<br /><br /> Zobacz:<br /><br /> -   [Diagramy aktywności UML: odwołanie](../modeling/uml-activity-diagrams-reference.md)<br />-   [Diagramy aktywności UML: wytyczne](../modeling/uml-activity-diagrams-guidelines.md)|Przepływ kroków, które występują, gdy system wykryje, że klient ponownie umieści zamówienie z restauracji, monitując klienta o napisanie przeglądu.|
...
### <a name="keeping-code-consistent-with-the-design"></a><a name="ValidatingCode"></a> Zachowywanie spójności kodu w projekcie
...
### <a name="general-tips-for-creating-and-using-models"></a><a name="GeneralTips"></a> Ogólne porady dotyczące tworzenia i używania modeli
...
### <a name="testing-validating-and-checking-in-code"></a><a name="TestValidateCheckInCode"></a> Testowanie, sprawdzanie poprawności i ewidencjonowanie kodu
...
## <a name="updating-the-system-using-visualization-and-modeling"></a><a name="UpdatingSystem"></a> Aktualizowanie systemu przy użyciu wizualizacji i modelowania
...
### <a name="understand-the-user-requirements-use-case-diagrams"></a><a name="UnderstandUseCases"></a> Informacje o wymaganiach użytkownika: diagramy przypadków użycia
...
### <a name="understand-the-business-process-activity-diagrams"></a><a name="UnderstandActivities"></a> Poznaj proces biznesowy: diagramy aktywności
...
### <a name="describe-the-system-structure-component-diagrams"></a><a name="DescribeComponents"></a> Opisz strukturę systemu: diagramy składników
...
|Diagramu aktywności|Wizualizuj wewnętrzne przetwarzanie wykonywane przez składniki w odpowiedzi na komunikaty przychodzące.<br /><br /> Zobacz:<br /><br /> -   [Diagramy aktywności UML: odwołanie](../modeling/uml-activity-diagrams-reference.md)<br />-   [Diagramy aktywności UML: wytyczne](../modeling/uml-activity-diagrams-guidelines.md)|
...
### <a name="describe-the-interactions-sequence-diagrams"></a><a name="DescribeSequence"></a> Opisywanie interakcji: diagramy sekwencji
...
- Podczas *synchronicznego* komunikatu obiekt nadawcy czeka na kontrolkę, która <\<return>> tak jak w przypadku zwykłego wywołania funkcji. W komunikacie *asynchronicznym* nadawca może natychmiast kontynuować pracę.

- Użyj <\<create>> komunikatów, aby wskazać konstrukcję obiektów przez inne obiekty. Powinien to być pierwszy komunikat wysyłany do obiektu.
...
|Diagramu aktywności|Zdefiniuj typy danych przekazywane przez węzły obiektów, numery PIN wejścia, PIN wyjściowe i węzły parametrów działania.<br /><br /> Zobacz:<br /><br /> -   [Diagramy aktywności UML: odwołanie](../modeling/uml-activity-diagrams-reference.md)<br />-   [Diagramy aktywności UML: wytyczne](../modeling/uml-activity-diagrams-guidelines.md)|
...
### <a name="describe-the-logical-architecture-layer-diagrams"></a><a name="DescribeLayers"></a> Opisywanie architektury logicznej: diagramy warstwowe
...
## <a name="see-also"></a>Zobacz też
 [Wizualizowanie kodu](../modeling/visualize-code.md) [Tworzenie modeli dla aplikacji](../modeling/create-models-for-your-app.md) [Używanie modeli w procesie programistycznym](../modeling/use-models-in-your-development-process.md) [Korzystanie z modeli w programowaniu Agile](https://msdn.microsoft.com/592ac27c-3d3e-454a-9c38-b76658ed137f) [weryfikacja systemu podczas programowania](../modeling/validate-your-system-during-development.md) [Extend UML models and diagrams](../modeling/extend-uml-models-and-diagrams.md)
