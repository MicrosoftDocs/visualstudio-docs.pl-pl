---
title: Dostosowywanie tworzenia i przenoszenia elementów | Microsoft Docs
ms.date: 11/15/2016
...
- Kod programu wywołuje dyrektywę scalenia elementów.
  ...
  ![Scalanie&#45;EMD&#95;DSL](../modeling/media/dsl-emd-merge.png "DSL — EMD_Merge") Rola dyrektywy scalania elementów
...
## <a name="defining-an-element-merge-directive"></a>Definiowanie dyrektywy scalania elementów
 ...
 ![Szczegóły&#95;&#45;DSL EMD](../modeling/media/dsl-emd-details.png "DSL — EMD_Details")
...
4. W obszarze **Scal proces przez utworzenie linków**Dodaj dwie ścieżki:
   ...
   2. Druga ścieżka łączy nowy element z istniejącym elementem. Wyrażenie path określa relację odwołania i rolę, do której zostanie przypisany nowy element. Ta ścieżka jest następująca:

       `ExampleElementReferencesTargets.Sources`

      Możesz użyć narzędzia do nawigacji ścieżki, aby utworzyć każdą ścieżkę:

   3. W obszarze **proces scalania przez tworzenie linków w ścieżkach**kliknij pozycję **\<add path>** .

   4. Kliknij strzałkę listy rozwijanej z prawej strony elementu listy. Zostanie wyświetlony widok drzewa.

   5. Rozwiń węzły w drzewie, aby utworzyć ścieżkę, którą chcesz określić.
...
5. Testowanie DSL:
   ...
   2. Po rozpoczęciu eksperymentalnego wystąpienia programu [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Otwórz plik modelu DSL. Utwórz Przykładowe elementy.
...
6. Testowanie DSL:
    ...
    1. Naciśnij klawisz F5, aby skompilować ponownie rozwiązanie. Gdy doświadczalne wystąpienie [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] zostanie otwarte, Otwórz wystąpienie elementu DSL.

    2. Utwórz nowe elementy na kilka sposobów:

        1. Przeciągnij z **przykładowego narzędzia elementu** na diagram.

        2. W **przykładowym Eksploratorze modelu**kliknij prawym przyciskiem myszy węzeł główny, a następnie kliknij polecenie **Dodaj nowy przykładowy element**.

        3. Skopiuj i Wklej element na diagramie.
...
1. Utwórz [!INCLUDE[dsl](../includes/dsl-md.md)] rozwiązanie przy użyciu szablonu modelu składnika.
...
10. Skompiluj i uruchom rozwiązanie. Pojawi się nowe wystąpienie [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] .
