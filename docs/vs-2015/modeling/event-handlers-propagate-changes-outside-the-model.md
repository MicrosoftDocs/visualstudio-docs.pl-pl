---
title: Programy obsługi zdarzeń propagują zmiany poza modelem | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="using-events-to-make-undoable-adjustments-in-the-store"></a>Używanie zdarzeń do wprowadzania zmian w sklepie
...
## <a name="see-also"></a>Zobacz też
 [Odpowiadanie na kod przykładowy i propagowanie zmian](../modeling/responding-to-and-propagating-changes.md) [: diagramy obwodów](http://code.msdn.microsoft.com/Visualization-Modeling-SDK-763778e8)
