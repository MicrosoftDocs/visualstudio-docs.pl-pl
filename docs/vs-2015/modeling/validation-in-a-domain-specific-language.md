---
title: Walidacja w języku specyficznym dla domeny | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>Zobacz też
 [Nawigowanie i aktualizowanie modelu w](../modeling/navigating-and-updating-a-model-in-program-code.md) programie [obsługi zdarzeń kodu programu propaguje zmiany poza modelem](../modeling/event-handlers-propagate-changes-outside-the-model.md)
