---
title: Używanie środowiska programistycznego dla języka C# | Microsoft Docs
ms.date: 11/15/2016
...
Zintegrowane środowisko programistyczne (IDE) programu Visual Studio to zbiór narzędzi programistycznych udostępnianych za pomocą wspólnego interfejsu użytkownika. Niektóre narzędzia są udostępniane innym [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] językom, a niektóre, takie jak kompilator języka C#, są unikatowe dla języka Visual C#. Ten temat zawiera łącza do najwa‪żniejszych narzędzi języka Visual C#.
...
|[IntelliSense Visual C#](../ide/visual-csharp-intellisense.md)|Łącza do tematów opisujących funkcje charakterystyczne dla języka Visual C#, takie jak automatyczna generacja kodu oraz technologia IntelliSense dla ostatnio używanych elementów członkowskich.|
|[Fragmenty kodu w języku Visual C#](../ide/visual-csharp-code-snippets.md)|Omówienie sposobu użycia fragmentów kodu w języku Visual C# do automatycznego dodawania typowych konstrukcji kodu do aplikacji.|
...
|[Debugowanie w Visual Studio](../debugger/debugging-in-visual-studio.md)|Opis sposobu uruchamiania debugera programu Visual Studio w celu wykrywania błędów logicznych i semantycznych.|
|[Zarządzanie zasobami aplikacji (.NET)](../ide/managing-application-resources-dotnet.md)|Informacje dotyczące dodawania i edytowania zasobów projektu, takich jak ciągi, obrazy, ikony, dźwięki oraz pliki.|

## <a name="see-also"></a>Zobacz też

- [C#](https://msdn.microsoft.com/library/7f4f8103-7068-4f1d-92c7-3c4519b6edbc)
- [Wprowadzenie przy użyciu języka C #](https://msdn.microsoft.com/library/d6ec050f-3956-4737-8030-a4fa3521d29f)
- [Odwołanie w C#](https://msdn.microsoft.com/library/06de3167-c16c-4e1a-b3c5-c27841d4569a)