---
title: Konfigurowanie projektu platformy Azure przy użyciu wielu konfiguracji usługi | Microsoft Docs
...
Na stronie **Ustawienia** można dodać ustawienia do konfiguracji jako pary nazwa-wartość. Kod uruchomiony w roli może odczytywać wartości ustawień konfiguracji w czasie wykonywania przy użyciu klas dostarczonych przez [bibliotekę zarządzaną platformy Azure](/previous-versions/azure/dn602775(v=azure.11)), w tym metodę [GetConfigurationSettingValue](/previous-versions/azure/reference/ee772857(v=azure.100)) .
