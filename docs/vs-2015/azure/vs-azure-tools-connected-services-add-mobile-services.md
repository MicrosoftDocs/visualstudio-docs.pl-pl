...
1. Upewnij się, że masz konto platformy Azure. Jeśli nie masz konta platformy Azure, możesz zarejestrować się, aby skorzystać z [bezpłatnej wersji próbnej](https://go.microsoft.com/fwlink/?LinkId=518146).
...
3. W oknie dialogowym **Dodawanie podłączonej usługi** wybierz pozycję **Azure Mobile Services**, a następnie wybierz przycisk **Konfiguruj** . Może zostać wyświetlony monit do zalogowania się do platformy Azure, jeśli jeszcze tego nie zrobiłeś.

    ![Dodawanie usługi mobilnej Azure](./media/vs-azure-tools-connected-services-add-mobile-services/IC797636.png)
4. W oknie dialogowym **Mobile Services platformy Azure** wybierz istniejącą usługę mobilną, jeśli ją masz. Jeśli musisz utworzyć nową usługę mobilną systemu Azure, postępuj zgodnie z poniższą procedurą, aby to zrobić. W przeciwnym razie pomiń ten krok i przejdź do następnego kroku.

    Aby utworzyć nowe konto usługi mobilnej:

   1. Wybierz łącze **Utwórz usługę** u dołu okna dialogowego.
       ![dodać nowej usługi połączonej z usługą mobilną](./media/vs-azure-tools-connected-services-add-mobile-services/IC797637.png)
...
Jak program Visual Studio modyfikuje projekt zależy od typu projektu. W C# przypadku aplikacji klienckich zobacz [co się stało C# — projekty](https://go.microsoft.com/fwlink/p/?LinkId=513119). W przypadku aplikacji klienckich w języku JavaScript Zobacz, [co się stało — projekty JavaScript](https://go.microsoft.com/fwlink/p/?LinkId=513120). W przypadku aplikacji oprogramowania Cordova Zobacz, [co się stało — projekty oprogramowania Cordova](https://go.microsoft.com/fwlink/p/?LinkId=513116).
