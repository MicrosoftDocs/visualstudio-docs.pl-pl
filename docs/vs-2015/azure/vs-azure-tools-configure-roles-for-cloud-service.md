...
- **ServiceDefinition.csdef** — plik definicji usługi definiuje ustawienia środowiska uruchomieniowego usługi w chmurze, w tym jakie role są wymagane, punkty końcowe i rozmiar maszyny wirtualnej. Żadne dane przechowywane `ServiceDefinition.csdef` w można zmienić, gdy rola jest uruchomiona.
