...
Możesz rozszerzyć funkcjonalność `TableAdapter` przez utworzenie pliku częściowej klasy dla `TableAdapter` i dodając kod do jego (zamiast opcji dodawania kodu *DatasetName*. Plik DataSet.Designer). Klasy częściowe Włącz kod dla określonej klasy do podzielone między wiele plików fizycznych. Aby uzyskać więcej informacji, zobacz [częściowe](https://msdn.microsoft.com/library/7adaef80-f435-46e1-970a-269fff63b448) lub [partial (typ)](https://msdn.microsoft.com/library/27320743-a22e-4c7b-b0b3-53afe3607334).  
