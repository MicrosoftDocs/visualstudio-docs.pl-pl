...
> [!NOTE]
> Program Visual Studio domyślnie nazywa `Fill` i `GetData` zapytań, ale te nazwy można zmienić na dowolną prawidłową nazwę metody.
...
### <a name="addobjects-to-a-collection"></a>Addobjects do kolekcji
 ...
 Aby zapoznać się z przykładem dodawania do kolekcji przy użyciu <xref:System.Windows.Forms.BindingSource>, zobacz metodę `LoadCustomers` w [instruktażu: łączenie z danymi w obiektach (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).

 Aby zapoznać się z przykładem dodawania obiektów do kolekcji niestandardowej, zobacz metodę `LoadOrders` w [przewodniku: łączenie z danymi w obiektach (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).
