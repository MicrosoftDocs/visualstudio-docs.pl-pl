---
title: Tworzenie tabel odnośników w aplikacjach WPF | Microsoft Docs
ms.date: 11/15/2016
...
1. Dodaj jeden z następujących typów źródeł danych z danymi powiązanymi do projektu:
    ...
    - Elementy. Aby uzyskać więcej informacji, zobacz [jak: łączenie z danymi w obiektach](https://msdn.microsoft.com/library/862fd351-0f4d-4220-9743-6103b87dc24b).
...
## <a name="see-also"></a>Zobacz też
 [Powiązywanie kontrolek WPF z danymi w programie Visual Studio](../data-tools/bind-wpf-controls-to-data-in-visual-studio1.md) [POWIĄZYWANIE kontrolek WPF z danymi w programie Visual Studio](../data-tools/bind-wpf-controls-to-data-in-visual-studio2.md) [Wyświetlanie powiązanych danych w instruktażu aplikacji WPF](../data-tools/display-related-data-in-wpf-applications.md) [: wyświetlanie powiązanych danych w aplikacji WPF](../data-tools/walkthrough-displaying-related-data-in-a-wpf-application.md)
