---
title: Dodatkowe zasoby do rozwiązywania problemów z błędami dostępu do danych | Microsoft Docs
ms.date: 11/15/2016
...
Pomoc dotyczącą rozwiązywania problemów i ostrzeżeń można znaleźć w publicznych forach Microsoft Developer Network (MSDN). Poniższa tabela zawiera listę forów związanych z danymi dostępnych w witrynie MSDN.
 ...
 [Windows Forms kontrolki danych i wiązania z danymi](https://social.msdn.microsoft.com/Forums/en-US/winformsdatacontrols/threads) Zawiera Forum dotyczące pytań i ogólnych dyskusji na temat dostępu do danych w Windows Forms.

 [Forum zestawu danych ADO.NET](https://social.msdn.microsoft.com/Forums/en-US/adodotnetdataset/threads) Zawiera Forum dotyczące pytań i ogólnej dyskusji na temat zestawów danych.

 [ADO.NET Entity Framework i LINQ to Entities](https://social.msdn.microsoft.com/Forums/en-US/adodotnetentityframework/) Zawiera Forum dotyczące pytań i ogólnej dyskusji na temat Entity Framework aplikacji i języka LINQ to Entities.

 [Forum usługi danych programu WCF](https://social.msdn.microsoft.com/Forums/en-US/adodotnetdataservices/threads) Zawiera Forum dotyczące pytań i ogólnej dyskusji na temat usług danych.

 [Forum dotyczące dostępu do danych SQL Server](https://social.msdn.microsoft.com/Forums/en-US/sqldataaccess/threads) Zawiera Forum dotyczące pytań i ogólnych dyskusji na temat uzyskiwania dostępu do danych w Microsoft SQL Server.

 [Forum LINQ to SQL](https://social.msdn.microsoft.com/Forums/en-US/linqtosql/threads) Zawiera Forum dotyczące pytań i ogólnej dyskusji na temat LINQ to SQL.

 [Forum dostawców danych ADO.NET](https://social.msdn.microsoft.com/Forums/en-US/adodotnetdataproviders/threads) Zawiera Forum dotyczące pytań i ogólnej dyskusji na temat różnych dostawców danych .NET Framework.

 Informacje o sposobach rozwiązywania problemów z usługą SQL Server znajdują się w temacie [How to rozwiązywanie problemów z aparatem bazy danych SQL Server Database](https://social.technet.microsoft.com/wiki/contents/articles/2102.how-to-troubleshoot-connecting-to-the-sql-server-database-engine.aspx).
