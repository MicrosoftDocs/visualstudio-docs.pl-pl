...
4. Tworzenie zestawu danych, odczytywanie pliku XML i wyświetlanie go w <xref:System.Windows.Forms.DataGridView> kontrolce

5. Dodawanie kodu do wyświetlania schematu XML na podstawie pliku XML w <xref:System.Windows.Forms.TextBox> kontrolce
...
## <a name="create-a-new-project"></a>Tworzenie nowego projektu
 W tym kroku utworzysz projekt Visual Basic lub Visual C#, który zawiera ten przewodnik.
...
3. Wpisz następujący kod w programie `ShowSchemaButton_Click` obsługi zdarzeń.
