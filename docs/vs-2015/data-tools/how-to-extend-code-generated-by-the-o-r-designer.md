...
Kod generowany przez program [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] jest ponownie generowany po wprowadzeniu zmian do klas jednostek i innych obiektów na powierzchni projektanta. Ze względu na ten kod, każdy kod dodawany do wygenerowanego kodu jest zwykle zastępowany, gdy projektant ponownie generuje kod. [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)]Zapewnia możliwość generowania plików klas częściowych, w których można dodać kod, który nie zostanie nadpisany. Jednym z przykładów dodawania własnego kodu do kodu wygenerowanego przez program [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] jest dodanie walidacji danych do klas LINQ to SQL (jednostki). Aby uzyskać więcej informacji, zobacz [jak: Dodawanie walidacji do klas jednostek](../data-tools/how-to-add-validation-to-entity-classes.md).
