...
Deklarację klasy lub struktury można podzielić między kilka deklaracji za pomocą `Partial` słowa kluczowego w Visual Basic lub `partial` słowa kluczowego w Visual C#. Możesz użyć dowolną liczbę deklaracji częściowych, tak jak wiele różnych plików źródłowych, lub w jednym pliku źródłowym. Wszystkie deklaracje muszą jednak znajdować się w tym samym zestawie i w tej samej przestrzeni nazw.
 ...
 Istnieją dwa rodzaje metod częściowych. W języku Visual C# są one nazywane deklarowaniem i implementacją; w Visual Basic są one nazywane deklaracją i implementacją.
...
## <a name="example"></a>Przykład
 Aby podzielić definicję klasy w Visual Basic, użyj `Partial` słowa kluczowego, jak pokazano w poniższym przykładzie.
...
## <a name="example"></a>Przykład
 Aby podzielić definicję klasy w Visual C#, użyj `partial` słowa kluczowego, jak pokazano w poniższym przykładzie.
...
## <a name="see-also"></a>Zobacz też
 [Klasy częściowe i metody](https://msdn.microsoft.com/library/804cecb7-62db-4f97-a99f-60975bd59fa1) [częściowe (Type)](https://msdn.microsoft.com/library/27320743-a22e-4c7b-b0b3-53afe3607334) [częściowe (Metoda) (odwołanie w C#)](https://msdn.microsoft.com/library/43f40242-17e0-4452-8573-090503ad3137) [Partial](https://msdn.microsoft.com/library/7adaef80-f435-46e1-970a-269fff63b448)
