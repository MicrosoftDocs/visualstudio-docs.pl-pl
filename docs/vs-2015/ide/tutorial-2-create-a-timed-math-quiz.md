...
> [!NOTE]
> Ten samouczek obejmuje Visual C# i Visual Basic, dlatego należy skoncentrować się na informacjach specyficznych dla języka programowania, którego używasz.
...
|[Krok 2. Tworzenie losowego problemu dodawania](../ide/step-2-create-a-random-addition-problem.md)|Utwórz problem z dodaniem i Użyj `Random` klasy w celu wygenerowania liczb losowych.|
