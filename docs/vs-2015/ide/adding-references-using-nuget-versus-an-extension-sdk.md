...
- NuGet to system zarządzania pakietami typu open source, który upraszcza proces dołączania bibliotek do rozwiązania projektu. Aby uzyskać więcej informacji, zobacz [Omówienie narzędzia NuGet](http://go.microsoft.com/fwlink/?LinkId=254877).
