---
title: 'Samouczek 3: Stwórz grę pasujący obiekt typu | Dokumentacja firmy Microsoft'
ms.date: 11/15/2016
...
|[Krok 3. Przypisywanie losowej ikony do każdej etykiety](../ide/step-3-assign-a-random-icon-to-each-label.md)|Przypisz ikony losowo do `Label` kontroluje, tak aby każda gra była inna.|  
...
|[Krok 8. Dodawanie metody sprawdzania, czy gracz wygrał](../ide/step-8-add-a-method-to-verify-whether-the-player-won.md)|Dodaj `CheckForWinner()` metodę, aby sprawdzić, czy gracz wygrał.|  
