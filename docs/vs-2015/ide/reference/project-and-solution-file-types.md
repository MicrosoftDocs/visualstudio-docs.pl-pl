...
## <a name="project-files"></a>Pliki projektu
 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] program używa różnych formatów plików do przechowywania informacji specyficznych dla projektów. Aby uzyskać więcej informacji, zobacz następujące tematy pomocy:
 ...
 [Kod Unicode](https://msdn.microsoft.com/library/1002004b-4113-4380-bf63-e1570934b793)
