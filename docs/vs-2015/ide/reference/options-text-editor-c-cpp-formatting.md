---
title: Opcje, Edytor tekstu, CC++, formatowanie | Microsoft Docs
ms.date: 11/15/2016
 ...
 **Pokaż nieaktywne bloki kodu** Kod, który jest nieaktywny ze względu na deklaracje `#ifdef`, ma odmienny kolor, aby ułatwić jego identyfikację.
 ...
 **Wcięcie nawiasów klamrowych** Można skonfigurować sposób, w jaki nawiasy klamrowe są wyrównane po naciśnięciu klawisza ENTER po rozpoczęciu bloku kodu, na przykład funkcja lub pętla `for`. Nawiasy klamrowe mogą być wyrównane względem pierwszego znaku bloku kodu lub wcięte.
