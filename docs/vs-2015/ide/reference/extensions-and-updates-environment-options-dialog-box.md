---
title: Rozszerzenia i aktualizacje, środowisko, Opcje — okno dialogowe | Microsoft Docs
ms.date: 11/15/2016
...
### <a name="automatically-check-for-updates"></a>Automatycznie sprawdzaj dostępność aktualizacji
 Po zaznaczeniu tej opcji program Visual Studio będzie okresowo sprawdzał dostępność aktualizacji, zainstalowanych zestawów SDK i narzędzi oraz rozszerzeń oraz wyświetlać powiadomienia na pasku menu, gdy są dostępne aktualizacje. Aby uzyskać więcej informacji, zobacz [powiadomienia](../../ide/visual-studio-notifications.md).
...
### <a name="load-user-extensions-when-running-as-administrator"></a>Załaduj rozszerzenia użytkownika podczas uruchamiania jako administrator
