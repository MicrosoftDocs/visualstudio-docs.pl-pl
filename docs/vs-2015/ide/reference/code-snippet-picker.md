---
title: Selektor fragmentu kodu | Dokumentacja firmy Microsoft
ms.date: 11/15/2016
...
ms.locfileid: "54789842"
---
# <a name="code-snippet-picker"></a>Selektor wstawek kodu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

  
[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] Edytor kodu udostępnia **selektor wstawek kodu** pozwala, za pomocą kilku kliknięć myszą, aby wstawić gotowych do użycia bloków kodu do aktywnego dokumentu.  
...
- Wizualne F# — **selektor wstawek kodu** nie jest dostępna.  
