 ...
 **Plik &#124; nowy &#124; projekt** z menu głównego, aby wyświetlić okno dialogowe Nowy projekt. W lewym okienku w obszarze z **niewyższymi szablonami &#124;** wybierz język programowania i platformę lub technologię, a następnie w środkowym okienku Wybieraj spośród dostępnych szablonów.
...
### <a name="deleting-solutions"></a>Usuwanie rozwiązań
 Rozwiązanie można trwale usunąć, ale nie za pomocą programu [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] . Przed usunięciem rozwiązania Przenieś wszystkie projekty, które mogą być używane ponownie w innym rozwiązaniu. Następnie użyj Eksploratora plików, aby usunąć katalog zawierający pliki rozwiązania. sln i. suo.
