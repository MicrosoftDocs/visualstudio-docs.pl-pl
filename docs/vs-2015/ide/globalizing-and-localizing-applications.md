...
## <a name="related-sections"></a>Sekcje pokrewne
 [Globalizacja aplikacji (aplikacje do sklepu Windows przy użyciu języka JavaScript i HTML)](https://msdn.microsoft.com/library/windows/apps/hh465006.aspx) Zawiera tematy z instrukcjami i wskazówki ułatwiające globalizację i lokalizowanie aplikacji [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] utworzonej przy użyciu języka JavaScript i języka HTML.

 [Globalizacja aplikacji (aplikacje ze sklepu Windows przy C#użyciuC++ /VB/i języka XAML)](https://msdn.microsoft.com/library/windows/apps/xaml/Hh965328(v=win.10).aspx) zawiera tematy i wskazówki ułatwiające globalizację i lokalizowanie aplikacji [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] utworzonej przy użyciu języka XAML i wizualizacji C#, Visual Basic lub wizualizacji C++.
