...
## <a name="list-members"></a>Lista składników
 Lista prawidłowych członków z typu (lub przestrzeni nazw) pojawia się po wpisaniu znaku wyzwalacza (na przykład kropki ( `.` ) w kodzie zarządzanym lub `::` w języku C++). Jeśli będziesz kontynuować wpisywanie znaków, lista jest filtrowana w celu uwzględnienia tylko elementów członkowskich, które zaczynają się od tych znaków.
...
## <a name="quick-info"></a>Szybkie informacje
 ...
 Szybkie informacje można wyłączyć w języku C++ przez ustawienie **opcji Narzędzia/Opcje/Edytor tekstu/C/C++/Advanced/Auto szybkie informacje** do `false` .
...
## <a name="see-also"></a>Zobacz też
 Funkcja [IntelliSense](../ide/visual-csharp-intellisense.md) [JavaScript IntelliSense](../ide/javascript-intellisense.md) [kodu XML](../ide/supplying-xml-code-comments.md) IntelliSense języka JavaScript [dla Visual Basic](../ide/visual-basic-specific-intellisense.md)
