---
title: 'Instrukcje: Znajdowanie tematów w spisie treści | Microsoft Docs'
ms.date: 11/15/2016
...
Na karcie **zawartość** można znaleźć informacje za pomocą spisu treści (TOC). Spis treści jest listą rozwijaną, która zawiera wszystkie tematy w zainstalowanych książkach. Aby uzyskać informacje o ułatwieniach dostępu dotyczące sposobu nawigowania po spisie treści, zobacz [klawisze skrótów (Podgląd pomocy)](../ide/shortcut-keys-help-viewer.md).
...
2. Kliknij przycisk **Pokaż temat w spisie treści** na pasku narzędzi lub naciśnij klawisze CTRL + S.

     Zostanie otwarta karta **zawartość** i zostanie wyświetlona lokalizacja tematu w spisie treści.

## <a name="see-also"></a>Zobacz też
 [Lokalizowanie](../ide/locate-information.md) [Podgląd pomocy firmy Microsoft](../ide/microsoft-help-viewer.md) informacji
