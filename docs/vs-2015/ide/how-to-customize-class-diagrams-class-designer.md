...
- [Powiększanie i pomniejszanie diagramu klas](../ide/how-to-customize-class-diagrams-class-designer.md#ZoomInOut)
...
- [Ukryj przedziały w typie](../ide/how-to-customize-class-diagrams-class-designer.md#HideCompartments)

- [Ukrywanie poszczególnych elementów członkowskich w typie](../ide/how-to-customize-class-diagrams-class-designer.md#HideMembers)

- [Pokaż ukryte przedziały i elementy członkowskie w typie](../ide/how-to-customize-class-diagrams-class-designer.md#DisplayHiddenCompartmentsAndMemberrs)

- [Ukryj relacje](../ide/how-to-customize-class-diagrams-class-designer.md#HideAssociationAndInheritance)

- [Pokaż ukryte relacje](../ide/how-to-customize-class-diagrams-class-designer.md#DisplayAssociationAndInheritance)

- [Usuwanie kształtu z diagramu klas](../ide/how-to-customize-class-diagrams-class-designer.md#RemoveCodeAndShape)

- [Usuwanie kształtu typu i jego kodu źródłowego](../ide/how-to-customize-class-diagrams-class-designer.md#DeleteTypeShapeAndCode)

## <a name="ZoomInOut"></a>Powiększanie i pomniejszanie diagramu klas
...
## <a name="HideCompartments"></a>Ukryj przedziały w typie
...
## <a name="HideMembers"></a>Ukrywanie poszczególnych elementów członkowskich w typie
...
## <a name="DisplayHiddenCompartmentsAndMemberrs"></a>Pokaż ukryte przedziały i elementy członkowskie w typie
...
## <a name="HideAssociationAndInheritance"></a>Ukryj relacje
...
## <a name="DisplayAssociationAndInheritance"></a>Pokaż ukryte relacje
...
## <a name="RemoveCodeAndShape"></a>Usuwanie kształtu z diagramu klas
...
## <a name="DeleteTypeShapeAndCode"></a>Usuwanie kształtu typu i jego kodu źródłowego
...
## <a name="see-also"></a>Zobacz też
 [Praca z diagramami klas (Projektant klas)](../ide/working-with-class-diagrams-class-designer.md) [instrukcje: zmiana między notacją składowej a notacją skojarzenia (Projektant klas)](../ide/how-to-change-between-member-notation-and-association-notation-class-designer.md) [instrukcje: wyświetlanie](../ide/how-to-view-existing-types-class-designer.md) [typów i relacji typu (Projektant klas) przeglądanie istniejących typów (Projektant klas) ](../ide/viewing-types-and-relationships-class-designer.md)
