...
## <a name="visual-studio-setup"></a>Instalator programu Visual Studio
 Możesz dowiedzieć się, którą wersję programu Visual Studio jest odpowiedni dla Ciebie na [wersje programu Visual Studio](https://visualstudio.microsoft.com/vs/).

 Visual Studio 2015 można zainstalować, pobierając go z [pobieranie Visual Studio](https://www.visualstudio.com/downloads/download-visual-studio-vs.aspx). Jeśli potrzebujesz dowiedzieć się więcej na temat procesu instalacji, zobacz [instalowania programu Visual Studio 2015](../install/install-visual-studio-2015.md).
