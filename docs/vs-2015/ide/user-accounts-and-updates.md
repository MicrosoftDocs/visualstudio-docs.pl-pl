...
> [!WARNING]
> Program Visual Studio 2015 nie może uzyskać dostępu do zasobów, które są skonfigurowane dla dostępu warunkowego. Aby można było korzystać z tych zasobów, należy przeprowadzić uaktualnienie do programu Visual Studio 2019 w wersji 16,6 lub nowszej i postępować zgodnie z [tematem jak używać programu Visual Studio z kontami, które wymagają wskazówek dotyczących uwierzytelniania wieloskładnikowego](../../ide/work-with-multi-factor-authentication.md) .
...
|Tytuł|Opis|
|-|-|
|[Visual Studio — logowanie](../ide/signing-in-to-visual-studio.md)|Opisuje, jak i dlaczego należy zalogować się do programu Visual Studio.|
