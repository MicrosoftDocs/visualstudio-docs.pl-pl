---
title: Praca z klasami i innymi typami (Projektant klas) | Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "72662624"
---
# <a name="working-with-classes-and-other-types-class-designer"></a>Praca z klasami i innymi typami (Projektant klas)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Łatwiej skupić się na klasach i typach, które Cię interesują, podczas tworzenia i edytowania ich przy użyciu Projektant klas w programie Visual Studio. Diagramy klas służą do bardziej wizualnej pracy z kodem Visual C# .NET, Visual Basic .NET lub C++.
