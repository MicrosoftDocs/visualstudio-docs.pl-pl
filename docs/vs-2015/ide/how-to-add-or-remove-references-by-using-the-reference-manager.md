...
- Składnik, który używa [!INCLUDE[net_v40_short](../includes/net-v40-short-md.md)] jest niezgodny z projektem, który jest przeznaczony dla [!INCLUDE[net_v45](../includes/net-v45-md.md)].
     ...
     Podczas tworzenia nowej aplikacji niektóre projekty są domyślnie przeznaczone dla [!INCLUDE[net_v45](../includes/net-v45-md.md)]. Aby uzyskać więcej informacji, zobacz [.NET Framework profilu klienta](https://msdn.microsoft.com/library/f0219919-1f02-4588-8704-327a62fd91f1).
...
## <a name="solution-tab"></a>Karta Rozwiązanie
 ...
 Projekt może się odwoływać do innego projektu, który jest przeznaczony dla innej wersji platformy .NET Framework. Na przykład możesz utworzyć projekt, który jest przeznaczony dla [!INCLUDE[net_v40_short](../includes/net-v40-short-md.md)], ale odwołuje się do zestawu, który został skompilowany dla .NET Framework 2. Jednak projekt .NET Framework 2 nie może odwoływać się do projektu [!INCLUDE[net_v40_short](../includes/net-v40-short-md.md)]. Aby uzyskać więcej informacji, zobacz [Określanie konkretnej wersji .NET Framework](../ide/targeting-a-specific-dotnet-framework-version.md).
 ...
 W [!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)], odwołanie do pliku zamiast odwołania projektu jest tworzone, jeśli jeden projekt jest przeznaczony dla .NET Framework 4 i inny projekt jest przeznaczony dla starszej wersji.

 Projekt, który jest przeznaczony dla [!INCLUDE[net_win8_profile](../includes/net-win8-profile-md.md)] nie może dodać odwołania projektu do projektu, który jest przeznaczony dla .NET Framework i na odwrót.
...
### <a name="core-subgroup"></a>Podgrupa podstawowa (Core)
 ...
 projekty aplikacji [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] zawierają odwołania do wszystkich WinMD w zestawie SDK [!INCLUDE[win8](../includes/win8-md.md)] domyślnie podczas tworzenia projektu. W projektach zarządzanych, węzeł tylko do odczytu w folderze References w **Eksplorator rozwiązań** wskazuje odwołanie do całego [!INCLUDE[win8](../includes/win8-md.md)] SDK. W związku z tym podgrupa podstawowa w Menedżerze odwołań nie będzie wyliczać żadnych zestawów z zestawu SDK [!INCLUDE[win8](../includes/win8-md.md)] i zamiast tego zostanie wyświetlony komunikat: "Windows SDK już istnieje odwołanie. Użyj przeglądarki obiektów do zbadania odwołań w zestawie SDK systemu Windows”.
...
### <a name="extensions-subgroup"></a>Podgrupa Rozszerzenia
 Rozszerzenia wyświetla pakiety SDK użytkownika, które rozszerzają docelową platformę Windows. Ta karta jest wyświetlana tylko dla [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] projekty aplikacji. Projekty pulpitu nie będzie wyświetlały tej karty, ponieważ mogą one wykorzystywać tylko pliki .winmd pierwszego producenta.
