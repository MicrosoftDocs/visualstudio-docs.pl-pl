---
title: 'Instrukcje: Zarządzanie oknami edytora | Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="splitting-an-editor-window"></a>Dzielenie okna edytora
...
## <a name="creating-new-windows"></a>Tworzenie nowych okien
...
## <a name="see-also"></a>Zobacz też
 [Dostosowywanie edytora](../ide/customizing-the-editor.md) [pisanie kodu](../ide/writing-code-in-the-code-and-text-editor.md) [dostosowanie układów okna](../ide/customizing-window-layouts-in-visual-studio.md)
