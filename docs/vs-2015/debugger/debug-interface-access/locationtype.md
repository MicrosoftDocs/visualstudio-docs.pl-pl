...
## <a name="elements"></a>Elementy  
 ...
 `LocIsStatic`  
 Lokalizacja jest statyczna.  
  
 `LocIsTLS`  
 Lokalizacja znajduje się w lokalnym magazynie wątków.  
  
 `LocIsRegRel`  
 Lokalizacja jest zależna od rejestru.  
 ...
 `LocIsBitField`  
 Lokalizacja znajduje się w polu bitowym.  
  
 `LocIsSlot`  
 Lokalizacja jest miejscem języka pośredniego firmy Microsoft (MSIL).  
  
 `LocIsIlRel`  
 Lokalizacja jest zależna od języka MSIL.  
  
 `LocInMetaData`  
 Lokalizacja znajduje się w metadanych.  
  
 `LocIsConstant`  
 Lokalizacja jest w stałej wartości.  
