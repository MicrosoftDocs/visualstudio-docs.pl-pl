# [Zestaw SDK dostępu do interfejsu debugowania](debug-interface-access-sdk.md)
## [Wprowadzenie](getting-started-debug-interface-access-sdk.md)
### [Omówienie](overview-debug-interface-access-sdk.md)
### [Używanie zapytań dotyczących pliku .Pdb](querying-the-dot-pdb-file.md)
## [Symbole i tagi symboli](symbols-and-symbol-tags.md)
### [Lokalizacje symboli](symbol-locations.md)
### [Hierarchia leksykalna typów symboli](lexical-hierarchy-of-symbol-types.md)
#### [Adnotacja](annotation.md)
#### [Blok](block.md)
#### [Jednostka kompilacji](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [Niestandardowe (Zestaw SDK dostępu do interfejsu debugowania)](custom-debug-interface-access-sdk.md)
#### [Dane (Zestaw SDK dostępu do interfejsu debugowania)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [Funkcja (Zestaw SDK dostępu do interfejsu debugowania)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [Etykieta (Zestaw SDK dostępu do interfejsu debugowania)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Thunk](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [Hierarchia klas typów symboli](class-hierarchy-of-symbol-types.md)
#### [ArrayType](arraytype.md)
#### [BaseClass](baseclass.md)
#### [BaseType](basetype.md)
#### [CustomType](customtype.md)
#### [Wymiar](dimension.md)
#### [Typ wyliczeniowy (Zestaw SDK dostępu do interfejsu debugowania)](enum-debug-interface-access-sdk.md)
#### [Przyjaciel (Zestaw SDK dostępu do interfejsu debugowania)](friend-debug-interface-access-sdk.md)
#### [FunctionArgType](functionargtype.md)
#### [FunctionType](functiontype.md)
#### [ManagedType](managedtype.md)
#### [PointerType](pointertype.md)
#### [Typedef (Zestaw SDK dostępu do interfejsu debugowania)](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
#### [VTableShape](vtableshape.md)
## [Tematy pomocy](debug-interface-access-sdk-reference.md)
### [Interfejsy (Zestaw SDK dostępu do interfejsu debugowania)](interfaces-debug-interface-access-sdk.md)
...
### [Wyliczenia i struktury](enumerations-and-structures.md)
#### [BasicType, wyliczenie](basictype.md)
#### [CV_access_e, wyliczenie](cv-access-e.md)
#### [CV_call_e, wyliczenie](cv-call-e.md)
#### [CV_CFL_LANG, wyliczenie](cv-cfl-lang.md)
#### [CV_CPU_TYPE_e, wyliczenie](cv-cpu-type-e.md)
#### [CV_HREG_e, wyliczenie](cv-hreg-e.md)
#### [DataKind, wyliczenie](datakind.md)
#### [DiaAddressMapEntry, struktura](diaaddressmapentry.md)
#### [LocationType, wyliczenie](locationtype.md)
#### [MemoryTypeEnum, wyliczenie](memorytypeenum.md)
#### [NameSearchOptions, wyliczenie](namesearchoptions.md)
#### [StackFrameTypeEnum, wyliczenie](stackframetypeenum.md)
#### [SymTagEnum, wyliczenie](symtagenum.md)
#### [THUNK_ORDINAL, wyliczenie](thunk-ordinal.md)
#### [UdtKind, wyliczenie](udtkind.md)
### [Stałe (Zestaw SDK dostępu do interfejsu debugowania)](constants-debug-interface-access-sdk.md)
## [Dia2dump — przykład](dia2dump-sample.md)
## [Plik źródłowy Dia2dump.cpp](dia2dump-cpp-source-file.md)
