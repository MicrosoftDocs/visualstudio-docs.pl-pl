...
- W wywołaniu funkcji zagnieżdżonej **Step Into** wchodzi do najgłębiej zagnieżdżonej funkcji. Jeśli używasz **kroku do** wywołania `Func1(Func2())`na przykład, debuger przeprowadzi do funkcji `Func2`.  
...
## <a name="step-into-non-user-code"></a>Wkrocz do kodu niezwiązanego z użytkownikiem  
 ...
 Tylko mój kod można wyłączyć, przechodząc do**opcji** /  **Narzędzia** / **debugowanie** i wyczyść pole wyboru **Włącz tylko mój kod** .  
