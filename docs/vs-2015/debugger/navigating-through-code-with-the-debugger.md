...
## <a name="start-debugging"></a>Rozpocznij debugowanie  
 ...
 ![&#95;podstawowe&#95;Rozpocznij debugowanie&#95;](../debugger/media/dbg-basics-start-debugging.png "DBG_Basics_Start_Debugging")  
 ...
 ![DBG&#95;podstawowe&#95;&#95;trybu przerwania](../debugger/media/dbg-basics-break-mode.png "DBG_Basics_Break_Mode")  
...
## <a name="step-into-code-line-by-line"></a><a name="BKMK_Step_into__over__or_out_of_the_code"></a> Wkrocz do kodu, wiersz po wierszu  
 Aby zatrzymać każdy wiersz kodu (poszczególne instrukcje) podczas debugowania, użyj skrótu klawiaturowego **F11** (lub **Debuguj**  /  **krok do** menu).  
...
- W przypadku wywołania funkcji zagnieżdżonej **Przejdź** do kroków do najbardziej głęboko zagnieżdżonej funkcji. Jeśli używasz **kroku do** wywołania na `Func1(Func2())` przykład, debuger przeprowadzi do funkcji `Func2` .  
  
- Debuger w rzeczywistości prowadzi przez instrukcje Code zamiast wierszy fizycznych. Na przykład `if` klauzula może być zapisywana w jednym wierszu:  
...
## <a name="step-through-code-skipping-functions"></a><a name="BKMK_Step_over_Step_out"></a> Przechodzenie przez kod, funkcje pomijania  
...
|Polecenie klawiaturowe|Polecenie menu|Opis|  
|----------------------|------------------|-----------------|  
...
## <a name="step-into-non-user-code"></a>Wkrocz do kodu niezwiązanego z użytkownikiem  
 ...
 Tylko mój kod można wyłączyć, przechodząc do opcji **Narzędzia**  /  **Options**  /  **debugowanie** i wyczyść pole wyboru **Włącz tylko mój kod** .  
...
## <a name="step-into-properties-and-operators-in-managed-code"></a><a name="BKMK_Step_into_properties_and_operators_in_managed_code"></a> Wkrocz do właściwości i operatorów w kodzie zarządzanym  
 Debuger domyślnie krokowo przekracza właściwości i operatory w kodzie zarządzanym. W większości przypadków zapewnia to lepsze środowisko debugowania. Aby włączyć krokowe przechodzenie do właściwości lub operatorów **Debug**, wybierz  /  **Opcje**debugowania. Na stronie **Debugging**  /  **Ogólne** debugowania wyczyść pole wyboru **Przekrocz nad właściwościami i operatorami (tylko zarządzane)**
