...
- Sprawdź ustawienia uprawnień. Aby uzyskać więcej informacji, zobacz [jak: Ustawianie uprawnień programu SQL Server do debugowania](http://msdn.microsoft.com/84e088d0-0409-41d4-841b-f5d4b0fda414).  
