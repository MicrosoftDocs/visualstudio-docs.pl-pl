---
title: Więcej funkcji debugowania | Microsoft Docs
ms.date: 11/15/2016
...
Ta sekcja zawiera dodatkowe funkcje, których można używać z debugerem programu Visual Studio.  
  
 Aby uzyskać listę porad i wskazówek umożliwiających szybsze i łatwiejsze debugowanie, zobacz [porady dotyczące debugowania i wskazówki](https://devblogs.microsoft.com/visualstudio/debugging-tips-and-tricks/).  
  
## <a name="additional-features"></a>Dodatkowe funkcje  
 [Sprawdzanie właściwości XAML podczas debugowania](../debugger/inspect-xaml-properties-while-debugging.md)  
 Opisuje użycie **aktywnego drzewa wizualnego** i narzędzi **Eksploratora właściwości na żywo** .  
  
 [Ustawienia debugera i przygotowanie](../debugger/debugger-settings-and-preparation.md)  
 Opisuje różne ustawienia, które mogą być potrzebne do użycia debugera w różnych kontekstach.  
  
 [Wyświetlanie danych w debugerze](../debugger/viewing-data-in-the-debugger.md)  
 Opisuje różne okna debugowania i  
  
 [Debugowanie just in time](../debugger/just-in-time-debugging-in-visual-studio.md)  
 Omawia debugowanie just in Time, które może automatycznie uruchamiać debuger, gdy program ulega awarii podczas uruchamiania poza programem Visual Studio.  
