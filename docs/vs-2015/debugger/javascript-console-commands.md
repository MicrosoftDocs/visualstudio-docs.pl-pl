...
|`msIsIndependentlyComposed(element)`|Używane w aplikacji sieci web. Nie są obsługiwane w aplikacjach Store przy użyciu języka JavaScript.|Nieobsługiwane.|  
|`profile(reportName)`|Używane w aplikacji sieci web. Nie są obsługiwane w aplikacjach Store przy użyciu języka JavaScript.|Nieobsługiwane.|  
|`profileEnd()`|Używane w aplikacji sieci web. Nie są obsługiwane w aplikacjach Store przy użyciu języka JavaScript.|Nieobsługiwane.|  
