...
## <a name="see-also"></a>Zobacz też
 [XML Editor](../xml-tools/xml-editor.md) [Składniki edytora XML](../xml-tools/xml-editor-components.md) edytora XML
