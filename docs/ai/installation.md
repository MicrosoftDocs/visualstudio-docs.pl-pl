...
![Instalowanie środowiska języka Python w systemie Windows](media/installation/install_python_win.png)
...
Aby zainstalować pakiet CNTK Python, zobacz [How to Install CNTK](/cognitive-toolkit/Setup-CNTK-on-your-machine).
...
> [!NOTE]
> W systemie Windows potrzebna jest wersja 2015 programu [Visual Studio](https://visualstudio.microsoft.com/) lub narzędzia do kompilowania [Microsoft Visual C++](https://visualstudio.microsoft.com/visual-cpp-build-tools/) , aby kompilować CuPy z cuda 8,0.
