...
ms.locfileid: "55936593"
---
# <a name="schema-cache"></a>Pamięci podręcznej schematów

Edytor XML udostępnia znajduje się w pamięci podręcznej schematów *%InstallRoot%\Xml\Schemas* katalogu. Pamięci podręcznej schematu jest globalne dla wszystkich użytkowników na komputerze i zawiera standardowe schematów XML, które są używane do weryfikacji dokumentu IntelliSense i XML.
