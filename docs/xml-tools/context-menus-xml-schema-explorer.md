...
ms.locfileid: "54270167"
---
# <a name="context-menus-xml-schema-explorer"></a>Menu kontekstowe (Eksplorator schematu XML)

Menu kontekstowe jest wyświetlane po kliknięciu prawym przyciskiem myszy element menu. Następujące elementy menu kontekstowego są używane do wykonywania wyszukiwania specyficznego dla schematu i inne operacje.
