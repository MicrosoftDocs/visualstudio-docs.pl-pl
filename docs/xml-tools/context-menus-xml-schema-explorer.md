...
description: Poznaj menu kontekstowe w Eksploratorze schematu XML, które zawierają elementy służące do wykonywania wyszukiwania specyficznego dla schematu i innych operacji.
