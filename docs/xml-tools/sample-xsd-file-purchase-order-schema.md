...
description: Wyświetl przykładowy plik XSD dla schematu zamówienia zakupu, który jest używany w różnych przykładach w dokumentacji projektanta schematu XSD.
