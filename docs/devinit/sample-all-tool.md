...
description: Przykład użycia wszystkich narzędzi devinit.
ms.date: 02/08/2021
ms.topic: reference
author: andysterland
ms.author: andster
...
ms.locfileid: "100006385"
---
# <a name="all-tools"></a>Wszystkie narzędzia

Ten przykład ma `devinit.json` , który instaluje wszystkie dostępne narzędzia devinit.
