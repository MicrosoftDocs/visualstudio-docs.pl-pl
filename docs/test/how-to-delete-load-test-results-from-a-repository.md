...
description: Dowiedz się, jak usunąć informacje z repozytorium Wyniki testów ładowania przy użyciu okna dialogowego Otwórz i Zarządzaj Wyniki testów ładowania.
