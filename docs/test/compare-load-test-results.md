...
description: Dowiedz się, jak generować raporty testów obciążenia programu Excel, które są oparte na dwóch lub większej liczbie wyników testów, w tym uruchamiania raportów porównawczych i raportów trendów.
