...
> [!NOTE]
> Nie można użyć tego adaptera danych diagnostycznych dla testów, które są uruchamiane za pomocą Microsoft Test Manager. Możesz użyć karty diagnostycznej profilera ASP.NET z testami obciążenia tylko przy użyciu witryn sieci Web, które wymagają Visual Studio Enterprise.
