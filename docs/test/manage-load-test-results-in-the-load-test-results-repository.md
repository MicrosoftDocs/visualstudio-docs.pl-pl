...
description: Dowiedz się, jak zarządzać danymi zebranymi podczas testu obciążenia, które są przechowywane w bazie danych SQL repozytorium Wyniki testów ładowania.
...
|**Usuwanie wyniku testu obciążenia z repozytorium:** Można usunąć wynik testu obciążenia z **Edytor testu obciążeniowego** przy użyciu okna dialogowego **otwórz i Zarządzaj wyniki testów ładowania** .|-   [Instrukcje: usuwanie wyników testu obciążenia z repozytorium](../test/how-to-delete-load-test-results-from-a-repository.md)|
