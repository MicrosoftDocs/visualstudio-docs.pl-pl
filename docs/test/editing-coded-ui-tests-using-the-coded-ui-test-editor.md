...
Za pomocą C# **edytora KODOWANEGO testu interfejsu użytkownika**można wyświetlać i edytować swój graficzny test interfejsu użytkownika oparty na Visual Basicach.
