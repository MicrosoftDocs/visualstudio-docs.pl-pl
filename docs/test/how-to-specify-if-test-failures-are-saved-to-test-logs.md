...
description: Dowiedz się, jak określić, czy chcesz, aby dziennik testu był zapisany, jeśli test zakończy się niepowodzeniem w teście obciążenia, zmieniając właściwość Save log for test Failure.
