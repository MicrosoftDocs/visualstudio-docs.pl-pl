...
- 90% łącznej liczby transakcji zostało ukończonych w mniej niż \<time > sekund.

- 95% łącznej liczby transakcji zostało ukończonych w mniej niż \<time > sekund.
