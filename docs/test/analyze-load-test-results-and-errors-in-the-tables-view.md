...
|-|-|-|
|**Żądając**|Adres URL żądania. Na przykład, *Home. html*lub *Orange-Arrow. gif*.|Tak|
|**Scenariusz**|Nazwa scenariusza.|Tak|
|**Test**|Nazwa testu.|Tak|
|**Ogólnego**|Całkowita liczba żądań testu wydajności sieci Web wystawionych podczas przebiegu testu obciążenia. Suma obejmuje żądania zakończone powodzeniem i nieudane, ale nie obejmuje buforowanych żądań, ponieważ nie są wystawiane dla serwera sieci Web.|Tak|
...
|**Pozostaje**|Łączna liczba przypadków, gdy żądanie zostało już w pamięci podręcznej.|Nie|
...
|**Test**|Nazwa testu.|Tak|
|**Scenariusz**|Nazwa scenariusza.|Tak|
|**Ogólnego**|Całkowita liczba uruchomień testu w scenariuszu. Obejmuje to liczbę testów zakończonych powodzeniem i nieudanych.|Tak|
...
|**Scenariusz**|Nazwa scenariusza.|Tak|
|**Test**|Nazwa testu.|Tak|
|**Ogólnego**|Całkowita liczba transakcji wydanych podczas przebiegu testu obciążenia.|Tak|
...
|Liczbą|Liczba błędów tego typu, które wystąpiły podczas testu obciążenia. Wpisy w tej kolumnie są wyświetlane jako hiperlinki. Możesz wybrać dowolne hiperłącze, aby wyświetlić listę poszczególnych błędów.|Tak|
...
|Kolumna|Opis|
|-|-|
|**Pierwszym**|Czas podczas testu obciążenia, w którym wystąpił błąd.|
...
|**Żądając**|Adres URL żądania, w którym wystąpił błąd.|
|**Wprowadź**|Typ błędu. Na przykład HttpError.|
|**Podtyp**|Podtyp błędu. Na przykład LoadTestException.|
|**Tekst**|Tekst komunikatu o błędzie. Na przykład 404-NotFound.|
|**Stosu**|Wpisy w tej kolumnie są puste lub **stos** słów jest sformatowany jako hiperlink. Możesz wybrać hiperłącze, aby wyświetlić ślad stosu błędu.|
|**Uzyskać**|Wpisy w tej kolumnie są puste lub słowo **TestLog** jest sformatowane jako hiperlink. Ten link może ułatwić wyizolowanie błędów w teście obciążenia. Na przykład wybranie linku **TestLog** na żądanie testu wydajności sieci Web spowoduje otwarcie wyników testu wydajności sieci Web w przeglądarce wyniki testów wydajności sieci Web i wyróżnienie błędu żądania.|
