...
4. Dodaj słowo kluczowe `public` do deklaracji klasy **Rooter** , aby kod testu mógł uzyskać do niej dostęp.
...
> [!TIP]
> W przypadku dodania metody pomocnika do klasy testowej, która nie ma być wyświetlana w **Eksploratorze testów**, nie należy dodawać do metody atrybutu <xref:Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute>.
