...
description: Dowiedz się, jak używać interfejsu API testu obciążenia, który obsługuje wtyczki testowe, które mogą kontrolować lub ulepszać test obciążenia.
