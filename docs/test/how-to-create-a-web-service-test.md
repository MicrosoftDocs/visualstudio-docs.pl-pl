...
W poniższych procedurach jest używana usługa sieci Web, która jest zawarta w ramach zestawu Commerce Start Kit. Można go pobrać z [ASP.NET Commerce Start Kit](http://go.microsoft.com/fwlink/?LinkId=181469).
