...
description: IntelliTest Eksplorowanie kodu platformy .NET do generowania danych testowych i zestawu testów jednostkowych. Dowiedz się, jak uruchomić IntelliTest, aby sprawdzić, które testy kończą się niepowodzeniem i napraw.
...
* Obsługa tylko kodu w języku C#, który jest przeznaczony dla .NET Framework.
...
2. Kliknij prawym przyciskiem myszy metodę i wybierz polecenie **Uruchom IntelliTest** , aby wygenerować testy jednostkowe dla kodu w metodzie.
   ...
   ![Prawy&#45;kliknij metodę, aby wygenerować testy jednostkowe](../test/media/runpex.png)
...
1. Wybierz wiersze danych, które chcesz zapisać z sparametryzowanym testem jednostkowym w projekcie testowym.
     ...
     ![Wybierz testy; prawy&#45;kliknij i wybierz pozycję Zapisz.](../test/media/savepextests.png)
...
2. Po zbadaniu kodu i zrozumieniu, co chcesz przetestować, możesz naprawić ostrzeżenie, aby wybrać klasy do użycia w celu przetestowania interfejsu.
     ...
     ![Prawo&#45;kliknij ostrzeżenie i wybierz pozycję Napraw.](../test/media/pexfixwarning.png)
...
Odp **.:** Tak, użyj założeń, aby określić, które dane testowe nie są wymagane do testów jednostkowych dla określonej metody. Użyj <xref:Microsoft.Pex.Framework.PexAssume> klasy, aby dodać założenia. Na przykład można dodać założenie, że `lengths` zmienna nie ma wartości null podobnej do:
...
![Prawy&#45;kliknij pozycję Edytor, wybierz polecenie Utwórz IntelliTest](../test/media/pexcreateintellitest.png)
