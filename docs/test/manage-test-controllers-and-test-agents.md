...
1. Wybierz **Start**  > **Narzędzia konfiguracji agenta testowego**.
...
|Gotowe|Dostępne do uruchamiania testów lub zbierania danych i diagnostyki|
|Stanie|Niedostępne do uruchamiania testów lub zbierania danych i diagnostyki|
|utrzymywani|Agent testowy nie został uruchomiony|
...
Jeśli chcesz zarejestrować kontroler testów w Team Foundation Server kolekcji projektów, konto, którego używasz dla usługi kontrolera testów, musi być członkiem grupy kont usługi testowej kolekcji projektów dla kolekcji projektów lub konta używany do uruchamiania narzędzia konfiguracji kontrolera testów musi być administratorem kolekcji projektu.
...
1. Aby uruchomić narzędzie w dowolnym momencie, aby ponownie skonfigurować kontroler testów, wybierz **Start**  > **Test Controller Configuration Tool**.
