...
description: Dowiedz się, jak program Visual Studio może utworzyć symulowane obciążenie przy użyciu maszyn fizycznych lub wirtualnych w celu wygenerowania większej liczby obciążeń niż pojedynczy komputer może generować same.
