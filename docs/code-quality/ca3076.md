...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Naruszenie funkcji &mdash;document i wykonywanie skryptu nie jest wyłączone
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>Rozwiązanie &mdash;disable funkcję dokumentu i wykonywanie skryptu
