...
## <a name="example-3-unnecessary-buffer-allocation-on-heap"></a>Przykład 3: Niepotrzebna alokacja bufora na stercie
...
## <a name="example-4-unnecessary-buffer-allocation-on-the-heap-fixed-with-container"></a>Przykład 4: Niepotrzebna alokacja bufora na stosie (naprawiona przy użyciu kontenera)
