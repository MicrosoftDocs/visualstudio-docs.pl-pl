---
title: 'CA0054: zestaw reguł niestandardowych ma nieprawidłowe zasoby XML.'
description: Dzieje się tak, jeśli zestaw reguł niestandardowych ma nieprawidłowe zasoby XML opisujące jego reguły.
ms.date: 10/19/2016
ms.topic: reference
f1_keywords:
- CA0054
...
ms.locfileid: "102468367"
---
# <a name="ca0054"></a>CA0054
Zestaw reguł niestandardowych ma nieprawidłowe zasoby XML.

Dzieje się tak, jeśli zestaw reguł niestandardowych ma nieprawidłowe zasoby XML opisujące jego reguły. Prawidłowy format jest następujący:
