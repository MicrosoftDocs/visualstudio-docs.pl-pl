...
ms.date: 11/04/2016
description: Dowiedz się więcej na temat zestawu reguł zalecanych przez program Visual Studio Native. Zobacz opisy reguł zabezpieczeń, niezawodności i innych krytycznych problemów w kodzie natywnym.
