...
Typ widoczny na zewnątrz można przypisać do interfejsu <xref:System.Runtime.Serialization.ISerializable?displayProperty=fullName> i jeden z następujących warunków jest spełniony:
