...
ms.locfileid: "72018451"
---
# <a name="c-core-guidelines-checker-reference"></a>W języku C++ podstawowych wytycznych dotyczących sprawdzania odwołania

W tej sekcji przedstawiono podstawowe sprawdzanie wytyczne dotyczące języka C++ ostrzeżenia. Aby uzyskać informacje na temat analizy kodu, zobacz [/analyze (analiza kodu)](/cpp/build/reference/analyze-code-analysis) i [Quick Start: Analiza kodu dla języka CC++/](../code-quality/quick-start-code-analysis-for-c-cpp.md).
...
Expression '%expr%': Brak tablicy do wskaźnika. Zobacz [C++ podstawowe wytyczne Bounds.3](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-bounds).
...
[C26444 NO_UNNAMED_RAII_OBJECTS](c26444.md) Unikaj nienazwanych obiektów z niestandardowym konstruowaniem i niszczeniem. Zobacz [ES. 84: Nie (spróbuj) zadeklarować zmienną lokalną bez nazwy @ no__t-0.
...
[C26433 OVERRIDE_EXPLICITLY](c26433.md) funkcji "% % symbol" powinien być oznaczony przez "override". Zobacz [C. 128: Funkcje wirtualne powinny określać dokładnie jedną z elementów wirtualnych, przesłonięcia lub Final @ no__t-0.
...
[C26435 SINGLE_VIRTUAL_SPECIFICATION](c26435.md) funkcji "% % symbol" powinna określać dokładnie jeden "virtual", "override" lub "final". Zobacz [C. 128: Funkcje wirtualne powinny określać dokładnie jedną z elementów wirtualnych, przesłonięcia lub Final @ no__t-0.
...
[C26443 NO_EXPLICIT_DTOR_OVERRIDE](c26443.md) przesłanianie destruktora nie należy używać jawnych "override" ani "virtual" specyfikatorów. Zobacz [C. 128: Funkcje wirtualne powinny określać dokładnie jedną z elementów wirtualnych, przesłonięcia lub Final @ no__t-0.
...
Zobacz podstawowe wytyczne dotycząceC++ [:  F. 6: Jeśli funkcja nie może zgłosić, zadeklaruj ją noexcept @ no__t-0.
...
[C26446 USE_GSL_AT](c26446.md) wolą używać `gsl::at()` zamiast niesprawdzonego operatora. Zobacz podstawowe wytyczne dotycząceC++ [:  Granice. 4: Nie używaj funkcji i typów, które nie są powiązane z biblioteką standardowa — sprawdzono @ no__t-0.
...
[C26485 NO_ARRAY_TO_POINTER_DECAY](C26485.md) Wyrażenie "% Expr%": Brak tablicy do wskaźnika. Zobacz [Bounds.3 wytyczne dotyczące podstawowych języka C++](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-bounds)
...
Zobacz [C++ Core wytycznych GSL. View: Widoki @ no__t-0

[C26446 USE_GSL_AT](c26446.md) wolą używać `gsl::at()` zamiast niesprawdzonego operatora. Zobacz podstawowe wytyczne dotycząceC++ [:  Granice. 4: Nie używaj funkcji i typów, które nie są powiązane z biblioteką standardowa — sprawdzono @ no__t-0.

[C26448 USE_GSL_FINALLY](c26448.md) Rozważ użycie `gsl::finally`, jeśli ostateczna akcja jest zamierzona. Zobacz podstawowe wytyczne dotycząceC++ [:  GSL.util: Narzędzia @ no__t-0.

[C26449 NO_SPAN_FROM_TEMPORARY](c26449.md) 
 `gsl::span` lub `std::string_view` utworzony na podstawie będą nieprawidłowe gdy zostaje unieważniony tymczasowy. Zobacz podstawowe wytyczne dotycząceC++ [: GSL. View: Wyświetla @ no__t-0.
