...
[C26448 USE_GSL_FINALLY](c26448.md) Rozważ użycie `gsl::finally`, jeśli ostateczna akcja jest zamierzona. Zobacz [C++ podstawowych wytycznych dotyczących języka: GSL.util: narzędzia](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities).
