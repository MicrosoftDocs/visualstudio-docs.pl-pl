...
- Istnieje odwołanie do wartości wyliczenia [Newtonsoft. JSON. TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) , innej niż `None` .
...
Ta reguła umożliwia znalezienie wartości [Newtonsoft. JSON. TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) innych niż `None` . Jeśli chcesz zdeserializować tylko wtedy, gdy określono [Newtonsoft. JSON. Serialization. ISerializationBinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm) , aby ograniczyć typy deserializowane, wyłącz tę regułę i Włącz w zamian reguły [CA2327](ca2327.md), [CA2328](ca2328.md), [CA2329](ca2329.md)i [CA2330](ca2330.md) .
