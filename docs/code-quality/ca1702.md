...
description: Nazwa identyfikatora zawiera wiele wyrazów i co najmniej jeden z nich wydaje się wyrazem złożonym, w którym wielkość liter nie jest poprawna.
ms.date: 03/28/2018
ms.topic: reference
f1_keywords:
- CA1702
