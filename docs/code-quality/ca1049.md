...
description: Typ odwołuje się do pola system. IntPtr, pola system. UIntPtr lub typu System. Runtime. InteropServices. HandleRef —, ale nie implementuje interfejsu system. IDisposable.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1049
