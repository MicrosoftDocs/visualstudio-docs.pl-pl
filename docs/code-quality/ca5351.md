...
- <xref:System.Security.Cryptography.RC2> szyfrowanie jest podatne na atak z wykorzystaniem klucza powiązanego, w którym atakujący odnajduje relacje matematyczne między wszystkimi wartościami klucza.
...
- Dla algorytmu DES i RC2 Użyj szyfrowania <xref:System.Security.Cryptography.Aes>.
