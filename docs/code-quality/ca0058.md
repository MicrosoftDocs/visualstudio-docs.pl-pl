...
- W C++programie można odwoływać się do zestawów za pomocą FORCEDUSING w VCPROJ, zastępując wiersz polecenia, aby przekazać/ForcedUsing lub dodać #using \<Some. dll > tylko w źródle.
