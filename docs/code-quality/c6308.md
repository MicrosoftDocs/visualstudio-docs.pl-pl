...
ms.locfileid: "72017769"
---
# <a name="c6308"></a>C6308
Ostrzeżenie C6308: element "realloc" może zwracać wskaźnik o wartości null: przypisanie wskaźnika o wartości null do > \<variable, który jest przekazaniem jako argument do elementu "realloc", spowoduje przeciek oryginalnego bloku pamięci
