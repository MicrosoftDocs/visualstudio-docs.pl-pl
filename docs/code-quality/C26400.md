...
Ta reguła sprawdza obecnie tylko zmienne lokalne. Jeśli alokacja jest przypisany do formalnego parametru, zmienna globalna, składowej klasy i tak dalej, nie jest traktowane. Odpowiednie pokrycie takich scenariuszy jest częścią przyszłych zadań.
