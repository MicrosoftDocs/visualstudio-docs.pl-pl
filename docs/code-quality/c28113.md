...
ms.locfileid: "72010548"
---
# <a name="c28113"></a>C28113
Ostrzeżenie C28113: Uzyskiwanie dostępu do zmiennej lokalnej przez zablokowaną funkcję

 Sterownik używa procedury międzyblokującej pomocy technicznej, takiej jak [InterlockedDecrement](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-interlockeddecrement), w celu uzyskania dostępu do zmiennej lokalnej.
