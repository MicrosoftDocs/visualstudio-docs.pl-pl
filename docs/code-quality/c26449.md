...
- Ta reguła ostrzega w miejscach, w których konstruktory są wywoływane dla zakresów lub widoków, a źródłowy bufor danych należy do tymczasowego obiektu utworzonego w tej samej instrukcji. Możliwości obejmują:
