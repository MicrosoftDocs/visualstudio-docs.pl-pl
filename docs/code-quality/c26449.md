...
`gsl::span` lub `std::string_view` utworzone na podstawie wartości tymczasowej będą nieprawidłowe, gdy tymczasowe jest unieważnione.

C++Podstawowe wytyczne: [GSL. View: Wyświetla @ no__t-0.
