---
description: Następujące reguły FxCop starszej wersji są przestarzałe i nie zostaną zaimplementowane jako analizatory.
title: Przestarzałe reguły
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
