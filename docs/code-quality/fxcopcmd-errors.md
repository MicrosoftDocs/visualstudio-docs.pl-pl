...
ms.date: 10/19/2016
description: Dowiedz się więcej o kodach błędów zwracanych przez polecenie plik FxCopCmd. Sprawdź, jaki typ błędu reprezentuje każdy kod, i Dowiedz się, jak rozpoznać błędy krytyczne.
