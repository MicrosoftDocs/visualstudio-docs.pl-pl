...
ms.date: 11/04/2016
description: Zapoznaj się z podstawowymi regułami poprawności ustawioną w programie Visual Studio, które koncentrują się na błędach logiki i często spotykane błędy interfejsu API platformy. Zobacz opisy reguł.
