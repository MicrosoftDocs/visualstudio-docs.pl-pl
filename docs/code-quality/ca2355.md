---
title: 'CA2355: niebezpieczny zestaw danych lub element DataTable w grafie serializowanych obiektów'
ms.date: 07/14/2020
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "86393503"
---
# <a name="ca2355-unsafe-dataset-or-datatable-in-deserialized-object-graph"></a>CA2355: niebezpieczny zestaw danych lub element DataTable w grafie serializowanych obiektów
...
Podczas deserializacji niezaufanych danych wejściowych przy użyciu programu <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> i deserializowany obiekt Graph zawiera <xref:System.Data.DataSet> lub <xref:System.Data.DataTable> , osoba atakująca może nawiązać złośliwy ładunek w celu wykonania ataku zdalnego wykonywania kodu. Mogą wystąpić nieznane luki w zabezpieczeniach dotyczące zdalnego wykonywania kodu.
