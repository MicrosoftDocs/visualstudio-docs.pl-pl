...
**C++ Podstawowe wytyczne**: R. 36: Aby można było zachować liczbę odwołań do obiektu, należy zastosować stałą shared_ptr @ no__t-0widget > parametr &.
