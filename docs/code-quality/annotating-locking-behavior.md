...
|`_Lock_level_order_(name1, name2)`|Instrukcja, która zapewnia kolejność blokowania między `name1` i `name2`.  Blokady, które mają `name1` poziomu muszą zostać pobrane przed blokadami, które mają poziom `name2`|
