...
>
> - Opcja **analizy** **kodu uruchamiania**  > .
> - Pola wyboru **Uruchom przy kompilacji** i **Pomijaj wyniki z wygenerowanego kodu** na karcie **Analiza kodu** na stronach właściwości projektu.
