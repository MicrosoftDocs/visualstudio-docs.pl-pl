...
ms.date: 11/04/2016
description: Dowiedz się więcej na temat rozszerzonych reguł dotyczących wytycznych dotyczących projektowania w programie Visual Studio, które koncentrują się na użyteczności i utrzymaniu. Zobacz opisy reguł.
