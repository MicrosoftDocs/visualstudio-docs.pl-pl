...
Aby naprawić naruszenie tej reguły, oznacz metodę, która ładuje zestaw z <xref:System.Security.SecurityCriticalAttribute> lub atrybutem <xref:System.Security.SecuritySafeCriticalAttribute>.
