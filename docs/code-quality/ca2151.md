...
Aby naprawić naruszenie tej reguły, zaznacz pole z atrybutem <xref:System.Security.SecurityCriticalAttribute> lub ustaw typ, do którego odwołuje się pole zabezpieczenia przezroczyste lub bezpieczne krytyczne.
