...
Ta zasada jest wyzwalana, gdy oba poniższe warunki mogą być spełnione dla wystąpienia [Newtonsoft.Json.Jsonserializer](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) :
