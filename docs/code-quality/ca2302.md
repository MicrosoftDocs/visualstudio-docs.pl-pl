---
title: 'CA2302: Upewnij się, że ustawiono BinaryFormatter. Binder przed wywołaniem BinaryFormatter. deserializacji'
ms.date: 04/05/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809717"
---
# <a name="ca2302-ensure-binaryformatterbinder-is-set-before-calling-binaryformatterdeserialize"></a>CA2302: Upewnij się, że ustawiono BinaryFormatter. Binder przed wywołaniem BinaryFormatter. deserializacji
...
Metoda deserializacji <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> została wywołana lub ma odwołanie, a właściwość <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> może mieć wartość null.

Ta reguła jest podobna do [CA2301](ca2301.md), ale analiza nie może określić, czy <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> ma na pewno wartość null.
