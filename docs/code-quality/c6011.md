...
## <a name="example"></a>Przykład
 Poniższy kod generuje to ostrzeżenie, ponieważ wywołanie funkcji malloc może zwrócić wartość null, jeśli nie jest dostępna wystarczająca ilość pamięci:
