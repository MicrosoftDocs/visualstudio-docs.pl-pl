...
[C. 128: Funkcje wirtualne powinny określać dokładnie jedną z wirtualnych, przesłonięcia lub ostatecznego](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md)
