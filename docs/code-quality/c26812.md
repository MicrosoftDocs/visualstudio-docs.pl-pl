...
ms.locfileid: "68423071"
---
# <a name="warning-c26812-prefer-enum-class-over-enum-enum3"></a>Ostrzeżenie C26812 Preferuj "enum Class" przed "enum" (enum. 3)
Typ wyliczeniowy% Type% jest nieobjęty zakresem. Preferuj element "enum Class" przed "wyliczeniem" (Wyliczenie. 3)
