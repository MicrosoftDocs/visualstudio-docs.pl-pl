...
Należy pamiętać, że posiadanie pola publicznego narusza także reguły projektowania [CA1051: Nie deklaruj widocznych pól wystąpień](../code-quality/ca1051.md).
...
- Zastąp tablicę kolekcją o jednoznacznie określonym typie, której nie można zmienić. Aby uzyskać więcej informacji, zobacz temat <xref:System.Collections.ReadOnlyCollectionBase?displayProperty=fullName>.
