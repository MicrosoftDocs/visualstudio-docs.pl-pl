...
Poniższy przykład naprawia poprzednie naruszenie przez zapakowanie operacji w zaznaczonym bloku. Jeśli operacja powoduje przepełnienie, zostanie wygenerowany <xref:System.OverflowException?displayProperty=fullName>.
