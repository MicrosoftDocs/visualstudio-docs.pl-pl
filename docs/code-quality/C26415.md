...
**W języku C++ podstawowych wytycznych dotyczących**: R.30: Wykonaj inteligentnych wskaźników jako parametry tylko z semantyką okresu istnienia jawnie express
