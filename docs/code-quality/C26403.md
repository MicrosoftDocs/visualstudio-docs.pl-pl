...
- Obecnie to sprawdzenie nie zapewnia dokładnej ścieżki, która kończy się niepowodzeniem do zwolnienia zasobu. To zachowanie, mogą być ulepszane w przyszłych wersjach. Może być trudne do znalezienia dokładną lokalizację poprawki. Lepszym rozwiązaniem jest spróbuj zamienić zwykły wskaźniki w złożone funkcje za pomocą wskaźników unikatowy, aby uniknąć ryzyka.
