---
description: Następujące reguły FxCop starszej wersji nie zostały jeszcze zaimplementowane jako analizatory, ale nadal mogą być.
title: Nieprzeniesione reguły, które można przenieść
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
...
ms.locfileid: "102144692"
---
# <a name="unported-rules-that-may-be-ported"></a>Nieprzeniesione reguły, które można przenieść
