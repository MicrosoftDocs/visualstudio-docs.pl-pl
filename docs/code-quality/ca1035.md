...
description: Typ publiczny lub chroniony implementuje metodę System. Collections. ICollection, ale nie udostępnia metody silnie wpisanej dla CopyTo.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
