...
Metoda ustawia właściwość <xref:System.Data.IDbCommand.CommandText%2A?displayProperty=fullName> przy użyciu ciągu skompilowanego z argumentu ciągu do metody.
