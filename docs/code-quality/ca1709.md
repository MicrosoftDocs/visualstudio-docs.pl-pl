...
description: Nazwa identyfikatora nie ma poprawnej wielkości liter, zawiera dwuliterowy akronim, a druga litera jest małymi literami lub zawiera akronim trzech lub więcej wielkich liter.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
