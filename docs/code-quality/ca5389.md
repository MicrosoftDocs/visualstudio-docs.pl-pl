...
- `destinationFileName` parametru metody <xref:System.IO.Compression.ZipFileExtensions.ExtractToFile%2A?displayProperty=nameWithType>
...
- ścieżka parametru <xref:System.IO.FileStream?displayProperty=nameWithType> konstruktora
- ścieżka parametru `fileName` <xref:System.IO.FileInfo?displayProperty=nameWithType>
