...
layout: LandingPage
title: Analiza kodu
description: Dowiedz się, jak analizowanie jakości kodu za pomocą programu Visual Studio 2017.
ms.date: 12/03/2018
...
ms.locfileid: "55949018"
---
# <a name="code-analysis-in-visual-studio"></a>Analiza kodu w programie Visual Studio

Visual Studio zawiera kilka różnych narzędzi do analizowania i poprawią jakość kodu.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analizowanie jakości kodu zarządzanego</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analizowanie jakości kodu C i C++</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Mierzenie łatwości utrzymania kodu za pomocą metryk kodu</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Ostrzeżenia analizy zarządzanego kodu</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Ostrzeżenia analizy kodu w języku C++</h3>
                    </div>
                </div>
            </div>
        </div>
