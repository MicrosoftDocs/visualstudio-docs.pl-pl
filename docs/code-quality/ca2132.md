...
Nie pomijaj ostrzeżeń z tej reguły. Naruszenia tej reguły przez kod aplikacji spowodują, że CoreCLR załaduje typ z <xref:System.TypeLoadException>.
