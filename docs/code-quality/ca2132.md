...
description: Atrybut przezroczystości domyślnego konstruktora klasy pochodnej nie jest tak krytyczny jak przezroczystość klasy bazowej.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2132
