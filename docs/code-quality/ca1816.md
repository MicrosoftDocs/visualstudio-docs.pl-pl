...
- Zmień wszystkie wywołania na <xref:System.GC.SuppressFinalize%2A?displayProperty=nameWithType> , aby przekazać [(C#)](/dotnet/csharp/language-reference/keywords/this) lub [Me (Visual Basic)](/dotnet/visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass#me).
...
Ten przykład przedstawia metodę, która poprawnie wywołuje wywołania <xref:System.GC.SuppressFinalize%2A?displayProperty=nameWithType> , przekazując [ten (C#)](/dotnet/csharp/language-reference/keywords/this) lub [Me (Visual Basic)](/dotnet/visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass#me).
