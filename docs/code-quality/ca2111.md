...
Publiczne lub chronione <xref:System.IntPtr?displayProperty=fullName> lub pole <xref:System.UIntPtr?displayProperty=fullName> nie jest tylko do odczytu.
