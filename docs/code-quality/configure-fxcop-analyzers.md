...
ms.locfileid: "90560765"
---
# <a name="configure-net-code-quality-analyzers-with-editorconfig"></a>Konfigurowanie analizatorów jakości kodu platformy .NET przy użyciu EditorConfig

Począwszy od platformy .NET 5,0, analizatory jakości kodu[ `CAxxxx` ](code-analysis-for-managed-code-warnings.md)są dołączone do [zestawu .NET SDK](/dotnet/fundamentals/productivity/code-analysis.md/#code-quality-analysis). Każdy Analizator jakości kodu może być rafinowany do zastosowania do części bazy kodu za pomocą konfigurowalnych opcji. Każda opcja jest określona przez dodanie pary klucz-wartość do pliku [EditorConfig](https://editorconfig.org) . Plik konfiguracji może być specyficzny dla pliku, projektu, rozwiązania lub całego repozytorium.
...
## <a name="options-for-net-code-quality-analyzers"></a>Opcje dla analizatorów jakości kodu platformy .NET
