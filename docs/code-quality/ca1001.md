...
Począwszy od programu FxCop analizatory 3. x, ta reguła odnoszą się do typów implementujących <xref:System.IAsyncDisposable?displayProperty=fullName> jako typy jednorazowe. 
