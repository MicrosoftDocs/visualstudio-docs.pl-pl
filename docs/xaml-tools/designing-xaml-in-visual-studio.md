...
| Zadanie | {1&gt;Visual Studio&lt;1} | Blend for Visual Studio | Więcej informacji |
| - | - | - | - |
...
Aby uzyskać więcej informacji na temat Zaawansowana konstrukcja XAML, zobacz [Tworzenie interfejsu użytkownika przy użyciu programu Blend for Visual Studio](../xaml-tools/creating-a-ui-by-using-blend-for-visual-studio.md).
