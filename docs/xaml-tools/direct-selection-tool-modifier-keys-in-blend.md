...
description: Informacje o skrótach klawiaturowych w narzędziu Wybór bezpośredni w Blend for Visual Studio, których można użyć do modyfikacji kształtu istniejącej ścieżki.
