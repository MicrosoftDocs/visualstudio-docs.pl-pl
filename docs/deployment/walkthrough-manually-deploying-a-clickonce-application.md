...
description: Dowiedz się, jak utworzyć wdrożenie ClickOnce przy użyciu wersji wiersza polecenia lub graficznej wersji Narzędzie tworzenia i edycji manifestów.
