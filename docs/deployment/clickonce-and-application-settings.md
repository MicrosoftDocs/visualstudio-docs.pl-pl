...
description: Dowiedz się, jak pliki ustawień aplikacji działają w aplikacji ClickOnce oraz jak technologia ClickOnce migruje ustawienia, gdy użytkownik uaktualnia do następnej wersji.
