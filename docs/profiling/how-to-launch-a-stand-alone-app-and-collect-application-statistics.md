...
---
# <a name="how-to-launch-a-stand-alone-application-with-the-profiler-and-collect-application-statistics-by-using-the-command-line"></a>Instrukcje: uruchamianie aplikacji autonomicznej za pomocą profilera i zbieranie statystyk aplikacji przy użyciu wiersza polecenia
W tym temacie opisano, jak używać narzędzi wiersza polecenia [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia profilowania do uruchamiania autonomicznej aplikacji (klienta) i zbierania statystyk wydajności przy użyciu metody próbkowania.
