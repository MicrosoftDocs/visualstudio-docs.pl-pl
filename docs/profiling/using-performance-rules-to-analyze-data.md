...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Zawiera informacje o sposobie otwierania **lista błędów** okna wyświetlanie ostrzeżeń dotyczących wydajności programu profilującego.  
  
 [Instrukcje: Konfigurowanie zasad wydajności](../profiling/how-to-configure-performance-rules.md)  
 Zawiera informacje o tym, jak włączyć ostrzeżeń dotyczących wydajności poszczególnych lub wyłączyć.  
  
 [Reguły wydajności — dokumentacja](../profiling/performance-rules-reference.md)  
 Zawiera szczegółowe informacje dotyczące programu profilującego ostrzeżeń dotyczących wydajności