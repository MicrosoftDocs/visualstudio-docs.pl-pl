...
Poniższy wiersz polecenia umożliwia zbieranie szczegółowych danych o chronometrażu z dynamicznie skompilowanej [!INCLUDE[vstecasp](../code-quality/includes/vstecasp_md.md)] aplikacji sieci Web:
