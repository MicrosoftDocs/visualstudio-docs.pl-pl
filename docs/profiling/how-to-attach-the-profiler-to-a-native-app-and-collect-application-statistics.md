...
---
# <a name="how-to-attach-the-profiler-to-a-native-stand-alone-application-and-collect-application-statistics-by-using-the-command-line"></a>Instrukcje: dołączanie profilera do natywnej aplikacji autonomicznej i zbieranie statystyk aplikacji przy użyciu wiersza polecenia
W tym artykule opisano sposób używania narzędzi wiersza polecenia [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia profilowania do dołączania profilera do uruchomionej natywnej aplikacji autonomicznej (klienckiej) i zbierania statystyk wydajności przy użyciu metody próbkowania.
