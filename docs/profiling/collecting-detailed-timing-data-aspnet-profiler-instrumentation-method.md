...
description: Dowiedz się, jak zbierać szczegółowe dane dotyczące wydajności aplikacji sieci Web ASP.NET przy użyciu programu VSPerfCmd. Zapewnia pełen dostęp do funkcji narzędzia profilowania.
