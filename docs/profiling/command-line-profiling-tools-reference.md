---
title: Informacje o narzędzia profilowania wiersza polecenia | Microsoft Docs
ms.date: 11/04/2016
ms.topic: conceptual
...
- [VSPerfMon](../profiling/vsperfmon.md)
 ...
 Wyświetla listę opcji VSPerfMon. exe na potrzeby zbierania danych.

- [VSPerfReport](../profiling/vsperfreport.md)

 Wyświetla listę opcji wiersza polecenia VSPerfReport. exe na potrzeby tworzenia raportów.
