---
title: Dołącz profiler do aplikacji ASP.NET, aby zbierać dane współbieżności
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
...
W tym artykule opisano, jak używać narzędzi wiersza polecenia [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia profilowania do dołączania profilera do aplikacji ASP.NET i zbierania danych współbieżności procesu i wątku.
