...
Metoda `MarkProfile` Wstawia znacznik profilu w. plik *VSP* . Profilowanie wątku zawierającego funkcję `MarkProfile` musi być włączone dla znacznika, który ma zostać wstawiony.
