---
title: 'Wiersz polecenia profilera: Instrumentacja .NET Service, pobieranie danych pamięci'
ms.date: 11/04/2016
ms.topic: conceptual
...
W tym artykule opisano, jak używać narzędzi wiersza polecenia [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia profilowania do Instrumentacji usługi .NET Framework i zbierania danych o użyciu pamięci. Można zbierać dane alokacji pamięci lub zbierać dane alokacji pamięci i okresu istnienia obiektu.
