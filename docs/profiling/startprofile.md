---
title: StartProfile | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- StartProfile
...
Funkcja `StartProfile` ustawia licznik na 1 (on) dla określonego poziomu profilowania.
...
|PROFILE_PROCESSLEVEL|Ustawienie poziomu procesu ma wpływ na wszystkie wątki, które są częścią określonego procesu.|
