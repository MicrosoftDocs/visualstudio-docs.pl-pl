...
W tym artykule opisano, jak używać narzędzi wiersza polecenia [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia profilowania do dołączania profilera do uruchomionej aplikacji autonomicznejC++(C/) i zbierania danych rywalizacji o wątki.
