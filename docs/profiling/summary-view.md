...
- Jeśli określisz segment czasu na wykresie, możesz ponownie przeanalizować dane dla tego segmentu lub powiększyć oś czasu do określonego segmentu. Aby uzyskać więcej informacji, zobacz [jak: Filtruje widoki raportów na podstawie podsumowania osi czasu](../profiling/how-to-filter-report-views-from-the-summary-timeline.md).
