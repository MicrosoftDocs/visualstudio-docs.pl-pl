---
title: Dołącz profiler do aplikacji sieci Web ASP.NET, aby uzyskać statystykę aplikacji
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
...
W tym artykule opisano, jak używać narzędzi wiersza polecenia [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia profilowania do dołączania profilera do aplikacji sieci Web ASP.NET i zbierania statystyk wydajności przy użyciu metody próbkowania.
...
1. Wykonaj jedną z następujących czynności, aby odłączyć Profiler od aplikacji docelowej:
   ...
   - Zamknij proces roboczy [!INCLUDE[vstecasp](../code-quality/includes/vstecasp_md.md)].
