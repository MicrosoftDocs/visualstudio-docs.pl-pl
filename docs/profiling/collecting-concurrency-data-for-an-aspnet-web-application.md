...
description: Zobacz informacje referencyjne na temat metody współbieżności programu Visual Studio narzędzia profilowania, która umożliwia zbieranie danych rywalizacji o zasoby.
...
### <a name="profile-aspnet-applications"></a>Profilowanie aplikacji ASP.NET
...
|Zadanie|Powiązana zawartość|
|----------|---------------------|
|**Samodzielne Profilowanie aplikacji (klienta)**|-   [Zbieranie danych współbieżności](../profiling/collecting-concurrency-data-for-stand-alone-applications.md)|
