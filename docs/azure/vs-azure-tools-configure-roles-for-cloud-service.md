...
- **ServiceDefinition. csdef** — plik definicji usługi definiuje ustawienia czasu wykonywania dla usługi w chmurze, w tym informacje o wymaganych rolach, punktach końcowych i rozmiarze maszyny wirtualnej. Żadna z danych przechowywanych w `ServiceDefinition.csdef` nie może zostać zmieniona, gdy rola jest uruchomiona.
