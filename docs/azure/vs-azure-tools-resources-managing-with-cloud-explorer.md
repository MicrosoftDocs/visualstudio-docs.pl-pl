...
> [!NOTE]
> Aby wyświetlić programu Cloud Explorer, naciśnij klawisz **Ctrl**+**Q** aktywować pole wyszukiwania, a następnie wprowadź **programu Cloud Explorer**.
