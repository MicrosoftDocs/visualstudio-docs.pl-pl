...
1. W eksperymentalnym wystąpieniu programu Visual Studio Otwórz przykładowy plik szablonu tekstowego. Ustaw jej zawartość w następujący sposób.
    ...
    - `hostSpecific` `inherits` `template` Należy ustawić atrybuty i dyrektywy.
...
4. W eksperymentalnym wystąpieniu programu Visual Studio Otwórz polecenie `Debugging\Sample.consume` .
