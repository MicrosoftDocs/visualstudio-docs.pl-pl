...
description: Zapoznaj się z tym, że w zestawie SDK wizualizacji i modelowania można definiować programy obsługi zdarzeń magazynu, aby propagować zmiany do zasobów poza magazynem.
