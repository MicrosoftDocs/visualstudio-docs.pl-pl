...
- [Ewidencjonowanie warunkowe TFVC](/azure/devops/pipelines/build/triggers#gated)
...
### <a name="DescribeLayers"></a>Opisywanie architektury logicznej: diagramy zależności
