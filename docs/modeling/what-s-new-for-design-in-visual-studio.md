...
description: Dowiedz się więcej o nowych funkcjach dotyczących projektowania kodu, takich jak weryfikacja zależności na żywo, które są dostępne w programie Visual Studio 2017.
