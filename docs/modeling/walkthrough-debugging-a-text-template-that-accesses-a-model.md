---
title: 'Przewodnik: debugowanie szablonów tekstowych, które uzyskują dostęp do modelu'
description: Zawiera informacje o sposobie debugowania szablonu tekstu, który uzyskuje dostęp do modelu.
ms.date: 11/04/2016
ms.topic: how-to
