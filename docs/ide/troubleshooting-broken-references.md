...
description: Dowiedz się, jak rozwiązywać problemy z uszkodzonymi odwołaniami, które mogą być spowodowane przez coś innego niż aplikacje, aby znaleźć składnik, do którego się odwołuje.
