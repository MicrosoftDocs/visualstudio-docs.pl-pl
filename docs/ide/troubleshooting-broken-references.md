...
description: Dowiedz się, jak rozwiązywać problemy z uszkodzonymi odwołaniami, które mogą być spowodowane przez coś innego niż brak możliwości aplikacji do znalezienia składnika, do którego się odwołuje.
