...
## <a name="adonet-entity-data-model-designer"></a>{1&gt;Projektant modelu danych jednostki ADO.NET&lt;1}
...
## <a name="microsoft-sql-server-data-tools-t-sql-pdw-editor"></a>{1&gt;Narzędzia danych Microsoft SQL Server, Edytor T-SQL PDW&lt;1}
...
## <a name="vc-string-editor"></a>{1&gt;Edytor ciągów VC&lt;1}
...
## <a name="work-item-results-view"></a>{1&gt;Widok wyników dotyczących elementu pracy&lt;1}
