...
Aby uzyskać informacje o tworzeniu aplikacji w językach dwukierunkowych w programie Visual Studio, zobacz [Twórz aplikacje dla arabski i hebrajski](creating-applications-in-bi-directional-languages.md).
