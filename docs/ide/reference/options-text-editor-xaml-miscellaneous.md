...
To ustawienie służy do kontrolowania, kiedy błędy i ostrzeżenia są generowane automatycznie. Aby uzyskać więcej informacji, zobacz [błędy i ostrzeżenia XAML](../../designers/xaml-errors-warnings.md).
