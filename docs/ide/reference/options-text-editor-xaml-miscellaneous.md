...
|**Zamykające nawiasy klamrowe dla wyrażeń MarkupExtension**|Określa, czy rozszerzenie znaczników w zamykający nawias klamrowy (**}**) jest generowany automatycznie po wpisaniu otwierający nawias klamrowy znak (**{**).|
