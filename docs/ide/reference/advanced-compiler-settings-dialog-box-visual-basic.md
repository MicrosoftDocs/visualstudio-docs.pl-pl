...
description: Dowiedz się, jak za pomocą okna dialogowego Zaawansowane ustawienia kompilatora określić zaawansowane właściwości kompilacji — konfiguracja.
