...
Po wybraniu tej opcji istnieje możliwość wybrania jednego z dwóch przycisków radiowych: **Jest to aplikacja o pełnej relacji zaufania** lub **jest to częściowa aplikacja zaufania**.
