...
description: Dowiedz się, jak za pomocą strony kart w sekcji wszystkie języki zmienić domyślne zachowanie kart edytora kodu w programie Visual Studio.
