...
ms.locfileid: "99932278"
---
# <a name="options-text-editor-xml-miscellaneous"></a>Opcje, Edytor tekstu, XML, różne

Na stronie **różne** opcje można zmienić ustawienia autouzupełniania i schematu dla edytora XML. Aby uzyskać dostęp do różnych opcji XML, wybierz opcje **Narzędzia**  >    >  **Edytor tekstu**  >  **XML**, a następnie wybierz **różne**.
