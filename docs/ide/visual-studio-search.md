---
title: Korzystanie z programu Visual Studio Search
...
Użyj **Ctrl** + skrótu klawiaturowego Ctrl**Q** , aby uzyskać dostęp do pola wyszukiwania lub kliknij pole danych wyjściowych wyszukiwania programu Visual Studio znajdujące się obok paska menu domyślnie:
...
:::image type="content" source="media/visual-studio-search-options.png" alt-text="Pole wyszukiwania programu Visual Studio":::
...
:::image type="content" source="media/visual-studio-search-menu.png" alt-text="Pole wyszukiwania programu Visual Studio":::
...
:::image type="content" source="media/visual-studio-search-window.png" alt-text="Pole wyszukiwania programu Visual Studio":::
...
:::image type="content" source="media/visual-studio-search-files.png" alt-text="Pole wyszukiwania programu Visual Studio":::
...
:::image type="content" source="media/visual-studio-search-camel.png" alt-text="Pole wyszukiwania programu Visual Studio":::
