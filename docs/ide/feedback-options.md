...
Jeśli masz pomysł lub sugestię, aby ulepszyć program Visual Studio, poinformuj nas za pomocą narzędzia **Zasugeruj funkcję** . W programie Visual Studio wybierz ikonę opinii w prawym górnym rogu lub wybierz pozycję **pomoc** > **Prześlij opinię** > **Zasugeruj funkcję** na pasku menu.
...
Jeśli masz pomysł lub sugestię, aby ulepszyć program Visual Studio, poinformuj nas za pomocą narzędzia do **tworzenia sugestii** . W programie Visual Studio wybierz ikonę opinii obok pola wyszukiwania lub wybierz pozycję **pomoc** > **Prześlij opinię** > **Podaj sugestię** z paska menu.
...
## <a name="ask-the-community"></a>Pytanie do społeczności
