            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Dowiedz się, jak instalowanie i konfigurowanie programu Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
...
## <a name="experience-visual-studio-with-5-minute-quickstarts"></a>Środowisko Visual Studio z 5-minutowych "samouczki Szybki Start"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Dowiedz się więcej o projekty i rozwiązania</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Tworzenie aplikacji sieci web w języku C#</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="go-deeper-with-tutorials"></a>Uzyskaj szczegółowe samouczki
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>Debugowanie</span></a></div>