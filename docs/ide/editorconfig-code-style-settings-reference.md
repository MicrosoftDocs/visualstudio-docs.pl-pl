...
- [Konwencje języka](../ide/editorconfig-language-conventions.md)
   ...
   Reguły dotyczące języka C# lub Visual Basic. Na przykład można określić reguły dotyczące użycia `var` lub typów jawnych podczas definiowania zmiennych lub wstępnego wnioskowania członków w postaci wyrażeń.
...
Oto przykład pliku *editorconfig* z opcjami domyślnymi, aby pomóc Ci rozpocząć pracę. W programie Visual Studio można wygenerować ten plik i zapisać go w projekcie w obszarze **Narzędzia**  >  **Opcje**  >  **edytora tekstu** > [**C#** lub **Basic**] > ogólny **styl kodu**  >  **General**. Następnie kliknij przycisk **Generuj plik editorconfig z ustawień** . Aby uzyskać więcej informacji, zobacz [Preferencje dotyczące stylu kodu](code-styles-and-code-cleanup.md).
