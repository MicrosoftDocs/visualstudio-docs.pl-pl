...
Oto przykład pliku *editorconfig* z opcjami domyślnymi, aby pomóc Ci rozpocząć pracę. W programie Visual Studio można wygenerować ten plik i zapisać go w projekcie w **narzędziach** > **Opcje** > **edytorze tekstów** > [**C#** lub **Basic**] > **stylu kodu** > **Ogólne**. Następnie kliknij przycisk **Generuj plik editorconfig z ustawień** . Aby uzyskać więcej informacji, zobacz [Preferencje dotyczące stylu kodu](code-styles-and-code-cleanup.md).
