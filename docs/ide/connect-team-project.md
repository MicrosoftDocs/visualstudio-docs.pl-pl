...
1. Na stronie **Połącz** wybierz pozycję **Zarządzaj połączeniami** ,  >  połączyć się z**projektem**.
...
- [Informacje Team Explorer](reference/team-explorer-reference.md)
