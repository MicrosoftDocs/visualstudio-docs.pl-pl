...
Za pomocą okna dialogowego **narzędzia** > **rozszerzenia i aktualizacje** można wykonywać następujące zadania związane z przykładami:

::: moniker-end

::: moniker range=">=vs-2019"

Za pomocą okna dialogowego **rozszerzenia** > **Zarządzanie rozszerzeniami** można wykonywać następujące zadania związane z przykładami:
