...
description: Dowiedz się, jak tworzyć szablony wieloprojektowe w programie Visual Studio, które mogą działać jako kontenery dla wielu projektów w tym samym czasie.
