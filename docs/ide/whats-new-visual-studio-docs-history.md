---
title: 'Visual Studio dokumentów: Historia nowości '
titleSuffix: ''
...
ms.locfileid: "111516937"
---
# <a name="history-of-whats-new-in-visual-studio-docs"></a>Historia nowości w dokumentacji programu Visual Studio

Witamy w historii nowości w Visual Studio dokumentów. Ten artykuł zawiera najważniejsze zmiany w dokumentów sprzed kwietnia 2021 r. (począwszy od lipca 2020 r.). Najnowsze informacje o nowościach można znaleźć w [Visual Studio docs: What's new in the docs](whats-new-visual-studio-docs.md).
...
- [Włączanie lub instalowanie zewnętrznych analizatorów .NET](../code-quality/install-net-analyzers.md) — poprawki problemów z usługą GitHub

### <a name="containers"></a>Kontenery

**Zaktualizowane artykuły**

- [Use Bridge to Kubernetes](../containers/bridge-to-kubernetes.md) - Bridge to Kubernetes: Use .NET todo-app sample (Używanie przykładu aplikacji todo-app na stronie .NET)
- [Docker Compose kompilacji](../containers/docker-compose-properties.md) — dodawanie obiektu ComposeProjectName
...
- [Jak opublikować aplikację WPF z włączonymi stylami wizualnymi](../deployment/how-to-publish-a-wpf-application-with-visual-styles-enabled.md) — wiersz polecenia dla deweloperów program PowerShell dla deweloperów
...
- [Słownik języka wizualnego — dodawanie](../extensibility/ux-guidelines/visual-language-dictionary-for-visual-studio.md) brakujących nawiasów języka Markdown w celu naprawienia błędu renderowania ikon
...
**Nowe artykuły**
- [Jak Visual Studio ułatwia kontrolę źródła](../version-control/git-visual-studio-source-control.md) — tworzenie nowego tematu Visual Studio kontroli kodu źródłowego
...
- [Pomoc edytora kodu F1](./not-in-toc/default-f1-text-editor.md) — łączenie aktualizacji dla domyślnych stron F1
- [Pomoc F1 —](./not-in-toc/default.md) łączenie aktualizacji dla domyślnych stron F1
- [Szybki start: używanie Visual Studio do tworzenia pierwszej aplikacji Node.js —](./quickstart-nodejs.md) aktualizacje angularJS
...
- [Domyślne skróty klawiaturowe w Visual Studio](./default-keyboard-shortcuts-in-visual-studio.md) — dodaj brakujący skrót klawiaturowy Ustaw warunki przerwania
...
- [Generowanie przesłonięcia metod Equals i GetHashCode w Visual Studio](./reference/generate-equals-gethashcode-methods.md)
...
- [Numery wersji i daty wydania programu Visual Studio](../install/visual-studio-build-numbers-and-release-dates.md)
  ...
  - Aktualizacje wtorkowe poprawek
...
- [Szybki start: używanie Visual Studio do tworzenia pierwszej aplikacji Vue.js —](../javascript/quickstart-vuejs-with-nodejs.md) aktualizacje angularJS
- [Samouczek: tworzenie aplikacji ASP.NET Core przy użyciu języka TypeScript w języku Visual Studio](../javascript/tutorial-aspnet-with-typescript.md)
  ...
  - visualstudio-docs/issues/6457 -- missing version (visualstudio-docs/issues/6457 — brak wersji)
...
- [Krok 6. Korzystanie z szablonu projektu](../python/learn-django-in-visual-studio-step-06-polls-django-web-project-template.md) internetowego Django usługi Polls — usunięto zawartość szablonu sondowania z samouczków języka Python Visual Studio 2019 r.
...
- [Krok 5. Używanie szablonu projektu](../python/learn-flask-visual-studio-step-05-polls-flask-web-project-template.md) internetowego flask usługi Polls — usunięto zawartość szablonu sondowania z samouczków języka Python Visual Studio 2019 r.
...
- [Uaktualnianie *z wersji .testsettings* *do .runsettings*](../test/migrate-testsettings-to-runsettings.md) — dodawanie migracji do doku runsettings
- [Uaktualnianie z wersji MSTestV1 do MSTestV2](../test/mstest-update-to-mstestv2.md) — dodaj doc w przypadku uaktualniania z wersji MSTestV1 do MSTestv2
...
- [VSTest.Console.exe wiersza polecenia — program](../test/vstest-console-options.md) wiersz polecenia dla deweloperów i program PowerShell dla deweloperów
...
- [Samouczek: otwieranie projektu z repo w programie Visual Studio 2017 —](../get-started/tutorial-open-project-from-repo-visual-studio-2017.md) aktualizacja Zobacz również linki w programie VS2017 Open Project from a Repo (Otwieranie projektu w programie VS2017 z usługi Repo)
...
- [Rozwiązywanie problemów z programem MSBuild i tworzenie](./msbuild-logs.md) dzienników — dodawanie instrukcji dotyczących korzystania z rozszerzenia narzędzi systemowych projektu
...
- [MSB3644: Nie](../msbuild/errors/msb3644.md) znaleziono zestawów odwoływać się do "FrameworkVersion" — błędy programu MSBuild
...
- [Tworzenie i wdrażanie w Cloud Services (rozszerzona](../azure/cloud-services-extended-support.md) pomoc techniczna) w usłudze Visual Studio (wersja zapoznawcza) — rozszerzona obsługa usług w chmurze — brak szablonu
...
- [Debugowanie aplikacji .NET Core w programie WSL 2 Visual Studio](../debugger/debug-dotnet-core-in-wsl-2.md) — debugowanie programu .NET Core WSL2

**Zaktualizowane artykuły**

- [Tworzenie niestandardowych widoków obiektów C++](../debugger/create-custom-views-of-native-objects.md) w debugerze przy użyciu struktury Natvis — wyjaśnienie formatowania XML znaków specjalnych w funkcji NatVis
...
- [JavaScript F1 Help for Visual Studio](./not-in-toc/default-f1-javascript.md) - Added JS and TS default F1 pages (Pomoc języka JavaScript F1 dla języka Visual Studio — dodano domyślne strony JS i TS F1
- [Pomoc języka TypeScript F1 dla Visual Studio](./not-in-toc/default-f1-typescript.md) — dodano domyślne strony JS i TS F1
...
- [Słownik programu MSBuild](../msbuild/msbuild-glossary.md) — podówienie kluczy słownika do H2

### <a name="profiling"></a>Profilowanie

**Nowe artykuły**

- [Wizualizowanie liczników dotnet z Visual Studio profilera](../profiling/dotnet-counters-tool.md) — dodawanie do narzędzia liczników .NET
...
- [Dodawanie Azure App Configuration przy użyciu usługi Visual Studio Connected Services —](../azure/vs-azure-tools-connected-services-app-configuration.md) samouczek app Config Connected Services
...
- [Włączanie lub instalowanie analizatorów .NET firmy](../code-quality/install-net-analyzers.md)
...
- [Migrowanie z analizatorów FxCop do analizatorów .NET](../code-quality/migrate-from-fxcop-analyzers-to-net-analyzers.md) — większa przejrzystość dokumentów migracji dla analizatorów FxCopAnalyzer do narzędzia NetAnalyzers
...
- [Często zadawane pytania — znajdowanie funkcji debugowania potrzebnej w programie Visual Studio](../debugger/find-your-debugging-task.yml) — praca odnajdywania na potrzeby znajdowania zadania debugowania i tematów z omówieniem
...
- [Visual Studio i wskazówki dotyczące wydajności](./visual-studio-performance-tips-and-tricks.md) — zaktualizuj sekcję Wyłączanie narzędzia diagnostyczne wydajności
...
- [Migrowanie z analizatorów FxCop do analizatorów .NET](../code-quality/migrate-from-fxcop-analyzers-to-net-analyzers.md) — dodawania dokumentacji w celu przeprowadzenia migracji z analizatorów FxCop do analizatorów .NET
- [Migrowanie ze starszej analizy (FxCop)](../code-quality/migrate-from-legacy-analysis-to-net-analyzers.md) do analizy źródła (analizatory .NET) — dodawania dokumentacji w celu przeprowadzenia migracji z analizatorów FxCop do analizatorów .NET
- [Często zadawane pytania dotyczące starszych analizatorów FxCop](../code-quality/net-analyzers-faq.yml) i .NET — dodawanie dokumentacji dotyczącej migracji z analizatorów FxCop do analizatorów .NET

**Zaktualizowane artykuły**

- [Często zadawane pytania dotyczące analizy kodu](../code-quality/analyzers-faq.yml) — dodano dokumentację dotyczącą migracji z analizatorów FxCop do analizatorów .NET
...
- [Nieprzeniesłane reguły, które mogą](../code-quality/fxcop-unported-rules-may-get-ported.md) być przenoszone — dodano dokumentację dotyczącą migracji z analizatorów FxCop do analizatorów .NET
- [Niezaimportowane reguły](../code-quality/fxcop-unported-rules.md) — dodano dokumentację dotyczącą migracji z analizatorów FxCop do analizatorów .NET
- [Instalowanie analizatorów innych firm —](../code-quality/install-roslyn-analyzers.md) dodano dokumentację dotyczącą migracji z analizatorów FxCop do analizatorów .NET
...
- [Jak Bridge to Kubernetes działa —](../containers/overview-bridge-to-kubernetes.md) sekcja uprawnień kubernetes

### <a name="debugger"></a>Debuger

**Nowe artykuły**

- [Dołączanie do procesu uruchomionego w kontenerze platformy Docker](../debugger/attach-to-process-running-in-docker-container.md) — dołączanie refaktoryzacji w celu przetwarzania dokumentów dla scenariuszy systemu Linux
...
- [Debugowanie programu .NET Core w systemie Linux przy użyciu SSH](../debugger/remote-debugging-dotnet-core-linux-with-ssh.md) przez dołączenie do procesu — refaktoryzacja dołączania do dokumentów procesów dla scenariuszy systemu Linux
...
- [Kompilowanie aplikacji ClickOnce z wiersza polecenia](../deployment/building-clickonce-applications-from-the-command-line.md) — dodawanie szybkiego startu usługi ClickOnce dla projektów systemu Windows .NET
- [Wdrażanie aplikacji w folderze, usługach IIS, na platformie Azure](../deployment/deploying-applications-services-and-components-resources.md) lub w innym miejscu docelowym — dodaj szybki start funkcji ClickOnce dla projektów platformy .NET dla systemu Windows
- [Wdrażanie aplikacji w folderze przy użyciu Visual Studio](../deployment/quickstart-deploy-to-local-folder.md) — dodawanie szybkiego startu technologii ClickOnce dla projektów .NET dla systemu Windows
...
- [Dowiedz się więcej o projektach i](../get-started/tutorial-projects-solutions.md) rozwiązaniach — zaktualizowano tekst alternatywny & metadanych, a także dodano uwagę na temat szablonu Puste rozwiązanie
...
- [Praca z kontami usługi GitHub](./work-with-github-accounts.md) w usłudze Visual Studio — dodano informacje dotyczące pracy ze stroną usługi GitHub i logowania się do innych stron w usłudze GitHub
...
- [Korzystanie z dopasowywania wzorców](./reference/use-pattern-matching.md) — dodano funkcje produktywności dotnet
...
- [Visual Studio Team Explorer component directory](../install/workload-component-id-vs-team-explorer.md) — zaktualizowano dokumenty składników dla wersji 16.8
- [Visual Studio składnika agenta testowego](../install/workload-component-id-vs-test-agent.md) — zaktualizowano dokumenty składników dla wersji 16.8
- [Visual Studio składnika kontrolera testów](../install/workload-component-id-vs-test-controller.md) — zaktualizowano dokumenty składników dla wersji 16.8
- [Instalowanie i używanie Visual Studio usług platformy Azure za zaporą](../install/install-and-use-visual-studio-behind-a-firewall-or-proxy-server.md) lub serwerem proxy — dodano brakującą domenę

### <a name="msbuild"></a>MSBuild

**Nowe artykuły**

- [Fala zmian](../msbuild/change-waves.md) — MSBuild: zmiana fal — nowy temat
...
- [Izolowanie aplikacji na użytek](../test/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md) testów jednostkowych za pomocą podkładek — zaktualizowana dokumentacja z obsługą programu .NET Core
...
- [Używanie danych czasu projektowania z projektant XAML w Visual Studio](../xaml-tools/xaml-designtime-data.md)
  - Zaktualizowano sekcję Wymagania dla wersji 16.8 (ga ga)
...
- [Rozwiązywanie problemów z błędami związanymi z siecią podczas instalowania lub](../install/troubleshooting-network-related-errors-in-visual-studio.md) używania serwera Visual Studio — dodawanie obejścia awarii serwera proxy uwierzytelniania opinii
...
- [Pierwsze spojrzenie na narzędzia profilowania —](../profiling/profiling-feature-tour.md) przewodnik po funkcjach profilowania
- [Uruchamianie narzędzi profilowania z debugerem lub bez debugera](../profiling/running-profiling-tools-with-or-without-the-debugger.md)
  - Aktualizacje przewodnika po funkcjach profilowania
...
- [Dodawanie usługi Azure Application Insights przy użyciu Visual Studio Connected Services](../azure/azure-app-insights-add-connected-service.md) — Connected Services for VS 2019 16.7
- [Dodawanie Azure Cache for Redis przy użyciu usługi Visual Studio Connected Services](../azure/azure-cache-for-redis-add-connected-service.md) dla programu VS 2019 16.7
...
- [Dodawanie usługi Azure SignalR przy użyciu Visual Studio Connected Services](../azure/azure-signalr-add-connected-service.md) — Connected Services for VS 2019 16.7
- [Dodawanie połączenia do usługi Azure SQL Database](../azure/azure-sql-database-add-connected-service.md) — połączone usługi dla programu VS 2019 16.7

**Zaktualizowane artykuły**

- [Dodawanie usługi Azure Storage przy użyciu Visual Studio połączonych](../azure/vs-azure-tools-connected-services-storage.md)
  - Połączone usługi dla programu VS 2019 16.7
  - Artykuł o usługach połączonych usługi Azure Storage: aktualizowanie interfejsu użytkownika i obsługiwanych typów projektów
...
- [Instalator programu Visual Studio Projects Extension i .NET Core 3.1](../deployment/installer-projects-net-core.md) — tworzenie nowej strony pomocy dla projektów instalatora funkcji .NET Core 3.1
...
- [Krok 5. Wdrażanie aplikacji ASP.NET Core na platformie Azure —](../get-started/csharp/tutorial-aspnet-core-ef-step-05.md) aktualizacje samouczka wideo dla nowego interfejsu użytkownika usług połączonych
...
- [Pomoc F1 dla edytora tekstów](./not-in-toc/default-f1-text-editor.md) — refaktoryzacja domyślnej strony pomocy F1
- [Konwertuj `typeof` `nameof` na](./reference/convert-typeof-to-nameof.md) — konwertuj typof na nazwę refaktoryzacji
- [Uproszczenie wyrażenia LINQ —](./reference/simplify-linq-expression.md) uproszczenie refaktoryzacji wyrażeń LINQ

**Zaktualizowane artykuły**

- [Dostosowywanie układów okien w Visual Studio](./customizing-window-layouts-in-visual-studio.md) — dodaj monikered vertical document tabs info (Dostosowywanie układów okien) w artykule Customize Window Layouts (Dostosowywanie układów okien).
- [Jak zgłosić problem z Visual Studio lub Instalator programu Visual Studio](./how-to-report-a-problem-with-visual-studio.md)
  - Dodano więcej informacji do NMI
  - Ponowne kolor całej strony Zgłoś problem
- [Pomoc F1 —](./not-in-toc/default.md) refaktoryzacja domyślnej strony pomocy F1
- [AutoOdzyskowanie, Środowisko, Opcje —](./reference/autorecover-environment-options-dialog-box.md) okno dialogowe — dodawanie informacji o zaktualizowanych lokalizacjach automatycznego zapisywanie plików
...
- [Konfigurowanie procesu lokalnego przy użyciu usługi Kubernetes](../containers/configure-bridge-to-kubernetes.md) — proces lokalny przy użyciu usługi Kubernetes: konfiguracja yaml
...
- [Samouczek: rozszerzanie prostej aplikacji konsolowej c#](../get-started/csharp/tutorial-console-part-2.md) — pierwsza wersja samouczka rozszerzania wersji sidewalk
...
- [Aktualizowanie Visual Studio przy użyciu minimalnego układu offline](../install/update-minimal-layout.md) — funkcja minimalnego układu dokumentu
