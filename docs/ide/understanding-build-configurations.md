...
description: Dowiedz się, w jaki sposób konfiguracje kompilacji są potrzebne, gdy zachodzi potrzeba skompilowania projektów przy użyciu różnych ustawień w programie Visual Studio.
