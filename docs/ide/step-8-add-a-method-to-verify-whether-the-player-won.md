---
title: Krok 8. Dodanie metody w celu sprawdzenia, czy gracz wygrał
ms.date: 11/04/2016
ms.topic: tutorial
...
2. Następnie, aby program obsługi zdarzeń <xref:System.Windows.Forms.Control.Click> etykiety wywołał nową metodę `CheckForWinner()`. Pamiętaj, że program sprawdza zwycięzcę natychmiast po pokazaniu drugiej ikony, którą wybierze gracz. Wyszukaj wiersz, w którym ustawisz kolor drugiej wybranej ikony, a następnie Wywołaj metodę `CheckForWinner()` bezpośrednio po tym, jak pokazano w poniższym kodzie.
