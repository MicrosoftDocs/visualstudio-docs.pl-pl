...
|Zawijanie wierszy|Powoduje, że wszystkie wiersze w dokumencie będą widoczne w oknie kodu. Możesz włączyć zawijanie wierszy i włączyć je w oknie Ustawienia **edytora tekstu wszystkie języki** (**Tools**  >  **Opcje**narzędzia  >  **Edytor tekstu**  >  **wszystkie języki**).|
