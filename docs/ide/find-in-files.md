...
description: Dowiedz się więcej o funkcji Znajdź w plikach i sposobach jej użycia do wyszukiwania określonego zestawu plików.
...
1. Na pasku menu wybierz **Edycja**  >  **Znajdź i Zamień**.
