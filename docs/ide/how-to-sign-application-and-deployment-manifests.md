...
description: Informacje o wymaganiach dotyczących podpisywania na potrzeby publikowania aplikacji ClickOnce i manifestów wdrożenia. Podpisywanie jest opcjonalne dla aplikacji opartych na programie. exe.
