...
|![Symbol Union](../ide/media/vxunion_icon.gif)|Union|![Symbol zdarzenia](../ide/media/vxevent_icon.gif)|Zdarzenie|
|![Symbol wyliczenia](../ide/media/vxenum_icon.gif)|Wyliczenie|![Ikona stałej](../ide/media/vxconstant_icon.gif)|Stała|
|![Symbol definicji typu](../ide/media/vxtypedef_icon.gif)|TypeDef|![Symbol wyliczenia elementu](../ide/media/vxenumitem_icon.gif)|Element Enum|
|![Symbol modułu programu Visual Studio](../ide/media/vxmodule_icon.gif)|Module|![Symbol elementu mapy](../ide/media/vxmapitem_icon.gif)|Element mapy|
...
|![Symbol delegata](../ide/media/vxdelegate_icon.gif)|Delegate|![Ikona błędu dla Widok klasy i Przeglądarka obiektów](../ide/media/erroricon.gif)|Błąd|
...
|Ikona|Opis|
|----------|-----------------|
|\<brak ikony sygnału >|Public. Dostępne z dowolnego miejsca w tym składniku i z dowolnego składnika, który odwołuje się do niego.|
...
|![Wewnętrzny symbol&#47;zaprzyjaźniony](../ide/media/vxsignal_icon_diamond.gif)|Zaprzyjaźniony/wewnętrzny. Dostępne tylko z projektu.|
