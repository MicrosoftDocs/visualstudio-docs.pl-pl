...
Aby zainstalować Podgląd pomocy, zobacz [instalacja podglądu pomocy firmy Microsoft](../ide/microsoft-help-viewer-installation.md). Aby rozpocząć odczyt tematów pomocy w Podglądzie pomocy, a nie w trybie online, przejdź do **pomocy** menu w programie Visual Studio, a następnie wybierz **Ustaw preferencje pomocy** > **Uruchom w Podglądzie pomocy** .
...
>
> ![Pobierz plik PDF, aby uzyskać dokumentację programu Visual Studio](media/download-pdf.png)
