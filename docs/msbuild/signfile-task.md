...
description: Dowiedz się, w jaki sposób MSBuild używa zadania SignFile — do podpisywania określonego pliku przy użyciu określonego certyfikatu.
