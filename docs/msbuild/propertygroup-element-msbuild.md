...
description: Dowiedz się więcej o elemencie właściwości programu MSBuild, który zawiera zestaw elementów właściwości zdefiniowanych przez użytkownika.
