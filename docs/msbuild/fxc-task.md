...
description: Dowiedz się więcej na temat parametrów używanych przez zadanie MSBuild FXC na potrzeby kompilatorów modułu cieniującego HLSL w procesie kompilacji.
