...
description: Dowiedz się, jak ustawić wybrane zadania programu MSBuild do uruchomienia w środowisku, które są docelowe, niezależnie od środowiska komputera deweloperskiego.
