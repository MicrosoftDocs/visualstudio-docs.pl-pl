...
description: Dowiedz się, w jaki sposób MSBuild używa elementu import do importowania zawartości jednego pliku projektu do innego pliku projektu.
