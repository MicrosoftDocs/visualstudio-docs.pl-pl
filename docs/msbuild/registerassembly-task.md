...
description: Dowiedz się, w jaki sposób MSBuild używa zadania RegisterAssembly —, aby odczytać metadane w określonym zestawie i dodać niezbędne wpisy do rejestru.
