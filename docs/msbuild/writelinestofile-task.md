...
description: Dowiedz się, w jaki sposób MSBuild używa zadania WriteLinesToFile —, aby zapisać ścieżki określonych elementów do określonego pliku tekstowego.
