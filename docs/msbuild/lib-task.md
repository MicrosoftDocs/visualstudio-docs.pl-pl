...
description: Dowiedz się, w jaki sposób MSBuild używa zadania LIB do oblewania narzędzia Microsoft 32-bit Library Manager, lib.exe, które tworzy bibliotekę plików obiektów COFF i zarządza nią.
...
|**Źródeł**|Wymagany parametr interfejsu `ITaskItem[]`.<br /><br /> Określa listę plików źródłowych rozdzielonych spacjami.|
