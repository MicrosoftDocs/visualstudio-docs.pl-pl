...
|**Źródeł**|Opcjonalny `ITaskItem[]` parametr.<br /><br /> Określa listę plików źródłowych manifestu rozdzielonych spacjami.<br /><br /> Aby uzyskać więcej informacji, zobacz **/manifest** opcji w [Mt.exe](/windows/desktop/SbsCs/mt-exe).|
