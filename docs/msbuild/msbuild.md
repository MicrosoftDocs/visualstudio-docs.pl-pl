...
- Nie zainstalowano programu Visual Studio. ([Pobierz MSBuild bez programu Visual Studio](https://visualstudio.microsoft.com/downloads/?q=build+tools))
