...
description: Utwórz rejestratory przesyłania dalej MSBuild, aby zwiększyć efektywność rejestrowania, umożliwiając wybranie zdarzeń, które mają być monitorowane podczas kompilowania projektów.
