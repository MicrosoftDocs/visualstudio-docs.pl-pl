...
description: Debuguj zainstalowany pakiet aplikacji platforma uniwersalna systemu Windows (platformy UWP) w programie Visual Studio na urządzeniach z systemem Windows 10, Xbox i Internet rzeczy (IoT).
