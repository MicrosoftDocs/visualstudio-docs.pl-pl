...
description: Informacje o oknie rejestrów w programie Visual Studio, które są dostępne tylko wtedy, gdy debugowanie na poziomie adresu jest włączone w oknie dialogowym Opcje, debugowanie węzła.
