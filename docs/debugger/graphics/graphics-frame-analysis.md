...
description: Użyj analiza klatek grafiki w analizator grafiki programu Visual Studio, aby przeanalizować i zoptymalizować wydajność renderowania gry lub aplikacji Direct3D.
