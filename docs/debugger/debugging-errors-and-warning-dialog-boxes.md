...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Okno dialogowe nie informacji o symbolach](https://msdn.microsoft.com/library/18de4888-9cca-4059-a165-48b135fee4c9)  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 [Błędy dołączania](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/8dbb3we5(v=vs.100))  
  
 [Rozwiązywanie problemów z konfiguracji debugowania SQL](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/s7ahaxtd(v=vs.100))  
