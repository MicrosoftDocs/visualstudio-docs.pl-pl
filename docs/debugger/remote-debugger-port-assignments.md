...
::: moniker-end
 ...
 W wierszu polecenia Uruchom zdalny debuger z przełącznikiem **/port** : **msvsmon/port \<numer portu >** .
...
:::moniker-end
 ...
 Ten port można skonfigurować przy użyciu wiersza polecenia: **msvsmon/wow64port \<numer portu >** .
