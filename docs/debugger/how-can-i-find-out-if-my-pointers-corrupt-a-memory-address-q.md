...
- Większość uszkodzeń pamięci jest rzeczywiście z powodu uszkodzenia sterty. Spróbuj użyć Global Flags Utility (gflags.exe) lub pageheap.exe. Zobacz [/Windows-Hardware/Drivers/Debugger/GFlags-and-Pageheap](/windows-hardware/drivers/debugger/gflags-and-pageheap).
