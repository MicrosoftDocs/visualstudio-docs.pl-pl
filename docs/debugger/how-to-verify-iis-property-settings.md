...
5. W przypadku aplikacji serwera ATL upewnij się, że zlecenie debugowania jest skojarzone z rozszerzeniem ISAPI. Aby uzyskać więcej informacji, zobacz [How to: Skojarz CZASOWNIK Debug with Extension](/previous-versions/ms165022(v=vs.100)).
