...
ms.locfileid: "72738569"
---
# <a name="publicsymbol"></a>PublicSymbol
Po utworzeniu pliku. exe każdy symbol publiczny (co najmniej, każda funkcja globalna i symbol danych) otrzymuje tag `SymTagPublicSymbol`.
