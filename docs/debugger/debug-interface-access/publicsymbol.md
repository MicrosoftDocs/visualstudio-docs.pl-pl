---
description: Po utworzeniu pliku. exe każdy symbol publiczny (co najmniej każda funkcja globalna i symbol danych) otrzymuje tag SymTagPublicSymbol.
