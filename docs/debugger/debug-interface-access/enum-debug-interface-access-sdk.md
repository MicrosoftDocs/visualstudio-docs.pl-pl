...
ms.locfileid: "72745231"
---
# <a name="enum-debug-interface-access-sdk"></a>Typ wyliczeniowy (Zestaw SDK dostępu do interfejsu debugowania)
Wyliczenia są identyfikowane przez `SymTagEnum` symbole. Każda wartość wyliczenia jest wyświetlana jako element podrzędny klasy ze znacznikiem `SymTagConstant`.
...
|[IDiaSymbol::get_unalignedType](../../debugger/debug-interface-access/idiasymbol-get-unalignedtype.md)|`BOOL`|`TRUE`, jeśli wyliczenie nie jest wyrównane.|
