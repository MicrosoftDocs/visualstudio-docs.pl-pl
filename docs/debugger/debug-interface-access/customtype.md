...
description: Znajdź informacje referencyjne o typie symbolu CustomType (SymTagCustomType) w zestawie SDK dostępu do interfejsu debugowania programu Visual Studio.
