...
Na stronie   >  **Opcje** narzędzi  >  **debugowania**  >  **symboli** można wykonać następujące instrukcje:
...
1. W programie Visual Studio Otwórz pozycję **Narzędzia**  >  **Opcje**  >  **debugowania**  >  **symbole** (lub opcje **debugowania**  >    >  **symbole**).
...
Możesz wybrać dodatkowe opcje symboli w opcji **Narzędzia**  >    >  **debugowanie**  >  **Ogólne** (lub opcje **debugowania**  >    >  **Ogólne**):
...
1. Aby otworzyć okno **moduły** , podczas debugowania wybierz kolejno opcje **Debuguj**  >  **moduły systemu Windows**  >   (lub naciśnij **klawisze CTRL**  +  **Alt**  +  **U**).
