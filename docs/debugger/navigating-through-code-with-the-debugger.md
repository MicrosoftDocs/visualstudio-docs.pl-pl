...
|**Shift** +**F11**|**Wyjdź**|**Krok** Wyjdź kontynuuje uruchamianie kodu i wstrzymuje wykonywanie, gdy bieżąca funkcja zwraca wartość. Debuger pomija bieżącą funkcję.|
