...
description: Użyj karty okna właściwości systemu Windows, aby wyświetlić informacje o systemie Windows, które są powiązane z wybranym oknem. Zapoznaj się z tym artykułem.
