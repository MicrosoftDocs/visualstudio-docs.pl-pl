...
1. Utwórz nowy projekt biblioteki klas.
    ...
    Na pasku menu u góry wybierz **pliku** > **New** > **projektu**. W lewym okienku okna dialogowego **Nowy projekt** w obszarze **Wizualizacja C#** wybierz **.NET Framework**, a następnie w środkowym okienku wybierz pozycję **Biblioteka klas (.NET Framework)** .
    ::: moniker-end
...
- W `public class DebuggerSide`, Dodaj następujący kod **metody:**
  ...
  `Show` Metoda zawiera kod, który faktycznie tworzy okno dialogowe Wizualizator lub innego interfejsu użytkownika i wyświetla informacje, który został przekazany do wizualizatora z debugera. Należy dodać kod, który tworzy okno dialogowe i wyświetla informacje. W tym instruktażu będziesz to robić przy użyciu okna komunikatu Windows forms. Najpierw należy dodać dyrektywę Reference i `using` dla elementu System. Windows. Forms.
...
1. W Eksplorator rozwiązań kliknij prawym przyciskiem myszy rozwiązanie, wybierz polecenie **Dodaj**, a następnie kliknij pozycję **Nowy projekt**.
    ...
    ::: moniker-end
    ::: moniker range="vs-2017"
    Na pasku menu u góry wybierz **pliku** > **New** > **projektu**. W lewym okienku okna dialogowego **Nowy projekt** w obszarze **Wizualizacja C#** wybierz pozycję **Windows Desktop**, a następnie w środkowym okienku wybierz pozycję **aplikacja konsoli (.NET Framework)** .
    ::: moniker-end
...
2. W oknie dialogowym **Nowy projekt** w obszarze **Wizualizacja C#** wybierz pozycję **.NET Framework**.
