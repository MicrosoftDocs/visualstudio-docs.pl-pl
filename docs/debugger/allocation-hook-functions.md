...
description: Dowiedz się więcej na temat używania funkcji punktu zaczepienia alokacji, które są instalowane przy użyciu _CrtSetAllocHook, gdy zachodzi potrzeba wykonania debugowania środowiska uruchomieniowego C (CRT) w programie Visual Studio.
...
> [!NOTE]
> Należy pamiętać o ograniczeniu użycia funkcji biblioteki wykonawczej języka C w funkcji punktu zaczepienia alokacji, opisanej w obszarze [punkty zaczepienia alokacji i alokacji pamięci w języku C Run-Time](../debugger/allocation-hooks-and-c-run-time-memory-allocations.md).
...
- [Punkty zaczepienia alokacji i alokacje pamięci w języku C Run-Time](../debugger/allocation-hooks-and-c-run-time-memory-allocations.md)
