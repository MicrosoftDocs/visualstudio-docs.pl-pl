...
Mimo że C#aplikacja demonstracyjna jest Visual Basic, większość funkcji ma zastosowanie do języków, C++, F#, Python, JavaScript i innych obsługiwanych przez program Visual Studio (F# nie obsługuje funkcji Edit-and-Continue. F#i język JavaScript nie obsługuje okna **autostarts** ). Zrzuty ekranu znajdują się w Visual Basic.
