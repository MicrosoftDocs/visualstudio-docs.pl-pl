...
1. Utwórz projekt szablonu projektu. Można znaleźć szablonu projektu w **nowy projekt** okno dialogowe Wyszukiwanie "szablon projektu", a następnie wybierając opcję C# lub wersji programu Visual Basic.
