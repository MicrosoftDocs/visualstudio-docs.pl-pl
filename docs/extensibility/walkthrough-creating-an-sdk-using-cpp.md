...
2. Na liście szablonów rozwiń węzeł rozszerzalność **języka Visual C#**  >  **Extensibility**, a następnie wybierz pozycję **Projekt VSIX**. W polu **Nazwa** Określ **NativeMathVSIX**, a następnie wybierz przycisk **OK** .
