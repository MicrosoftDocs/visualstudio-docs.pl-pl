...
Możesz dowiedzieć się więcej w [jak: Migrowanie rozszerzalności projektów programu Visual Studio 2017](how-to-migrate-extensibility-projects-to-visual-studio-2017.md). Ponadto jest świetnym wpisie na blogu, [zmieni się na instalację programu Visual Studio](https://blogs.msdn.microsoft.com/heaths/2016/09/15/changes-to-visual-studio-15-setup).
