...
## <a name="language-services-and-the-core-editor"></a>Usługi języka oraz podstawowy edytor
 ...
 ![Grafika przedstawiająca usługi Model języka](../extensibility/media/vslanguageservicemodel.gif "vsLanguageServiceModel") podstawowych obiektów usługi Edytor i język
