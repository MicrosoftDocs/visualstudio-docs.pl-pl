---
title: IDebugDocumentContext2::EnumCodeContexts | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Kontekst pojedynczego dokumentu może generować wiele kontekstów kodu, gdy dokument używa szablonów lub zawiera pliki.
