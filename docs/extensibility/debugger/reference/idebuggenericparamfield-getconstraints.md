---
description: Pobiera ograniczenia, które są skojarzone z tym parametrem ogólnym.
...
ms.locfileid: "102172789"
---
# <a name="idebuggenericparamfieldgetconstraints"></a>IDebugGenericParamField::GetConstraints
Pobiera ograniczenia, które są skojarzone z tym parametrem ogólnym.
...
`cConstraints`\
podczas Liczba ograniczeń.

`ppConstraints`\
określoną Zwraca tablicę zawierającą ograniczenia skojarzone z tym polem.

`pcConstraints`\
[in. out] Liczba ograniczeń w `ppConstraints` tablicy.
