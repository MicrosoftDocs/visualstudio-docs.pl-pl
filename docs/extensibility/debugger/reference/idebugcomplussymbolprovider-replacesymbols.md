---
title: IDebugComPlusSymbolProvider::ReplaceSymbols | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
- ReplaceSymbols
...
Zastępuje bieżące symbole debugowania symbolami w określonym strumieniu danych.
...
`pStream`\
[w] Strumień danych zawierający nowe symbole.
