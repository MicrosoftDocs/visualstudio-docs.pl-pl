...
## <a name="members"></a>Elementy członkowskie
 REF_COMPARE_EQUAL określa porównanie równości.

 REF_COMPARE_LESS_THAN określa mniej-niż porównania.

 REF_COMPARE_GREATER_THAN określa większą-niż porównania.
