...
`guidVendor` Identyfikator GUID dostawcy. Może być wartością null.

`bstrConstraint` Nazwa ograniczenia punktu przerwania. Może być wartością null.

`bstrTracepoint` Nazwa punktu śledzenia. Może być wartością null.
