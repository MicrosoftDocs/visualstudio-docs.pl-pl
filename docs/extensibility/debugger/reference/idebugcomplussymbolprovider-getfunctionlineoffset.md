---
title: IDebugComPlusSymbolProvider::GetFunctionLineOffset | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
Pobiera adres w ramach funkcji, która reprezentuje danego odsunięcia wiersza.
...
`pAddress`\
[w] Adres, który reprezentuje funkcję.

`dwLine`\
[w] Przesunięcie linii od początku funkcji.

`ppNewAddress`\
[na zewnątrz] Nowy adres reprezentujący przesunięcie wiersza od początku funkcji.
