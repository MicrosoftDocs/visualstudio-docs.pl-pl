---
description: Pobiera adres w ramach funkcji, która reprezentuje podane przesunięcie wiersza.
...
`pAddress`\
podczas Adres reprezentujący funkcję.

`dwLine`\
podczas Przesunięcie wiersza od początku funkcji.

`ppNewAddress`\
określoną Nowy adres reprezentujący przesunięcie linii od początku funkcji.
