---
title: IDebugBoundBreakpoint2::Włącz | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`fEnable`\
[w] Ustaw na niezerowy (`TRUE`), aby`FALSE`włączyć lub zero ( ), aby wyłączyć punkt przerwania.
