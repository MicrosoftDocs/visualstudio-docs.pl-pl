---
description: Włącza lub wyłącza punkt przerwania.
...
`fEnable`\
podczas Ustaw wartość różną od zera ( `TRUE` ), aby włączyć lub zero ( `FALSE` ), aby wyłączyć punkt przerwania.
