---
title: IEnumDebugCodeContexts2::Dalej | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[w, na zewnątrz] Tablica elementów [IDebugCodeContext2](../../../extensibility/debugger/reference/idebugcodecontext2.md) do wypełnienia.
