---
description: Wylicza wszystkie punkty przerwania powiązane z tym oczekującym punktem przerwania.
...
ms.locfileid: "105072705"
---
# <a name="idebugpendingbreakpoint2enumboundbreakpoints"></a>IDebugPendingBreakpoint2::EnumBoundBreakpoints
Wylicza wszystkie punkty przerwania powiązane z tym oczekującym punktem przerwania.
...
`ppEnum`\
określoną Zwraca obiekt [IEnumDebugBoundBreakpoints2](../../../extensibility/debugger/reference/ienumdebugboundbreakpoints2.md) , który wylicza powiązane punkty przerwania.
