---
description: Pobiera do typu symbolu z uwzględnieniem jego adresu debugowania.
...
`ppField`\
określoną Zwraca typ tablicy, ponieważ jest reprezentowany przez interfejs [IDebugClassField](../../../extensibility/debugger/reference/idebugclassfield.md) .
