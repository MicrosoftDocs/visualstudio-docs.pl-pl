---
title: IDebugComPlusSymbolProvider::GetTypeFromAddress | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`ppField`\
[na zewnątrz] Zwraca typ tablicy, ponieważ jest reprezentowany przez interfejs [IDebugClassField.](../../../extensibility/debugger/reference/idebugclassfield.md)
