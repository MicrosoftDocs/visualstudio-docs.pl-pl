---
description: Ten interfejs jest wysyłany przez aparat debugowania (Anuluj) do Menedżera debugowania sesji (SDM), gdy wątek jest uruchomiony do ukończenia.
