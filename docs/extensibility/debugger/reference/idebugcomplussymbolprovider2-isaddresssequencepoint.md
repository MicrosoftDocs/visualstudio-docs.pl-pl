---
title: IDebugComPlusSymbolProvider2::IsAddressSequencePoint | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
Jeśli adres debugowania jest punktem sekwencji, zwraca ; `S_OK` w przeciwnym `S_FALSE`razie zwraca plik .
