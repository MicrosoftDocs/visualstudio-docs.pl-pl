---
description: Określa, czy określony adres debugowania jest punktem sekwencji.
...
Jeśli adres debugowania jest punktem sekwencji, zwraca `S_OK` ; w przeciwnym razie zwraca `S_FALSE` .
