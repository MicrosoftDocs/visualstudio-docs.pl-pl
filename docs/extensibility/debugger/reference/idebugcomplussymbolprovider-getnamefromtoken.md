---
title: IDebugComPlusSymbolProvider::GetNameFromToken | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
Zwraca nazwę skojarzoną z określonym tokenem, biorąc pod uwagę jego obiekt metadanych.
...
`pMetadataImport`\
[w] Obiekt zawierający informacje o metadanych.

`dwToken`\
[w] Token do nazwy.

`pbstrName`\
[na zewnątrz] Nazwa, która odpowiada tokenowi.
