---
description: Zwraca następny zestaw DEBUG_PROPERTY_INFO elementów z wyliczenia.
...
`rgelt`\
[in. out] Tablica elementów [DEBUG_PROPERTY_INFO](../../../extensibility/debugger/reference/debug-property-info.md) do wypełnienia.
