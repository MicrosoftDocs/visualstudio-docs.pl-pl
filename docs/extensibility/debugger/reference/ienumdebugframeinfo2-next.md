---
description: Zwraca następny zestaw elementów z wyliczenia FRAMEINFO.
...
`rgelt`\
[in. out] Tablica elementów [FRAMEINFO](../../../extensibility/debugger/reference/frameinfo.md) do wypełnienia.
