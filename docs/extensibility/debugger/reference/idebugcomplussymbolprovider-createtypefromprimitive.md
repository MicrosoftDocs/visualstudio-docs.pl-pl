---
title: IDebugComPlusSymbolProvider::CreateTypeFromPrimitive | Dokumenty firmy Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`ppType`\
[w] Zwraca obiekt [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) opisujący typ.
