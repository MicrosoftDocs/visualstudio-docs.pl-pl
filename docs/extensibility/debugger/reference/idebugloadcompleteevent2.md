---
description: Ten interfejs jest wysyłany przez aparat debugowania (poza) do Menedżera debugowania sesji (SDM) podczas ładowania programu, ale przed wykonaniem dowolnego kodu.
