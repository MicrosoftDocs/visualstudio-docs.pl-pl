...
description: Dowiedz się, w jaki sposób program Visual Studio implementuje usługę do kolorowania składni w starszej wersji usługi językowej, aby identyfikować elementy języka i wyświetlać je w kolorach w edytorze.
