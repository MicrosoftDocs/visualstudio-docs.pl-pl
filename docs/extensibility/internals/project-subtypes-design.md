...
![Grafika przedstawiająca wielopoziomowej projectflavor Visual Studio](../../extensibility/internals/media/vs_multilevelprojectflavor.gif)
...
![Automatyczne rozszerzanie podtypu projektu VS (grafika)](../../extensibility/internals/media/vs_projectflavorautoextender.gif)
