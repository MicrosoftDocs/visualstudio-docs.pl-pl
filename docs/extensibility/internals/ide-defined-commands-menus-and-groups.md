...
ms.locfileid: "72727295"
---
# <a name="ide-defined-commands-menus-and-groups"></a>Polecenia, menu i grupy definiowane w środowisku IDE
Wiele menu, poleceń i grup poleceń jest już zdefiniowanych do użycia przez [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] IDE. Te polecenia są również dostępne do użycia podczas rozszerzając [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)].
...
- ShellCmdPlace. vsct
  ...
  Te pliki znajdują się w *ścieżce instalacji zestawu SDK programu \<Visual Studio >* \VisualStudioIntegration\Common\Inc \\. Pliki te zawierają definicje i identyfikatory GUID menu i grup, których można użyć w pliku konfiguracji tabeli poleceń (. vsct) pakietu VSPackage jako kontenery dla własnych menu, grup i poleceń.
