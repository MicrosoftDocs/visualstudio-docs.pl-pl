...
## <a name="command-menu-access"></a>Dostęp do menu poleceń
 Następująca [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] ścieżka menu zintegrowanego środowiska deweloperskiego jest używana w przypadku testowym.
