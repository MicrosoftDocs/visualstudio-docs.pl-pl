...
layout: HubPage
hide_bc: true
title: Produkty Visual Studio | Microsoft Docs
description: Zapoznaj się z rodziną produktów Visual Studio.
ms.topic: hub-page
ms.date: 07/02/2019
searchScope: []
                ...
                <ul id="products">
                    <li>
                        ...
                        <ul id="products1" class="cardsC cols cols3">
                            <li>
                                <a href="/visualstudio/" title="Program Visual Studio">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Twórz aplikacje i gry przy użyciu systemu Windows, aby dotarcie do każdego urządzenia z systemami Android, iOS, Windows, Web lub Cloud.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Opracowywanie aplikacji i gier dla systemów iOS, Android, Desktop i sieci Web przy użyciu platformy .NET.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bogate edytowanie i debugowanie w setkach języków w systemach MacOS, Linux i Windows</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ciągła integracja, dostarczanie i uczenie aplikacji dla systemów Android, iOS, macOS i Windows. Szybsze dostarczanie 5-gwiazdek aplikacji o wyższej jakości.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Narzędzia programistyczne, usługi w chmurze, szkolenia i pomoc techniczna w jednym miejscu.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
