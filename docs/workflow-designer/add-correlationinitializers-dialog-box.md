...
description: Dowiedz się, jak za pomocą okna dialogowego Dodawanie inicjatora korelacji skonfigurować właściwości CorrelationInitializers działań typu wysyłanie, odbieranie i działanie SendReply.
