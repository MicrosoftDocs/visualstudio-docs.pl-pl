...
description: Dowiedz się, jak za pomocą narzędzia Switch <T> Activity Designer utworzyć i skonfigurować <T> działanie switch w Projektant przepływu pracy.
