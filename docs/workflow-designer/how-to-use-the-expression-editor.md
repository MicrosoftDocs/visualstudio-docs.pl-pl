...
description: Dowiedz się, jak Edytor wyrażeń jest formantem Projektant przepływu pracy, którego można użyć w wielu działaniach przepływu pracy do wprowadzania i szacowania wyrażeń.
