---
title: AddToCollection &lt; T, &gt; Projektant działań
description: Dowiedz się, <T> w jaki sposób Projektant działań AddToCollection służy do tworzenia i konfigurowania <T> działania AddToCollection w Projektant przepływu pracy.
