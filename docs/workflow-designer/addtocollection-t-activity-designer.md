...
description: Dowiedz się, w jaki sposób <T> Projektant działań AddToCollection służy do tworzenia i konfigurowania <T> działania AddToCollection.
