---
title: Nie można utworzyć skojarzenia — właściwość jest wymieniona dwukrotnie
ms.date: 11/04/2016
ms.topic: reference
...
Właściwości w komunikacie zostanie wyświetlone więcej niż jeden raz w nadrzędnej lub podrzędnej klasy **właściwości skojarzenia**.
...
- [Instrukcje: Tworzenie skojarzenia między LINQ to SQL klas (Projektant O/R)](../data-tools/how-to-create-an-association-relationship-between-linq-to-sql-classes-o-r-designer.md)