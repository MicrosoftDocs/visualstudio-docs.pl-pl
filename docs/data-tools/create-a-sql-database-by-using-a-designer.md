...
4. Kliknij prawym przyciskiem myszy wiersz `CustomerID`, a następnie wybierz pozycję **Ustaw klucz podstawowy**.

5. Kliknij prawym przyciskiem myszy wiersz domyślny (`Id`), a następnie wybierz pozycję **Usuń**.
