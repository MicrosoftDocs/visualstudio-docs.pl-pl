...
description: W tym instruktażu Utwórz element DataTable (bez TableAdapter) przy użyciu Projektant obiektów Dataset. Utwórz nową aplikację Windows Forms i Dodaj do niej nowy zestaw danych.
