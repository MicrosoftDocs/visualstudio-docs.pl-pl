...
ms.locfileid: "87805852"
---
## <a name="azure-development-build-tools"></a>Narzędzia do tworzenia kompilacji na platformie Azure

**Identyfikator:** Microsoft. VisualStudio. obciążeni. AzureBuildTools

**Opis:** Zadania i elementy docelowe programu MSBuild służące do kompilowania aplikacji platformy Azure.
...
Microsoft. NET. Core. Component. SDK. 2.1 | Środowisko uruchomieniowe programu .NET Core 2,1 (LTS) | 16.7.30310.162 | Opcjonalne
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. DataBuildTools

**Opis:** Kompiluj SQL Server projekty bazy danych
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. ManagedDesktopBuildTools

**Opis:** Narzędzia do kompilowania aplikacji WPF, Windows Forms i konsolowych przy użyciu języków C#, Visual Basic i F #.
...
Microsoft.Net. Component. 4,7. DeveloperTools | Narzędzia programistyczne .NET Framework 4,7 | 16.3.29207.166 | Opcjonalne
Microsoft.Net. Component. 4.8. DeveloperTools | Narzędzia programistyczne .NET Framework 4,8 | 16.4.29318.151 | Opcjonalne
Microsoft. VisualStudio. Component. FSharp. MSBuild | kompilator F# | 16.0.28528.71 | Opcjonalne

## <a name="msbuild-tools"></a>Narzędzia MSBuild

**Identyfikator:** Microsoft. VisualStudio. obciążeni. MSBuildTools

**Opis:** Zapewnia narzędzia wymagane do kompilowania aplikacji opartych na programie MSBuild.
...
--- | --- | --- | ---
Microsoft. Component. MSBuild | MSBuild | 16.5.29515.121 | Wymagane
Microsoft. VisualStudio. Component. CoreBuildTools | Visual Studio Build Tools rdzeń | 16.7.30310.162 | Wymagane
Microsoft. VisualStudio. Component. Roslyn. kompilator | Kompilatory języka C# i Visual Basic Roslyn | 16.0.28714.129 | Wymagane

## <a name="net-core-build-tools"></a>Narzędzia kompilacji platformy .NET Core

**Identyfikator:** Microsoft. VisualStudio. obciążeni. NetCoreBuildTools

**Opis:** Narzędzia do kompilowania aplikacji przy użyciu programu .NET Core, ASP.NET Core, HTML/JavaScript i kontenerów.
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. NodeBuildTools

**Opis:** Zadania i elementy docelowe programu MSBuild służące do tworzenia skalowalnych aplikacji sieciowych przy użyciu Node.js, asynchronicznego środowiska uruchomieniowego JavaScript opartego na zdarzeniach.
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. OfficeBuildTools

**Opis:** Tworzenie dodatków pakietu Office i programu SharePoint oraz dodatków narzędzi VSTO.

### <a name="components-included-by-this-workload"></a>Składniki zawarte w tym obciążeniu

Identyfikator składnika | Nazwa | Wersja | Typ zależności
--- | --- | --- | ---
Microsoft. Component. ClickOnce. MSBuild | Narzędzia do kompilacji ClickOnce | 16.0.28625.61 | Wymagane
Microsoft. Component. MSBuild | MSBuild | 16.5.29515.121 | Wymagane
...
## <a name="universal-windows-platform-build-tools"></a>Narzędzia kompilacji platforma uniwersalna systemu Windows

**Identyfikator:** Microsoft. VisualStudio. obciążeni. UniversalBuildTools

**Opis:** Zapewnia narzędzia wymagane do kompilowania aplikacji platforma uniwersalna systemu Windows.
...
Microsoft. VisualStudio. Component. VC. najnowsze 141. ARM | MSVC najnowsze 141-VS 2017 C++ ARM Build Tools (v 14.16) | 16.7.30310.162 | Opcjonalne
...
Microsoft. VisualStudio. Component. platformy UWP. VC. BuildTools | C++ (v142) — narzędzia platforma uniwersalna systemu Windows | 16.3.29207.166 | Opcjonalne
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. VCTools
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. VisualStudioExtensionBuildTools
...
Microsoft. VisualStudio. Component. NuGet. BuildTools | Cele i zadania kompilacji NuGet | 16.1.28829.92 | Wymagane
Microsoft. VisualStudio. Component. Roslyn. kompilator | Kompilatory języka C# i Visual Basic Roslyn | 16.0.28714.129 | Wymagane
Microsoft. VisualStudio. Component. VSSDKBuildTools | Podstawowe narzędzia kompilacji zestawu SDK programu Visual Studio | 16.0.28315.86 | Wymagane
Microsoft. VisualStudio. Components. VisualStudioExtensionBuildTools. Pres | Wymagania wstępne dotyczące programowania rozszerzeń programu Visual Studio | 16.4.29318.151 | Wymagane
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. WebBuildTools

**Opis:** Zadania i elementy docelowe programu MSBuild służące do tworzenia aplikacji sieci Web.
...
**Identyfikator:** Microsoft. VisualStudio. obciążeni. XamarinBuildTools

**Opis:** Narzędzia do tworzenia aplikacji międzyplatformowych dla systemów iOS, Android i Windows przy użyciu języków C# i F #.
...
Microsoft. VisualStudio. Component. VC. 14.22. CLI. Support | Obsługa języka C++/CLI dla narzędzi kompilacji v142 (14,22) | 16.7.30310.162
...
Microsoft. VisualStudio. Component. VC. 14.23. CLI. Support | Obsługa języka C++/CLI dla narzędzi kompilacji v142 (14,23) | 16.7.30310.162
...
Microsoft. VisualStudio. Component. VC. 14.24. CLI. Support | Obsługa języka C++/CLI dla narzędzi kompilacji v142 (14,24) | 16.7.30310.162
...
Microsoft. VisualStudio. Component. VC. 14.25. ARM. Spectre | MSVC v142-VS 2019 C++ ARM Spectre-libs (v 14.25) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ARM64 | MSVC v142-VS 2019 C++ ARM64 Build Tools (v 14.25) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ARM64. Spectre | MSVC v142-VS 2019 C++ ARM64 Spectre — skorygowane libs (v 14.25) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ATL | C++ v 14.25 ATL dla narzędzi kompilacji v142 (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ATL. ARM | C++ v 14.25 ATL dla narzędzi kompilacji v142 (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ATL. ARM. Spectre | C++ v 14.25 ATL dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ATL. ARM64 | C++ v 14.25 ATL dla narzędzi kompilacji v142 (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ATL. ARM64. Spectre | C++ v 14.25 ATL dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. ATL. Spectre | C++ v 14.25 ATL dla narzędzi kompilacji v142 z ograniczeniami Spectre (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. CLI. Support | Obsługa języka C++/CLI dla narzędzi kompilacji v142 (14,25) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. MFC | C++ v 14.25 MFC for v142 Build Tools (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. MFC. ARM | C++ v 14.25 MFC for v142 Build Tools (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. MFC. ARM. Spectre | C++ v 14.25 MFC dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. MFC. ARM64 | C++ v 14.25 MFC for v142 Build Tools (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. MFC. ARM64. Spectre | C++ v 14.25 MFC dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. MFC. Spectre | C++ v 14.25 MFC dla narzędzi kompilacji v142 z ograniczeniami Spectre (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. x86. x64 | MSVC v142-VS 2019 C++ x64/x86 Build Tools (v 14.25) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.25. x86. x64. Spectre | MSVC v142-VS 2019 C++ x64/x86 Spectre-łagodzeni libs (v 14.25) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ARM | MSVC v142-VS 2019 C++ ARM Build Tools (v 14.26) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ARM. Spectre | MSVC v142-VS 2019 C++ ARM Spectre-libs (v 14.26) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ARM64 | MSVC v142-VS 2019 C++ ARM64 Build Tools (v 14.26) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ARM64. Spectre | MSVC v142-VS 2019 C++ ARM64 Spectre — skorygowane libs (v 14.26) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ATL | C++ v 14.26 ATL dla narzędzi kompilacji v142 (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ATL. ARM | C++ v 14.26 ATL dla narzędzi kompilacji v142 (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ATL. ARM. Spectre | C++ v 14.26 ATL dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ATL. ARM64 | C++ v 14.26 ATL dla narzędzi kompilacji v142 (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ATL. ARM64. Spectre | C++ v 14.26 ATL dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. ATL. Spectre | C++ v 14.26 ATL dla narzędzi kompilacji v142 z ograniczeniami Spectre (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. CLI. Support | Obsługa języka C++/CLI dla narzędzi kompilacji v142 (14,26) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. MFC | C++ v 14.26 MFC for v142 Build Tools (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. MFC. ARM | C++ v 14.26 MFC for v142 Build Tools (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. MFC. ARM. Spectre | C++ v 14.26 MFC dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. MFC. ARM64 | C++ v 14.26 MFC for v142 Build Tools (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. MFC. ARM64. Spectre | C++ v 14.26 MFC dla narzędzi kompilacji v142 z ograniczeniami Spectre (ARM64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. MFC. Spectre | C++ v 14.26 MFC dla narzędzi kompilacji v142 z ograniczeniami Spectre (x86 & x64) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. x86. x64 | MSVC v142-VS 2019 C++ x64/x86 Build Tools (v 14.26) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. 14.26. x86. x64. Spectre | MSVC v142-VS 2019 C++ x64/x86 Spectre-łagodzeni libs (v 14.26) | 16.7.30310.162
...
Microsoft. VisualStudio. Component. VC. Runtimes. ARM. Spectre | MSVC v142-VS 2019 C++ ARM Spectre-libs (v 14.27) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. Runtimes. ARM64. Spectre | MSVC v142-VS 2019 C++ ARM64 Spectre — skorygowane libs (v 14.27) | 16.7.30310.162
Microsoft. VisualStudio. Component. VC. Runtimes. x86. x64. Spectre | MSVC v142-VS 2019 C++ x64/x86 Spectre-łagodzeni libs (v 14.27)  | 16.7.30310.162
