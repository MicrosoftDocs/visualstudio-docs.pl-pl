...
titleSuffix: ''
description: Więcej informacji, sposobu eksportowania konfiguracji instalacji do pliku .vsconfig udostępnianie innym osobom i zaimportować go do klonowania.
ms.date: 05/18/2019
ms.topic: conceptual
f1_keywords:
- vs.about
