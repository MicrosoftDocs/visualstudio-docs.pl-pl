...
* **[Korzystanie z programu Visual Studio i usług platformy Azure](#use-visual-studio-and-azure-services)** : Ta tabela zawiera adresy URL domeny, które mają zostać dodane do listy dozwolonych i portów i protokołów do otwarcia, aby mieć dostęp do wszystkich żądanych funkcji i usług.
...
| Usługi pakietu | [account].visualstudio.com <br/> [konto]. \*. visualstudio.com <br/> \*.blob.core.windows.net <br/> registry.npmjs.org </br> nodejs.org <br/> dist.nuget.org <br/> nuget.org | Protokół HTTPS | 443 | Npmjs.org, \*. NuGet.org i \*. NodeJS.org są wymagane tylko dla niektórych scenariuszy zadań kompilacji (na przykład: \* Instalator narzędzia NuGet, instalator narzędzia węzła, lub jeśli zamierzasz używać publicznych pakietów przesyłanych ze źródłami danych. Trzy domeny są wymagane do podstawowych funkcji tworzenia pakietów usługi. |
| Usługom DevOps platformy Azure | \*. vsassets.io <br/> static2.sharepointonline.com <br/> dev.azure.com | | | Używane do łączenia się z usługami DevOps platformy Azure |
| | | | | |
