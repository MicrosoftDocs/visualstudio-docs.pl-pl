...
> [!IMPORTANT]
> Masz problem z instalacją? Możemy pomóc. Oferujemy opcję obsługi [**czatu instalacyjnego**](https://visualstudio.microsoft.com/vs/support/#talktous) (tylko w języku angielskim).
