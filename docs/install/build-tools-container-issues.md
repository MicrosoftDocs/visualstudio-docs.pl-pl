...
Aby potwierdzić problem z miejscem na dysku, sprawdź pliki dziennika, aby uzyskać więcej informacji. Jeśli zabraknie miejsca na dysku, plik `vslogs\dd_setup_<timestamp>_errors.log` będzie zawierać następujące elementy: 
```
