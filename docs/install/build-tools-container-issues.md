...
* W starszych wersjach Docker for Windows domyślny rozmiar obrazu kontenera jest tylko 20 GB i nie będzie pasował do narzędzi kompilacji. Postępuj zgodnie [z instrukcjami, aby zmienić rozmiar obrazu](https://docs.microsoft.com/virtualization/windowscontainers/manage-containers/container-storage#storage-limits) na 127 GB lub więcej.
