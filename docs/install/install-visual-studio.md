...
::: moniker range="vs-2017"
  ...
  ![Visual Studio 2017 — instalowanie pakietów językowych](media/vs-installer-installing-language-packs.png "Instalowanie Visual Studio językowych")

::: moniker-end

::: moniker range=">=vs-2019"

  ![Visual Studio 2019 — instalowanie pakietów językowych](media/vs-2019/vs-installer-language-packs.png "Instalowanie Visual Studio językowych")
...
**Nowość w programie 15.7:** teraz można zmniejszyć rozmiar instalacji Visual Studio na dysku systemowym. Możesz przenieść pamięć podręczną pobierania, składniki udostępnione, zestawy SDK i narzędzia na różne dyski i zachować Visual Studio na dysku, na który jest uruchamiany najszybszy.
...
Możesz zmniejszyć rozmiar instalacji Visual Studio na dysku systemowym. Możesz przenieść pamięć podręczną pobierania, składniki udostępnione, zestawy SDK i narzędzia na różne dyski i zachować Visual Studio na dysku, na który jest uruchamiany najszybszy.
...
> [!IMPORTANT]
> Inny dysk można wybrać tylko podczas pierwszej instalacji Visual Studio. Jeśli dysk został już zainstalowany i chcesz zmienić dyski, musisz odinstalować Visual Studio a następnie zainstalować go ponownie.

Aby uzyskać więcej informacji, zobacz [stronę Wybieranie lokalizacji](change-installation-locations.md) instalacji.

## <a name="step-8---start-developing"></a>Krok 8. Rozpoczynanie tworzenia aplikacji
...
3. Wybierz typ projektu.
   ...
   Aby na przykład skompilować aplikację w języku [C++,](/cpp/get-started/tutorial-console-cpp)wybierz pozycję **Zainstalowane,** rozwiń pozycję **Visual C++**, a następnie wybierz typ projektu C++, który chcesz skompilować.

   Aby [skompilować aplikację w](../get-started/csharp/tutorial-console.md)języku C#, wybierz pozycję Zainstalowane, rozwiń pozycję Visual  **C#,** a następnie wybierz typ projektu języka C#, który chcesz skompilować.
