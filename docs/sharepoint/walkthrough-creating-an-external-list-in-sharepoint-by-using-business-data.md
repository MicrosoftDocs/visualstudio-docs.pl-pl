...
4. W **Eksplorator rozwiązań** Otwórz menu skrótów dla *jednostki Entity1. vb* (w Visual Basic) lub *jednostki Entity1. cs* (w języku C#), a następnie wybierz polecenie **Usuń**.
