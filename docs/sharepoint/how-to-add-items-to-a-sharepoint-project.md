...
4. Na liście **zainstalowane szablony** rozwiń węzeł **SharePoint** , a następnie wybierz węzeł **2010** .

5. Na liście szablonów elementów projektu wybierz szablon.

6. W polu tekstowym **Nazwa** wprowadź nazwę, a następnie wybierz przycisk **OK** .
