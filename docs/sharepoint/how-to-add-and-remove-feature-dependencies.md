...
description: Zapoznaj się z tematem Dodawanie i usuwanie zależności funkcji do rozwiązania programu SharePoint za pomocą projektanta funkcji w programie Visual Studio.
