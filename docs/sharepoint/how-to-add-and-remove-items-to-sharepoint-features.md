...
description: Ręczne dodawanie i usuwanie elementów projektu programu SharePoint do funkcji programu SharePoint przy użyciu projektanta funkcji w programie Visual Studio.
