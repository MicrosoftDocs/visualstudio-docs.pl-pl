...
| pliki *. cs* lub *. vb* | Te pliki kodu definiują zachowanie dostosowań programu SharePoint z modelem programowania, do którego można uzyskać dostęp C# za pomocą kodu Visual lub Visual Basic, takich jak strony aplikacji, składniki Web Part i przepływy pracy. |
