...
-   [Instrukcje: Dodawanie okienek akcji do dokumentów programu Word i skoroszytów programu Excel](../vsto/how-to-add-an-actions-pane-to-word-documents-or-excel-workbooks.md).
...
-   [Instrukcje: Programowe sortowanie danych w arkuszach](../vsto/how-to-programmatically-sort-data-in-worksheets.md).
...
-   [Instrukcje: Buforowanie danych w dokumentach zabezpieczonych hasłem](../vsto/how-to-cache-data-in-a-password-protected-document.md).
...
-   [Instrukcje: Publikowanie rozwiązań Office poziomu dokumentu na serwerze programu SharePoint przy użyciu technologii ClickOnce](https://msdn.microsoft.com/2408e809-fb78-42a1-9152-00afa1522e58).

-   [Instrukcje: Zainstalować rozwiązanie ClickOnce Office](https://msdn.microsoft.com/14702f48-9161-4190-994c-78211fe18065).

-   [Instrukcje: Instalowanie wymagań wstępnych na komputerach użytkowników końcowych do uruchamiania rozwiązań pakietu Office](https://msdn.microsoft.com/74dd2c52-838f-4abf-b2b4-4d7b0c2a0a98).

-   [Instrukcje: Przygotowanie usług IIS do wdrożenia rozwiązań dla pakietu Office](https://msdn.microsoft.com/f62bce70-81d4-4f8b-86e6-2f2afec5d9b4).

-   [Instrukcje: Aktualizacja wdrożony rozwiązań pakietu Office](https://msdn.microsoft.com/be96db53-b6ea-46ab-b8d9-b76b098b3b13).

-   [Instrukcje: Zmień ścieżkę instalacji rozwiązania do pakietu Office](https://msdn.microsoft.com/d0eaa07b-2d72-4902-899f-2f9fb165b8fd).
