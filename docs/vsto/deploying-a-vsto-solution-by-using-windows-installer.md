---
title: Wdrażanie Visual Studio Tools dla rozwiązania pakietu Office przy użyciu Instalator Windows
ms.date: 08/18/2010
ms.topic: conceptual
dev_langs:
- VB
...
---
# <a name="deploying-a-visual-studio-tools-for-office-solution-using-windows-installer"></a>Wdrażanie Visual Studio Tools dla rozwiązania pakietu Office przy użyciu Instalator Windows
...
11. W oknie **CustomActionData** **Właściwości** CustomActionData wprowadź lokalizację biblioteki DLL dostosowania, manifest wdrożenia i lokalizację dokumentu Microsoft Office. Wymagany jest również SolutionID.
