...
## <a name="Adding"></a>Dodawanie regionu formularza programu Outlook do projektu
...
### <a name="CreatingFormRegion"></a>Tworzenie nowego regionu formularza przy użyciu kreatora
...
|Zastępc|Dodaje region formularza jako nową stronę zastępującą domyślną stronę formularza programu Outlook.|
|Zamień wszystko|Zamienia cały formularz programu Outlook na region formularza.|

 Można również użyć kreatora, aby określić warunki wyświetlania i wybrać typ formularza do rozszerania. Aby uzyskać więcej informacji, zobacz [jak: Dodaj region formularza do projektu](../vsto/how-to-add-a-form-region-to-an-outlook-add-in-project.md)dodatku programu Outlook.

 Wybór dokonany w Kreatorze ma wpływ na opcje dostępne na innych stronach kreatora. Na przykład jeśli wybierzesz **sąsiadujące** lub **oddziel** na stronie **Utwórz nowy region formularza programu Outlook** , pola **tytuł** i **Opis** są niedostępne w **tekście opisowym i wybierasz ekran Strona preferencji** . Jest to spowodowane tym, że program Outlook nie używa tych pól, gdy wyświetla sąsiedni lub oddzielony region formularza.
...
#### <a name="form-region-factory-class"></a>Klasa fabryki regionów formularza
 ...
 Większość klas fabryk regionów formularza jest zaimplementowana w pliku projektanta regionów formularza. Jednak program obsługi zdarzeń jest uwidoczniony w pliku kodu regionu formularza. `FormRegionInitializing` Możesz użyć tego programu obsługi zdarzeń, aby określić, czy program Outlook powinien wyświetlać region formularza. Aby uzyskać więcej informacji, zobacz [Obsługa zdarzeń regionów formularza](#HandlingFormRegionEvents).
...
### <a name="AddingExistingFormRegion"></a>Dodawanie istniejącego regionu formularza do projektu
 ...
 Istniejący region formularza musi mieć plik kodu ( *. vb* lub *. cs*); nie można dodać plików magazynu formularzy programu Outlook (*OFS*) za pomocą okna dialogowego **Dodaj istniejący element** . Można jednak utworzyć nowy region formularza przez zaimportowanie pliku magazynu formularza programu Outlook. Aby uzyskać więcej informacji, zobacz [jak: Dodaj region formularza do projektu](../vsto/how-to-add-a-form-region-to-an-outlook-add-in-project.md)dodatku programu Outlook.

## <a name="UsingFormRegionDesigner"></a>Korzystanie z projektanta regionów formularza
...
## <a name="UsingFormRegionDesignedOutlook"></a>Importowanie regionu formularza zaprojektowanego w programie Outlook
 ...
 Aby obsłużyć zdarzenia C# w projekcie, Subskrybuj zdarzenia w <xref:Microsoft.Office.Tools.Outlook.FormRegionControl.FormRegionShowing> metodzie. Aby uzyskać więcej informacji, zobacz [jak: Subskrybowanie i anulowanie subskrypcji &#40;zdarzeń C&#35; Przewodnik&#41;](/dotnet/csharp/programming-guide/events/how-to-subscribe-to-and-unsubscribe-from-events)programowania.
...
### <a name="HandlingFormRegionEvents"></a>Obsługa zdarzeń regionów formularza
...
|Zdarzenie|Opis|
|-----------|-----------------|
|FormRegionInitializing|Występuje przed zainicjowaniem regionu formularza. Możesz sprawdzić warunki w tym programie obsługi zdarzeń, aby określić, czy program Outlook powinien wyświetlać region formularza. Aby uzyskać więcej informacji, zobacz [jak: Uniemożliwia programowi Outlook wyświetlanie regionu](../vsto/how-to-prevent-outlook-from-displaying-a-form-region.md)formularza.|
...
## <a name="Building"></a>Kompilowanie projektu
...
## <a name="Debugging"></a>Debugowanie regionu formularza
 Można debugować dodatek VSTO programu Outlook, który zawiera region formularza tak samo jak debugowanie innych [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] projektów. Po uruchomieniu [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] debugera program Visual Studio automatycznie uruchamia program Outlook.
...
## <a name="Deploying"></a>Wdróż region formularza
...
|[Przewodnik: Importowanie regionu formularza zaprojektowanego w programie Outlook](../vsto/walkthrough-importing-a-form-region-that-is-designed-in-outlook.md)|Pokazuje, jak zaprojektować region formularza w programie Microsoft Office Outlook, a następnie zaimportować region formularza do projektu dodatku VSTO programu Outlook przy użyciu nowego kreatora **regionu formularza programu Outlook** .|
...
|[Instrukcje: Zapobiegaj wyświetlaniu przez program Outlook regionu formularza](../vsto/how-to-prevent-outlook-from-displaying-a-form-region.md)|Pokazuje, jak zapobiec wyświetlaniu przez program Microsoft Office regionu formularza dla określonego elementu.|
