 ...
 *Główna* \\ *Klasa komunikatów* \Software\Microsoft\Office\Outlook\FormRegions
...
## <a name="loadbehavior-values"></a><a name="LoadBehavior"></a> LoadBehavior wartości
