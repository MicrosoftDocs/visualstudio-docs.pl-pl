...
## <a name="targeted-net-framework"></a>.NET Framework do celu
 W przypadku uaktualniania projektu do Visual Studio 2013 program Visual Studio modyfikuje projekt, aby docelowo [!INCLUDE[net_v45](../vsto/includes/net-v45-md.md)] [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)]albo. Wersja programu .NET Framework wskazywanego przez projekt zależy od zainstalowanej wersji pakietu Office na komputerze. Jeśli [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)] jest zainstalowany, program Visual Studio modyfikuje projekt, aby [!INCLUDE[net_v45](../vsto/includes/net-v45-md.md)]docelowo. W przeciwnym razie program Visual Studio modyfikuje projekt, [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)]aby docelowo.
...
> Może być konieczne wykonanie pewnych dodatkowych kroków w celu uruchomienia rozwiązania przekierowania na komputerach z systemem deweloperskim i użytkownikami końcowymi, a projekt nie będzie już kompilować, jeśli używa pewnych funkcji. Aby uzyskać więcej informacji, zobacz [Migrowanie rozwiązań pakietu Office do .NET Framework 4 lub nowszego](../vsto/migrating-office-solutions-to-the-dotnet-framework-4-or-later.md).
 ...
 Jeśli obiektem docelowym [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] jest lub później w projekcie pakietu Office, można użyć niektórych funkcji, które nie są dostępne w przypadku kierowania .NET Framework 3,5. Aby uzyskać więcej informacji, zobacz [projektowanie i tworzenie rozwiązań pakietu Office](../vsto/designing-and-creating-office-solutions.md).
...
## <a name="targeted-office-application"></a>Aplikacja pakietu Office dla aplikacji
 ...
 Projekty pakietu Office w Visual Studio 2013 mogą [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)] być [!INCLUDE[office14_long](../vsto/includes/office14-long-md.md)] ukierunkowane na aplikacje i. Program Visual Studio modyfikuje projekt, tak aby był przeznaczony dla najnowszej zainstalowanej wersji pakietu Office. Jeśli żadna z tych wersji pakietu Office nie jest zainstalowana, program Visual Studio nie uaktualnia projektu.

> [!NOTE]
> Jeśli uaktualniasz projekt dodatku VSTO do elementu docelowego [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)] lub nowszego, upewnij się, `ThisAddIn_Startup` że program obsługi zdarzeń dodatku VSTO nie zawiera kodu, który uzyskuje dostęp do dokumentu w aplikacji. Aby uzyskać więcej informacji, zobacz [dostęp do dokumentu podczas uruchamiania aplikacji pakietu Office](../vsto/programming-vsto-add-ins.md#AccessingDocuments).

 W przypadku dostosowań na poziomie [!INCLUDE[vs_current_short](../sharepoint/includes/vs-current-short-md.md)] dokumentu program konwertuje dokumenty w projekcie, który ma format binarny, taki jak dokumenty z rozszerzeniem *xls* lub *doc* , do formatu Office Open XML. Aby uzyskać więcej informacji na temat programu Open XML, zobacz [wprowadzenie do nowych rozszerzeń nazw plików i otwartych formatów XML](https://support.office.com/en-nz/article/Introduction-to-new-file-name-extensions-eca81dcb-5626-4e5b-8362-524d13ae4ec1).
