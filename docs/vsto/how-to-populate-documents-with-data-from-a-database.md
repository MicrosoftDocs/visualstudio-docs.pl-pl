...
description: Dowiedz się, jak można użyć danych z bazy danych w rozwiązaniu oraz jak można użyć formantów Windows Forms, aby wyświetlić dane w dokumencie.
