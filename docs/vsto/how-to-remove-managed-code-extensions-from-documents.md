...
3. Wywołaj metodę static <xref:Microsoft.VisualStudio.Tools.Applications.ServerDocument.RemoveCustomization%2A> klasy <xref:Microsoft.VisualStudio.Tools.Applications.ServerDocument> i określ ścieżkę dokumentu rozwiązania dla parametru.
