...
### <a name="word-customization-programming-model"></a>Model programowania dostosowywania wyrazów
 ...
 Aby uzyskać więcej informacji na temat klasy `ThisDocument` i innych funkcji, których można użyć w projekcie na poziomie dokumentu, zapoznaj się z tematem [dostosowania na poziomie dokumentu programu](../vsto/programming-document-level-customizations.md).
...
|[Automatyzowanie programu Word za pomocą obiektów rozszerzonych](../vsto/automating-word-by-using-extended-objects.md)|Zawiera informacje o rozszerzonych obiektach (dostarczonych przez [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)]), których można używać w rozwiązaniach programu Word.|
