...
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (standardowa, miesięczna chmura)   | LICENCJONOWANie, Azure, sprzedaż detaliczna, wybrane NFR<sup>1</sup>, równoważnik  | Azure Boards & repozytoria (podstawowa), Azure Test Plans, Azure Artifacts<sup>2</sup>, Azure Pipelines (samodzielny)       |  Tak          |
| Visual Studio Professional (standardowa, miesięczna chmura) | LICENCJONOWANie, Azure, sprzedaż detaliczna,                                        | Azure Boards & repozytoria (podstawowa), Azure Artifacts<sup>2</sup>                                                            |  Tak          |
...
<sup></sup>1*obejmuje:    Nie do odsprzedaży (NFR), najbardziej cennych profesjonalistów (MVP), regionalnej dyrektora (RD), Visual Studio Industry partner (VSIP), Microsoft Partner Network (Enterprise), BizSpark, MCT Software & Services developer. Wyklucza MCT oprogramowanie &, Wyobraź sobie.*

<sup>2</sup> *Obejmuje 2 GB bez opłat*
...
Nie masz pewności, której subskrypcji używasz?  Połącz się z, [AbywyświetlićwszystkieprzypisanedoCiebiesubskrypcje. https://my.visualstudio.com/subscriptions](https://my.visualstudio.com/subscriptions?wt.mc_id=o~msft~docs)
