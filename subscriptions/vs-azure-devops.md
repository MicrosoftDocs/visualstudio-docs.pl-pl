...
| Visual Studio Enterprise subskrypcję z usługą GitHub Enterprise   | Licencja| Azure Boards & repozytoria (podstawowe<sup>2</sup>), Azure test Plans, własne zadania równoległe |  Tak          |
...
| Visual Studio Professional subskrypcję z usługą GitHub Enterprise | Licencja| Repozytoria & Azure Boards (podstawowa<sup>2</sup>)                                                             |  Tak          |
...
### <a name="q-as-a-visual-studio-enterprise-subscriber-do-i-get-additional-parallel-jobs-for-tfs-and-azure-pipelines"></a>P: jako subskrybent Visual Studio Enterprise należy uzyskać dodatkowe zadania równoległe dla TFS i Azure Pipelines?
Odp.: tak. Subskrybenci Visual Studio Enterprise mogą uzyskać jedno zadanie równoległe w Team Foundation Server 2017 lub nowszej i jedno zadanie równoległe własne w każdej Azure DevOps Services organizacji, gdzie są członkami.
...
- [Repozytoria & Azure Boards (plan podstawowy)](https://azure.microsoft.com/services/devops/compare-features/)
