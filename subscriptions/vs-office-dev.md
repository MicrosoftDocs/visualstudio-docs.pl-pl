...
Subskrybenci z wybranych subskrypcji programu Visual Studio otrzymują korzyści subskrypcja dewelopera usługi Office 365.  Subskrypcja dewelopera usługi Office 365 umożliwia opracowywanie, testowanie i wdrażaj dodatki dla programu Microsoft Office i Microsoft SharePoint.  Ta korzyść umożliwia dla jednej dzierżawy i maksymalnie 25 użytkowników.

## <a name="activation-steps"></a>Procedurę aktywacji

1. Odwiedź stronę [ https://my.visualstudio.com/benefits ](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) zalogować się do portalu subskrybenta.

2. W zależności od konta albo nastąpi przekierowanie na stronę logowania Twojej organizacji lub Account Microsoft strony logowania.   W obu przypadkach, wprowadź nazwę użytkownika i hasło, a następnie kliknij przycisk **dalej**.
...
- Potrzebujesz pomocy dotyczącej subskrypcji dewelopera pakietu Office? Zapoznaj się z [obsługuje](https://developer.microsoft.com/office/docs#officecommunity) zasobów na [Centrum deweloperów pakietu Office](https://developer.microsoft.com/office).
