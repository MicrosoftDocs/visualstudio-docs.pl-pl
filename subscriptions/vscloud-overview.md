...
> [!NOTE]
> Firma Microsoft nie oferuje już Visual Studio Professional rocznych subskrypcji i Visual Studio Enterprise rocznych subskrypcji w ramach subskrypcji chmury. Istnieją zmiany w istniejących klientach i możliwość odnowienia, zwiększenia, zmniejszenia lub anulowania subskrypcji. Zachęcamy [https://visualstudio.microsoft.com/vs/pricing/](https://visualstudio.microsoft.com/vs/pricing/) nowych klientów do przeglądania różnych opcji zakupu programu Visual Studio. Nadal możesz zakupić nowe miesięczne subskrypcje w chmurze.
...
Każda osoba mająca [właściciela](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#owner), [administratora usługi lub](https://docs.microsoft.com/azure/billing/billing-add-change-azure-subscription-administrator#assign-a-user-as-an-administrator-of-a-subscription) współadministratorom dostęp do subskrypcji platformy Azure może zakupić subskrypcje w chmurze.

## <a name="how-to-buy-cloud-subscriptions"></a>Jak kupić subskrypcje chmury

1. Zaloguj się do [subskrypcji > Visual Studio Marketplace](https://marketplace.visualstudio.com/subscriptions).

2. Wybierz subskrypcję, którą chcesz kupić, na przykład comiesięczną subskrypcję Visual Studio Professional.
...
> [!div class="mx-imgBorder"]
> ![Zmień subskrypcje](_img/buy-vs-subscriptions/manage-subscriptions.png)
...
Odp.: Przejdź do [https://visualstudio.microsoft.com/vs/pricing/](https://visualstudio.microsoft.com/vs/pricing/) innych opcji zakupu.

#### <a name="q-what-purchasing-options-are-available-to-me"></a>PYTANIA Jakie opcje zakupu są dostępne dla mnie?
Odp.:  Firma Microsoft udostępnia miesięczne subskrypcje i standardowe subskrypcje w naszych kanałach sprzedaży bezpośredniej. Aby uzyskać więcej informacji, zapoznaj [https://visualstudio.microsoft.com/vs/pricing/](https://visualstudio.microsoft.com/vs/pricing/)się z tematem.
Istnieje również wiele opcji dostępnych w ramach programu licencjonowania zbiorowego. Możesz zbadać opcje i ceny w [https://www.microsoft.com/en-us/licensing/how-to-buy/how-to-buy](https://www.microsoft.com/en-us/licensing/how-to-buy/how-to-buy).
...
Odp.:  Chociaż nie będziesz mieć możliwości kupowania kolejnej rocznej subskrypcji w chmurze, istnieje wiele opcji zakupu subskrypcji programu Visual Studio.  Dowiedz się [https://visualstudio.microsoft.com/vs/pricing/](https://visualstudio.microsoft.com/vs/pricing/)więcej o.
...
Odp.:  Chociaż nie będą mogli kupować innej rocznej subskrypcji w chmurze, istnieje wiele opcji zakupu subskrypcji programu Visual Studio.  Dowiedz się [https://visualstudio.microsoft.com/vs/pricing/](https://visualstudio.microsoft.com/vs/pricing/)więcej o.
