...
0. Na ekranie powitalnym wybierz region/kraj, wprowadź nazwę swojej firmy i kliknij pole wyboru, aby zaakceptować warunki użytkowania.  Następnie kliknij przycisk **Next** (Dalej).
...
0. W oknie dialogowym **Konfigurowanie subskrypcji dewelopera** wybierz swój kraj, Utwórz nazwę użytkownika i domenę, a następnie ustaw hasło.  Następnie kliknij pozycję **Kontynuuj**.
...
| Visual Studio Professional (standardowa) | VL, Azure, Retail                                       | Dołączono                                                             |Yes         |
