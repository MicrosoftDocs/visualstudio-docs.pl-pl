...
<sup>1</sup>@no__t 1Includes:    Nie do odsprzedaży (NFR), Visual Studio Industry partner (VSIP), równoważnik, BizSpark, MCT Software & Services developer.  Wyklucza MCT Software & Services, Microsoft Partner Network (MPN), Wyobraź sobie, najbardziej cenny specjalisty (MVP), dyrektor regionalny (RD). *
...
### <a name="q-how-do-current-users-upgrade-to-e5"></a>PYTANIA Jak bieżąca liczba użytkowników jest uaktualniana do E5?
...
### <a name="q-can-i-choose-e3-or-e5"></a>PYTANIA Czy mogę wybrać E3 lub E5?
...
### <a name="q-how-do-i-know-which-version-i-have"></a>PYTANIA Jak mogę wiesz, którą wersję mam?
...
### <a name="q-if-microsoft-365-doesnt-include-windows-how-do-i-get-windows"></a>PYTANIA Jeśli Microsoft 365 nie obejmuje systemu Windows, jak uzyskać system Windows?
...
- Jeśli jeszcze tego nie zrobiono, zalecamy aktywację tych innych korzyści w ramach subskrypcji:
   - [Azure](vs-azure.md)
   - [Usługa Azure DevOps](vs-azure-devops.md)
