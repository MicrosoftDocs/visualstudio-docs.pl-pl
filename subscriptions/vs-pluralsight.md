...
1. Aby aktywować subskrypcję, Połącz się z [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) i kliknij link **uzyskaj kod** na kafelku korzyści Pluralsight, który znajduje się w sekcji Programowanie profesjonalne.
   ...
   > Kafelek ![Pluralsight korzyść](_img/vs-pluralsight/vs-pluralsight-3month-tile.png)
   >
   > [!IMPORTANT]
...
3. Nastąpi przekierowanie do strony Pluralsight, która jest dostępna w ramach subskrypcji programu Visual Studio.
   ...
   > [!div class="mx-imgBorder"]
   > ![Pluralsight Aktywuj korzyści](_img/vs-pluralsight/vs-pluralsight-create-account.png)
