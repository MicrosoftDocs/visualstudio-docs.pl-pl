---
title: Korzyści z platformy Microsoft Azure | Dokumenty firmy Microsoft
author: evanwindom
ms.author: lank
manager: lank
...
3. Jeśli nie masz istniejącej subskrypcji platformy Azure, zostaniesz poproszony o wypełnienie wymaganych informacji, aby utworzyć subskrypcję platformy Azure.  Pierwszym krokiem jest podanie danych osobowych, a następnie **kliknięcie przycisku Dalej**.
   > [!div class="mx-imgBorder"]
   > ![Rejestracja na platformie Azure](_img/vs-azure/vs-azure-about-you.png)

4. Następnie musisz zweryfikować swoją tożsamość za pomocą prostego kodu weryfikacyjnego. Podaj swój numer telefonu i wybierz, czy chcesz otrzymać kod smsem czy telefonem.  Wprowadź otrzymany kod i kliknij pozycję **Zweryfikuj kod**.   
   > [!div class="mx-imgBorder"]
   > ![Przygotowanie platformy Azure](_img/vs-azure/vs-azure-identity.png)

5. W ostatnim kroku kliknij pole wyboru, aby zaakceptować warunki, a następnie kliknij pozycję **Zarejestruj się**.  To wszystko!
   > [!div class="mx-imgBorder"]
   > ![Przygotowanie platformy Azure](_img/vs-azure/vs-azure-agreement.png)

0. Centrum szybkiego startu pulpitu nawigacyjnego platformy Azure zostanie załadowane.  
   > [!div class="mx-imgBorder"]
...
|--------------------------------------------------------------|-----------------------------|-------------------------------------------------------------|
|              Visual Studio Enterprise Standard               |     $150 kredyt miesięczny     |                             Tak                             |
|              Visual Studio Enterprise z gitHub Enterprise               |     $150 kredyt miesięczny     |                             Tak                             |
|               Program Visual Studio Enterprise co miesiąc               |        Niedostępne        |                                                             |
|             Visual Studio Professional Standard              |     $50 kredyt miesięczny      |                             Tak
|              Visual Studio Professional z gitHub Enterprise              |     $150 kredyt miesięczny     |                             Tak                             |
|              Program Visual Studio Professional co miesiąc              |        Niedostępne        |                                                             |
|                    Visual Studio Test Pro                    |     $50 kredyt miesięczny      |                             Tak                             |
|                        Platformy MSDN                        |     $100 kredyt miesięczny     |                             Tak                             |
|               Program Visual Studio Enterprise — NFR\*               |     $150 kredyt miesięczny     |                             Tak                             |
|                Visual Studio Enterprise — fte                |     $150 kredyt miesięczny     |                             Tak                             |
|     Visual Studio Enterprise — sieć partnerów firmy Microsoft     |     $150 kredyt miesięczny     |                             Tak                             |
|    Visual Studio Professional — sieć partnerów firmy Microsoft    |        Niedostępne        |                                                             |
|        Visual Studio Enterprise — Imagine (standard)         |        Niedostępne        |                                                             |
|         Visual Studio Enterprise — Imagine (Premium)         |        Niedostępne        |                                                             |
|             Visual Studio Enterprise — BizSpark              |     $150 kredyt miesięczny     |                             Tak                             |
|      Visual Studio Enterprise — mct software & Services      |     $100 kredyt miesięczny     |                             Tak                             |
| Visual Studio Enterprise — deweloper usług & mct |     $150 kredyt miesięczny     |                             Tak                             |

*Obejmuje nie do odsprzedaży (NFR), Most Valuable Professional (MVP), Regional Director (RD), Visual Studio Industry Partner (VSIP)
...
### <a name="q-how-do-i-submit-a-technical-support-incident-from-within-the-azure-portal"></a>Pyt.: Jak przesłać zdarzenie pomocy technicznej z poziomu witryny Azure portal?
Odp.: Przesyłanie zdarzenia pomocy technicznej z witryny Azure portal jest procesem trzyetapowym.
1. Aktywuj swoją pomoc techniczną i uzyskaj identyfikator dostępu do identyfikatora umowy.
2. Połącz umowę pomocy technicznej z subskrypcją platformy Azure.
3. Prześlij zdarzenie pomocy technicznej.

Szczegółowe informacje można znaleźć w dokumentacji [pomocy technicznej.](vs-tech-support.md)
