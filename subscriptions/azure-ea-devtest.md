...
ms.locfileid: "85903143"
---
# <a name="azure-enterprise-agreement-devtest-offer"></a>Oferta usługi Azure Umowa Enterprise DevTest

Ta oferta, która jest częścią Umowa Enterprise, jest dla zespołów aktywnych subskrybentów programu Visual Studio do uruchamiania obciążeń deweloperskich/testowych na Microsoft Azure, co zapewnia obniżone stawki na maszynach wirtualnych z systemem Windows i dostęp do obrazów wyłącznych w galerii platformy Azure. Ta oferta jest ograniczona do programowania i testowania tylko i nie można jej używać w środowisku produkcyjnym.  
