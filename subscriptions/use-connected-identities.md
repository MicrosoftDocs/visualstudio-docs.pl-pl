...
Gdy administrator nawiązał połączenie Twojego konta MSA z tożsamością usługi Azure AD, musisz zalogować się do portalu subskrybenta pod adresem https://my.visualstudio.com z tożsamością usługi Azure AD, aby uzyskać dostęp do korzyści, które korzystają z usługi Azure AD.  Należą do nich:
- Visual Studio IDE
- Azure DevOps
- Kredyty na korzystanie z platformy Azure
...
### <a name="q-how-can-i-contact-my-admin-about-this"></a>PYTANIA Jak mogę skontaktować się z administratorem?
...
Gdy administrator nawiąże połączenie z kontami usługi Azure AD i MSA, zalecamy sprawdzenie, czy można pomyślnie zalogować się do [portalu subskrypcji](https://my.visualstudio.com?wt.mc_id=o~msft~docs) i uzyskać dostęp do korzyści takich jak Azure DevOps, Visual Studio i kredyty na korzystanie z platformy Azure. 