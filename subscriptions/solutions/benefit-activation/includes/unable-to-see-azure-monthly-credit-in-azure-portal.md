...
Istnieje wiele powodów, dla których nie można zobaczyć miesięcznych środków na korzystanie z platformy Azure. Być może używasz niewłaściwej wiadomości e-mail do zalogowania się, możesz zalogować się przy użyciu poprawnej wiadomości e-mail, ale w niewłaściwym katalogu lub nie masz jeszcze aktywacji miesięcznej korzyści z kredytów. 

## <a name="azure-subscription-sign-in"></a>Logowanie do subskrypcji platformy Azure 
