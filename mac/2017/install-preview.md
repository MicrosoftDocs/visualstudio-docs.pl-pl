...
ms.locfileid: "85950640"
---
# <a name="install-a-preview-release"></a>Instalowanie wersji zapoznawczej

> [!NOTE]
> Program Visual Studio 2019 for Mac (wersja zapoznawcza) jest [teraz dostępny do instalacji](/visualstudio/mac/installation/?view=vsmac-2019) i testowania.

## <a name="install-an-update-for-visual-studio-for-mac"></a>Zainstaluj aktualizację dla Visual Studio dla komputerów Mac
...
2. W polu kombi kanał aktualizacji wybierz pozycję **wersja beta**.
