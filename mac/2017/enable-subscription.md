...
> Aby aktywować subskrypcję programu Visual Studio 2017 dla komputerów Mac Professional lub Enterprise, podczas logowania należy nawiązywać połączenie z Internetem.

Jeśli program Visual Studio Enterprise 2017 został zakupiony dla komputerów Mac dla komputerów Mac dla komputerów Mac, możesz nadal korzystać z programu Visual Studio dla komputerów Mac bez aktywacji, ale nie będą używane funkcje Xamarin Inspector, Xamarin Profiler i osadzone zestawy. Dostępne.
