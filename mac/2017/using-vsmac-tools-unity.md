...
Chociaż zawsze można dodać nowe pliki do projektu Unity w edytorze Unity, Visual Studio dla komputerów Mac umożliwia łatwe tworzenie nowych skryptów Unity, modułów cieniujących i folderów z poziomu programu Visual Studio.
