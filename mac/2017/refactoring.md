...
Akcje kontekstowe umożliwiają sprawdzenie dowolnego kodu w języku C# i wyświetlenie wszystkich możliwych opcji refaktoryzacji.
...
2. Zaznacz linię `double volume = (baseArea * height) / 3;` , kliknij ją prawym przyciskiem myszy, a następnie wybierz pozycję **refaktoryzacja > Wyodrębnij metodę**.
