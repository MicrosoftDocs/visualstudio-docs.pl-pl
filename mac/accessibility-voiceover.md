...
|Cechy|Opis|Skrót|
|-------|-----------|--------|
|Nawigacja|Przechodzenie do wszystkich elementów interfejsu użytkownika|**VO →**, **VO ←**|
|Nawigacja|Wkrocz do elementów interfejsu użytkownika lub z nich|**VO ⇧ ↓**, **VO ⇧ ↑**|
