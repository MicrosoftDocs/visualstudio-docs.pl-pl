...
Unity to aparat gier, który umożliwia tworzenie gier w języku C#. W tym instruktażu pokazano, jak rozpocząć opracowywanie i debugowanie gier Unity przy użyciu Visual Studio dla komputerów Mac i Visual Studio dla komputerów Mac narzędzia dla aparatu Unity obok środowiska Unity.
...
- Środowisko Unity 5.6.1 w wersji osobistej lub wyższej ( [https://store.unity.com](https://store.unity.com/) wymaga konta Unity.com do uruchomienia)
...
3. Ustaw **nazwę projektu** na **"UnityLab"** i wybierz pozycję **3D**. Kliknij pozycję **Utwórz projekt**.
...
1. Najlepszym sposobem na edytowanie kodu w języku C# jest użycie Visual Studio dla komputerów Mac. Środowisko Unity można skonfigurować tak, aby używało Visual Studio dla komputerów Mac jako domyślnej procedury obsługi. Wybierz pozycję **preferencje > aparatu Unity**.
