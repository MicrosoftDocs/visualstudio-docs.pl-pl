...
Dostępne są dwie opcje do rozważenia rozpoczynania pracy ze składnią Razor w programie Visual Studio dla komputerów Mac: Strony razor programu ASP.NET Core i ASP.NET Core MVC. Samouczki i więcej informacji na temat obu opcji można znaleźć jednego z poniższych przewodników:
