...
| Wersja zestaw .NET Core SDK |Visual Studio dla komputerów Mac 8,1 (stabilne) | Visual Studio dla komputerów Mac 8,2 (stabilne) | Visual Studio dla komputerów Mac 8,3 (stabilne) |
|---------|---------|---------|---------|
|v 2.1.0-v 2.1.5 XX | | | |
|v 2.1.600 + |✔️|✔️|✔️|
|v 2.2.1-v 2.2.1 XX | | | |
...
> [!IMPORTANT]
> Wersje zapoznawcze zestaw .NET Core SDK nie są obsługiwane, należy zaktualizować do wersji wydanej. W przypadku instalowania Visual Studio dla komputerów Mac 8,3 zostanie zainstalowana wydana wersja programu .NET Core v 3.0.
