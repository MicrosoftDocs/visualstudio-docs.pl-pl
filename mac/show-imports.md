...
Aby włączyć tę funkcję, Otwórz **Preferencje** za pośrednictwem preferencji **programu Visual Studio**  >  **Preferences** i przejdź do **edytora tekstu**  >  **IntelliSense**. Zaznacz pole wyboru **Pokaż elementy importu** , aby włączyć dodatkowe elementy w IntelliSense.
...
Na liście IntelliSense obszary nazw są wyświetlane obok elementów członkowskich, które nie są aktualnie przywoływane przez `using` instrukcję. W przypadku wybrania jednego z tych elementów z listy element członkowski zostanie dodany do kodu, _a_ `using` instrukcja zostanie dodana na początku pliku. Elementy członkowskie z typów, do których już odwołują się odwołania, nie będą pokazywały ich przestrzeni nazw w IntelliSense.
