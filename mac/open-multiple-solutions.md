...
Aby otworzyć drugie wystąpienie zintegrowanego środowiska programistycznego (IDE), kliknij prawym przyciskiem myszy ikonę programu Visual Studio w folderze stacja dokująca lub **aplikacja,** a następnie wybierz pozycję **Nowe wystąpienie**.

![Zrzut ekranu przedstawiający opcję menu Nowe wystąpienie na ikonie programu Visual Studio z prawym przyciskiem myszy](media/open-new-instance.png)
