...
ms.locfileid: "62946755"
---
# <a name="idebugdocumenttexteventsondestroy"></a>IDebugDocumentTextEvents::onDestroy
Wskazuje, że dokumentu podstawowego został zniszczony i nie jest już prawidłowy.  
...
## <a name="remarks"></a>Uwagi  
 Ta metoda wskazuje, że dokumentu podstawowego został zniszczony i nie jest już prawidłowy.  
