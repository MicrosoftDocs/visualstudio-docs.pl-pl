...
#### <a name="parameters"></a>Parametry  
 `ppEnum`  
 [out] W przypadku moduł wyliczający, który wyświetla kontekstów wyrażenie globalne dla wszystkich języków, w tym wątku.  
