...
ms.locfileid: "72574708"
---
# <a name="idebugapplicationnodeeventsonaddchild"></a>IDebugApplicationNodeEvents::onAddChild
Obsługuje zdarzenie po dodaniu węzła podrzędnego do obiektu węzła debugowania aplikacji.  
...
## <a name="remarks"></a>Uwagi  
 Ta metoda obsługuje zdarzenie po dodaniu węzła podrzędnego do obiektu węzła debugowania aplikacji.  
