...
#### <a name="parameters"></a>Parametry  
 `cCharacterPosition`  
 podczas Lokalizacja początkowa zakresu znaków do zastąpienia.  
  
 `cNumToReplace`  
 podczas Liczba znaków do zastąpienia.  
  
 `pcharText[]`  
 podczas Bufor zawierający nowe znaki do zastępowania starych znaków.  
