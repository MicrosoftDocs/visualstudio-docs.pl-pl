...
ms.locfileid: "72577018"
---
# <a name="idebugdocumenthelperbringdocumentcontexttotop"></a>IDebugDocumentHelper::BringDocumentContextToTop
Umieszcza kontekst tego dokumentu w górnej części interfejsu użytkownika debugera.  
...
#### <a name="parameters"></a>Parametry  
 `pddc`  
 Kontekst dokumentu do przełączenia do góry w interfejsie użytkownika debugera.  
...
## <a name="remarks"></a>Uwagi  
 Ta metoda umożliwia przeniesienie kontekstu tego dokumentu na górę w interfejsie użytkownika debugera.  
