...
|Element członkowski|Value|Opis|  
|------------|-----------|-----------------|  
...
|APPBREAKFLAG_DEBUGGER_HALT|0x00000002|Aparat języka powinien natychmiast przerwać z BREAKREASON_DEBUGGER_HALT.|  
|APPBREAKFLAG_STEP|0x00010000|Aparat języka powinien natychmiast przerwać w wątku taktowania za pomocą BREAKREASON_STEP.|  
