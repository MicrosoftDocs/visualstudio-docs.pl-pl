---
title: IEnumRemoteDebugApplications::Next | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Parametry  
 ...
 `ppda`  
 [out] Zwraca tablicę `IRemoteDebugApplication` interfejsy, które reprezentuje segmentów pobierania.  
