...
|Stała|Wartość|Opis|  
|--------------|-----------|-----------------|  
|DWORD DEBUG_TEXT_ISEXPRESSION|0x00000001|Wskazuje, czy tekst jest wyrażeniem, w przeciwieństwie do instrukcji. Ta flaga może mieć wpływ na sposób, w którym tekst jest analizowany przy niektórych języków.|  
